 ...
 *
 * @param <double> Typ des Objekts
 */
public class BoundPropertyDouble {
	 ...
	 *                              auszul&ouml;sen
	 */
	public BoundPropertyDouble(String propertyName, double defaultValue, PropertyChangeSupport propertyChangeSupport) {
		value = defaultValue;
	 ...
	 * @param newValue
	 */
	public void setValueWithoutEvent(double newValue) {
		value = newValue;
	}
}
