 ...
 *
 * @param <char> Typ des Objekts
 */
public class BoundPropertyChar {
	 ...
	 *                              auszul&ouml;sen
	 */
	public BoundPropertyChar(String propertyName, char defaultValue, PropertyChangeSupport propertyChangeSupport) {
		value = defaultValue;
	 ...
	 * @param newValue
	 */
	public void setValueWithoutEvent(char newValue) {
		value = newValue;
	}
}
