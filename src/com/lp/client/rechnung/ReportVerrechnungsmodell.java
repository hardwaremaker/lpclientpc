...
public class ReportVerrechnungsmodell extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportVerrechnungsmodell(InternalFrameRechnung internalFrame, Integer verrechnungsmodellIId,
	...
	public String getReportname() {
		return AbrechnungsvorschlagFac.REPORT_VERRECHNUNGSMODELL;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getRechnungDelegate().printVerrechnungsmodell(verrechnungsmodellIId);
	}
