...
public class ReportNichtAbgerechneteAZ_RE extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportNichtAbgerechneteAZ_RE(TabbedPaneRechnung tabbedPane,String add2Title) throws Throwable {
	...
	public String getReportname() {
		return RechnungReportFac.REPORT_NICHT_ABGERECHNETE_ANZAHLUNGEN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getRechnungDelegate()
				.printNichtabgerechneteAnzahlungen();
	}
