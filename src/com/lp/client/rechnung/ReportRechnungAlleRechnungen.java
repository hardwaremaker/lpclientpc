...
public class ReportRechnungAlleRechnungen extends PanelReportJournalVerkauf implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperCheckBox wcbFibuDetails = null;

	public ReportRechnungAlleRechnungen(InternalFrame internalFrame, String add2Title) throws Throwable {
	...
	protected void jbInit() {
		...
		wrbSortierungVertreter = new WrapperRadioButton(LPMain.getTextRespectUISPr("label.vertreter"));
		...
		wbuVertreter.setMinimumSize(new Dimension(BREITE_BUTTONS, Defaults.getInstance().getControlHeight()));
		wbuVertreter.setPreferredSize(new Dimension(BREITE_BUTTONS, Defaults.getInstance().getControlHeight()));
		wtfVertreter = new WrapperTextField();
		wtfVertreter.setEditable(false);
		wtfVertreter.setMinimumSize(new Dimension(50, Defaults.getInstance().getControlHeight()));
		wtfVertreter.setPreferredSize(new Dimension(50, Defaults.getInstance().getControlHeight()));

		
		
		iZeile++;
		jpaWorkingOn.add(wrbSortierungVertreter, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbVertreterAlle, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbVertreterEiner, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(getPanelVertreter(), new GridBagConstraints(2, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
		...
		HelperClient.setMinimumAndPreferredSize(wcbNurOffene, HelperClient.getSizeFactoredDimension(90));
		...
		HelperClient.setMinimumAndPreferredSize(wcbGutschriftenBerucksichtigen,
				HelperClient.getSizeFactoredDimension(190));
		jpaWorkingOn.add(wcbNurOffene, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wcbStatistikadresse, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wcbGutschriftenBerucksichtigen, new GridBagConstraints(0, iZeile, 2, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		wcbFibuDetails = new WrapperCheckBox();
		wcbFibuDetails.setText(LPMain.getTextRespectUISPr("rechnung.fibudetails"));
		HelperClient.setMinimumAndPreferredSize(wcbFibuDetails, HelperClient.getSizeFactoredDimension(190));
		jpaWorkingOn.add(wcbFibuDetails, new GridBagConstraints(2, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	}
	...
	private void setDefaults() {
		...
		wcbFibuDetails.setSelected(false);
	...
	private JPanel getPanelVertreter() {
		if (jPanelVertreter == null) {
			...
			jPanelVertreter.add(wbuVertreter, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jPanelVertreter.add(wtfVertreter, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		}
	...
	protected ReportRechnungJournalKriterienDto getKriterien() {
		...
		krit.setBFibuDetails(wcbFibuDetails.isSelected());
		return krit;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getRechnungDelegate().printRechnungenAlle(getKriterien());
	}
}
