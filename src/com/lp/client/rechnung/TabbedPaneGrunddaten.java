...
import com.lp.client.forecast.PanelKommdrucker;
...
/**
 * <p>
 * Diese Klasse kuemmert sich RE-Grundaten.
 * </p>
 *
 * <p>
...
//	private final static int IDX_RECHNUNGTYP = 4;
	...
	private final static int IDX_MMZ = 10;
...
// entfernt PJ 14922
	/*
	 * private PanelQuery panelQueryRechnungsstatus = null; private
	 * PanelStammdatenCRUD panelBottomRechnungsstatus = null; private PanelSplit
	 * panelSplitRechnungsstatus = null;
	 * 
	 * private PanelQuery panelQueryRechnungtyp = null; private PanelStammdatenCRUD
	 * panelBottomRechnungtyp = null; private PanelSplit panelSplitRechnungtyp =
	 * null;
	 */
	...
	private PanelQuery panelQueryMmz = null;
	private PanelBasis panelBottomMmz = null;
	private PanelSplit panelSplitMmz = null;
	...
	private void jbInit() throws Throwable {
		...
		// Tab 1: Rechnungstext
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.rechnungtext"), null, null,
				LPMain.getInstance().getTextRespectUISPr("lp.rechnungtext"), IDX_PANEL_RECHNUNGTEXT);

		// Tab 2: Mahntext
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.mahntext"), null, null,
				LPMain.getInstance().getTextRespectUISPr("lp.mahntext"), IDX_PANEL_MAHNTEXT);
		// Tab 3: Rechnungsart
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsart"), null, null,
				LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsart"), IDX_RECHNUNGART);
// entfernt PJ 14922
		/*
		 * // Tab 4: Rechnungsstatus insertTab(LPMain.getInstance().getTextRespectUISPr(
		 * "rechnung.tab.oben.rechnungsstatus"), null, null,
		 * LPMain.getInstance().getTextRespectUISPr(
		 * "rechnung.tab.oben.rechnungsstatus"), IDX_RECHNUNGSSTATUS); // Tab 5:
		 * Rechnungstyp insertTab(LPMain.getInstance().getTextRespectUISPr(
		 * "rechnung.tab.oben.rechnungtyp"), null, null,
		 * LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungtyp"),
		 * IDX_RECHNUNGTYP);
		 */

		// Tab 6: Rechnungzahlungsart
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.zahlungsart"), null, null,
				LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.zahlungsart"), IDX_RECHNUNGZAHLUNGART);

		// Tab 7: Mahnstufen
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.mahnstufe"), null, null,
				LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.mahnstufe"), IDX_MAHNSTUFE);

		// Tab 8: Rechnungpositionart Rechnung
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.rechnung"), null,
				null, LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.rechnung"),
				IDX_RECHNUNGPOSITIONART_RE);

		// Tab 9: Rechnungpositionart Gutschrift
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.gutschrift"), null,
				null, LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.gutschrift"),
		...
		insertTab(LPMain.getInstance().getTextRespectUISPr("lp.gutschrifttext"), null, null,
				LPMain.getInstance().getTextRespectUISPr("lp.gutschrifttext"), IDX_PANEL_GUTSCHRIFTTEXT);
		// Tab 12: Rutschriftgrund
		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.gutschriftsgrund"), null, null,
				LPMain.getInstance().getTextRespectUISPr("rechnung.gutschriftsgrund"), IDX_GUTSCHRIFTGRUND);

		insertTab(LPMain.getInstance().getTextRespectUISPr("rechnung.mindermengenzuschlag"), null, null,
				LPMain.getInstance().getTextRespectUISPr("rechnung.mindermengenzuschlag"), IDX_MMZ);
	...
	public void lPEventItemChanged(ItemChangedEvent eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.ITEM_CHANGED) {
			...
			}else if (e.getSource() == panelQueryMmz) {
				Integer iId = (Integer) panelQueryMmz.getSelectedId();
				getInternalFrame().setKeyWasForLockMe(iId + "");
				panelBottomMmz.setKeyWhenDetailPanel(iId);
				panelBottomMmz.eventYouAreSelected(false);
				panelQueryMmz.updateButtons();
			}
// entfernt PJ 14922
			/*
			 * else if (e.getSource() == panelQueryRechnungsstatus) { String cNr = (String)
			 * panelQueryRechnungsstatus.getSelectedId();
			 * getInternalFrame().setKeyWasForLockMe(cNr);
			 * panelBottomRechnungsstatus.setKeyWhenDetailPanel(cNr);
			 * panelBottomRechnungsstatus.eventYouAreSelected(false);
			 * panelQueryRechnungsstatus.updateButtons(); } else if (e.getSource() ==
			 * panelQueryRechnungtyp) { String cNr = (String)
			 * panelQueryRechnungtyp.getSelectedId();
			 * getInternalFrame().setKeyWasForLockMe(cNr);
			...
			}else if (eI.getSource() == panelBottomMmz) {
				panelSplitMmz.eventYouAreSelected(false);
			}
		}
			...
			}else if (e.getSource() == panelBottomMmz) {
				Object oKey = panelBottomMmz.getKeyWhenDetailPanel();
				panelQueryMmz.eventYouAreSelected(false);
				panelQueryMmz.setSelectedId(oKey);
				panelSplitMmz.eventYouAreSelected(false);
			...
			if (e.getSource() == panelBottomRechnungsart) {
				...
				panelSplitMmz.eventYouAreSelected(false); // refresh auf das gesamte 1:n panel
			} else if (eI.getSource() == panelBottomRechnungtext) {
				panelSplitRechnungtext.eventYouAreSelected(false);
			} else if (eI.getSource() == panelBottomMahntext) {
			...
			}else if (eI.getSource() == panelQueryMmz) {
				panelBottomMmz.eventActionNew(e, true, false);
				panelBottomMmz.eventYouAreSelected(false);
				setSelectedComponent(panelSplitMmz);
			} else if (eI.getSource() == panelQueryRechnungtext) {
...
// entfernt PJ 14922
		/*
		 * case IDX_RECHNUNGSSTATUS: { refreshRechnungsstatus();
		 * panelSplitRechnungsstatus.eventYouAreSelected(false); break; } case
		 * IDX_RECHNUNGTYP: { refreshRechnungtyp();
		 * panelSplitRechnungtyp.eventYouAreSelected(false); break; }
		 */
		...
		case IDX_PANEL_RECHNUNGTEXT: {
			...
			if (panelQueryRechnungtext.getSelectedId() == null) {
				getInternalFrame().enableAllOberePanelsExceptMe(this, IDX_PANEL_RECHNUNGTEXT, false);
			}
			break;
		}
		case IDX_PANEL_GUTSCHRIFTTEXT: {
			...
			if (panelQueryGutschrifttext.getSelectedId() == null) {
				getInternalFrame().enableAllOberePanelsExceptMe(this, IDX_PANEL_GUTSCHRIFTTEXT, false);
			}
			break;
		}
		case IDX_PANEL_MAHNTEXT: {
			...
			// die restlichen oberen Laschen deaktivieren, ausser ...
			if (panelQueryMahntext.getSelectedId() == null) {
				getInternalFrame().enableAllOberePanelsExceptMe(this, IDX_PANEL_MAHNTEXT, false);
			}
			break;
		}
		case IDX_MAHNSTUFE: {
	...
	private void refreshRechnungsart() throws Throwable {

		if (panelSplitRechnungsart == null) {

			panelQueryRechnungsart = new PanelQuery(null, null, QueryParameters.UC_ID_RECHNUNGART, null,
					getInternalFrame(), LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsart"),
					true); // liste refresh wenn lasche geklickt wurde

			panelBottomRechnungsart = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsart"), null,
					HelperClient.SCRUD_RECHNUNGSART_FILE, (InternalFrameRechnung) getInternalFrame(),
					HelperClient.LOCKME_RECHNUNGSART);

			panelSplitRechnungsart = new PanelSplit(getInternalFrame(), panelBottomRechnungsart, panelQueryRechnungsart,
					200);
	...
	private void refreshMmz() throws Throwable {

		if (panelSplitMmz == null) {

			String[] aWhichStandardButtonIUse = { PanelBasis.ACTION_NEW };
			panelQueryMmz = new PanelQuery(null, null, QueryParameters.UC_ID_MMZ, aWhichStandardButtonIUse,
					getInternalFrame(), LPMain.getInstance().getTextRespectUISPr("rechnung.mindermengenzuschlag"),
					true); // liste refresh wenn lasche geklickt wurde

			panelBottomMmz = new PanelMmz(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.mindermengenzuschlag"), null);

			panelSplitMmz = new PanelSplit(getInternalFrame(), panelBottomMmz, panelQueryMmz, 200);
			setComponentAt(IDX_MMZ, panelSplitMmz);

			// liste soll sofort angezeigt werden
			panelQueryMmz.eventYouAreSelected(true);
		}
	}
	...
	private void refreshGutschriftgrund() throws Throwable {
		...
		if (panelSplitGutschriftgrund == null) {
			...
			String[] aWhichStandardButtonIUse = { PanelBasis.ACTION_NEW };
			panelQueryGutschriftgrund = new PanelQuery(null, null, QueryParameters.UC_ID_GUTSCHRIFTGRUND,
					aWhichStandardButtonIUse, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.gutschriftsgrund"), true); // liste refresh wenn
																									// lasche geklickt
																									// wurde

			panelBottomGutschriftgrund = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.gutschriftsgrund"), null,
					HelperClient.SCRUD_GUTSCHRIFTGRUND_FILE, (InternalFrameRechnung) getInternalFrame(),
					HelperClient.LOCKME_GUTSCHRIFTGRUND);

			panelSplitGutschriftgrund = new PanelSplit(getInternalFrame(), panelBottomGutschriftgrund,
					panelQueryGutschriftgrund, 200);
	...
	/*
	 * entfernt PJ 14922 private void refreshRechnungtyp() throws Throwable {
	 * 
	 * if (panelSplitRechnungtyp == null) {
	 * 
	 * panelQueryRechnungtyp = new PanelQuery( null, null,
	 * QueryParameters.UC_ID_RECHNUNGTYP, null, getInternalFrame(),
	 * LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungtyp"),
	 * true); // liste refresh wenn lasche geklickt wurde
	 * 
	 * panelBottomRechnungtyp = new PanelStammdatenCRUD( getInternalFrame(),
	 * LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungtyp"),
	 * null, HelperClient.SCRUD_RECHNUNGTYP_FILE, (InternalFrameRechnung)
	 * getInternalFrame(), HelperClient.LOCKME_RECHNUNGTYP);
	 * 
	 * panelSplitRechnungtyp = new PanelSplit( getInternalFrame(),
	 * panelBottomRechnungtyp, panelQueryRechnungtyp, 200);
	...
	private void refreshZahlungsart() throws Throwable {

		if (panelSplitZahlungsart == null) {

			panelQueryZahlungsart = new PanelQuery(null, null, QueryParameters.UC_ID_ZAHLUNGSART, null,
					getInternalFrame(), LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.zahlungsart"),
					true); // liste refresh wenn lasche geklickt wurde

			panelBottomZahlungsart = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.zahlungsart"), null,
					HelperClient.SCRUD_ZAHLUNGSART_FILE, (InternalFrameRechnung) getInternalFrame(),
					HelperClient.LOCKME_ZAHLUNGSART);

			panelSplitZahlungsart = new PanelSplit(getInternalFrame(), panelBottomZahlungsart, panelQueryZahlungsart,
					200);
	 ...
	 * @throws Throwable
	 */
	private void refreshRechnungpositionartRE() throws Throwable {

		if (panelSplitRechnungpositionartRE == null) {
			panelQueryRechnungpositionartRE = new PanelQuery(null, null, QueryParameters.UC_ID_RECHNUNGPOSITIONSART,
					null, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.rechnung"), true); // liste
																														// refresh
																														// wenn
																														// lasche
																														// geklickt
			...
			panelBottomRechnungpositionartRE = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.rechnung"), null,
					HelperClient.SCRUD_RECHNUNGPOSITIONSART_FILE, (InternalFrameRechnung) getInternalFrame(),
					HelperClient.LOCKME_RECHNUNGPOSITIONSART);

			panelSplitRechnungpositionartRE = new PanelSplit(getInternalFrame(), panelBottomRechnungpositionartRE,
					panelQueryRechnungpositionartRE, 200);
	 ...
	 * @throws Throwable
	 */
	private void refreshRechnungpositionartGS() throws Throwable {

		if (panelSplitRechnungpositionartGS == null) {
			panelQueryRechnungpositionartGS = new PanelQuery(null, null, QueryParameters.UC_ID_GUTSCHRIFTPOSITIONSART,
					null, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.gutschrift"), true); // liste
																															// refresh
																															// wenn
																															// lasche
																															// geklickt
			...
			panelBottomRechnungpositionartGS = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.gutschrift"), null,
					HelperClient.SCRUD_GUTSCHRIFTPOSITIONSART_FILE, (InternalFrameRechnung) getInternalFrame(),
					HelperClient.LOCKME_GUTSCHRIFTPOSITIONSART);

			panelSplitRechnungpositionartGS = new PanelSplit(getInternalFrame(), panelBottomRechnungpositionartGS,
					panelQueryRechnungpositionartGS, 200);
	 ...
	 * @throws Throwable
	 */
	private void refreshRechnungpositionartPR() throws Throwable {

		if (panelSplitRechnungpositionartPR == null) {
			panelQueryRechnungpositionartPR = new PanelQuery(null, null,
					QueryParameters.UC_ID_PROFORMARECHNUNGPOSITIONSART, null, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.proformarechnung"),
					true); // liste refresh wenn lasche geklickt wurde

			panelBottomRechnungpositionartPR = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungpositionart.proformarechnung"),
					null, HelperClient.SCRUD_PROFORMARECHNUNGPOSITIONSART_FILE,
					(InternalFrameRechnung) getInternalFrame(), HelperClient.LOCKME_PROFORMARECHNUNGPOSITIONSART);

			panelSplitRechnungpositionartPR = new PanelSplit(getInternalFrame(), panelBottomRechnungpositionartPR,
					panelQueryRechnungpositionartPR, 200);
	...
	/*
	 * entfernt PJ 14922 private void refreshRechnungsstatus() throws Throwable { if
	 * (panelSplitRechnungsstatus == null) { panelQueryRechnungsstatus = new
	 * PanelQuery( null, null, QueryParameters.UC_ID_RECHNUNGSTATUS, null,
	 * getInternalFrame(),
	 * LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsstatus")
	 * , true); // liste refresh wenn lasche geklickt wurde
	 * panelBottomRechnungsstatus = new PanelStammdatenCRUD( getInternalFrame(),
	 * LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.rechnungsstatus")
	 * , null, HelperClient.SCRUD_RECHNUNGSSTATUS_FILE, (InternalFrameRechnung)
	 * getInternalFrame(), HelperClient.LOCKME_RECHNUNGSSTATUS);
	 * panelSplitRechnungsstatus = new PanelSplit( getInternalFrame(),
	 * panelBottomRechnungsstatus, panelQueryRechnungsstatus, 200);
	 * setComponentAt(IDX_RECHNUNGSSTATUS, panelSplitRechnungsstatus); // liste soll
	 * sofort angezeigt werden panelQueryRechnungsstatus.eventYouAreSelected(true);
	 * } }
	 */
	private void refreshMahnstufe() throws Throwable {
		...
		if (panelSplitMahnstufe == null) {
			...
			String[] aWhichStandardButtonIUse = { PanelBasis.ACTION_NEW };
			panelQueryMahnstufe = new PanelQuery(null, null, QueryParameters.UC_ID_MAHNSTUFE, aWhichStandardButtonIUse,
					getInternalFrame(), LPMain.getInstance().getTextRespectUISPr("rechnung.tab.oben.mahnstufe"), true); // liste
																														// refresh
																														// wenn
																														// lasche
																														// geklickt
			...
			panelBottomMahnstufe = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.detail"), null, HelperClient.SCRUD_MAHNSTUFE_FILE,
					(InternalFrameRechnung) getInternalFrame(), HelperClient.LOCKME_MAHNSTUFE);
			panelSplitMahnstufe = new PanelSplit(getInternalFrame(), panelBottomMahnstufe, panelQueryMahnstufe, 200);
	...
	private void refreshPanelRechnungtext() throws Throwable {
		if (panelSplitRechnungtext == null) {
			...
			RechnungtextDto reTextDtoKopf = DelegateFactory.getInstance().getRechnungServiceDelegate()
					.rechnungtextFindByMandantLocaleCNr(LPMain.getInstance().getTheClient().getLocUiAsString(),
							MediaFac.MEDIAART_KOPFTEXT);
			if (reTextDtoKopf == null) {
				DelegateFactory.getInstance().getRechnungServiceDelegate().createDefaultRechnungtext(
			...
			RechnungtextDto reTextDtoFuss = DelegateFactory.getInstance().getRechnungServiceDelegate()
					.rechnungtextFindByMandantLocaleCNr(LPMain.getInstance().getTheClient().getLocUiAsString(),
			...
			panelQueryRechnungtext = new PanelQuery(null, null, QueryParameters.UC_ID_RECHNUNGTEXT,
					aWhichStandardButtonIUse, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.rechnungtext"), true);
			panelBottomRechnungtext = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.rechnungtext"), null,
					HelperClient.SCRUD_RECHNUNGTEXT_FILE, getInternalFrame(), HelperClient.LOCKME_RECHNUNGTEXT);
			panelSplitRechnungtext = new PanelSplit(getInternalFrame(), panelBottomRechnungtext, panelQueryRechnungtext,
					400 - ((PanelStammdatenCRUD) panelBottomRechnungtext).getAnzahlControls() * 30);
	...
	private void refreshPanelGutschrifttext() throws Throwable {
		if (panelSplitGutschrifttext == null) {
			// der Kopftext muss hinterlegt sein oder angelegt werden
			GutschrifttextDto gsTextDtoKopf = DelegateFactory.getInstance().getRechnungServiceDelegate()
					.gutschrifttextFindByMandantLocaleCNr(LPMain.getInstance().getTheClient().getLocUiAsString(),
							MediaFac.MEDIAART_KOPFTEXT);
			if (gsTextDtoKopf == null) {
				DelegateFactory.getInstance().getRechnungServiceDelegate().createDefaultGutschrifttext(
						MediaFac.MEDIAART_KOPFTEXT, RechnungServiceFac.GUTSCHRIFT_DEFAULT_KOPFTEXT,
						LPMain.getInstance().getTheClient().getLocUiAsString());
			}
			// der Fusstext muss hinterlegt sein oder angelegt werden
			GutschrifttextDto gsTextDtoFuss = DelegateFactory.getInstance().getRechnungServiceDelegate()
					.gutschrifttextFindByMandantLocaleCNr(LPMain.getInstance().getTheClient().getLocUiAsString(),
							MediaFac.MEDIAART_FUSSTEXT);
			if (gsTextDtoFuss == null) {
				DelegateFactory.getInstance().getRechnungServiceDelegate().createDefaultGutschrifttext(
						MediaFac.MEDIAART_FUSSTEXT, RechnungServiceFac.GUTSCHRIFT_DEFAULT_FUSSTEXT,
						LPMain.getInstance().getTheClient().getLocUiAsString());
			}
			String[] aWhichStandardButtonIUse = null;
			panelQueryGutschrifttext = new PanelQuery(null, null, QueryParameters.UC_ID_GUTSCHRIFTTEXT,
					aWhichStandardButtonIUse, getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.gutschrifttext"), true);
			panelBottomGutschrifttext = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.gutschrifttext"), null,
					HelperClient.SCRUD_GUTSCHRIFTTEXT_FILE, getInternalFrame(), HelperClient.LOCKME_RECHNUNGTEXT);
			panelSplitGutschrifttext = new PanelSplit(getInternalFrame(), panelBottomGutschrifttext,
					panelQueryGutschrifttext,
					400 - ((PanelStammdatenCRUD) panelBottomGutschrifttext).getAnzahlControls() * 30);
	...
	private void refreshPanelMahntext() throws Throwable {
		if (panelSplitMahntext == null) {
			MahntextDto mahntextDto1 = DelegateFactory.getInstance().getFinanzServiceDelegate()
					.mahntextFindByMandantLocaleCNr(LPMain.getInstance().getTheClient().getLocUiAsString(),
							new Integer(FinanzServiceFac.MAHNSTUFE_1));
			if (mahntextDto1 == null) {
				DelegateFactory.getInstance().getFinanzServiceDelegate().createDefaultMahntext(
						new Integer(FinanzServiceFac.MAHNSTUFE_1), FinanzServiceFac.DEFAULT_TEXT_MAHNSTUFE_1);
			}
			...
			if (mahntextDto2 == null) {
				DelegateFactory.getInstance().getFinanzServiceDelegate().createDefaultMahntext(
						new Integer(FinanzServiceFac.MAHNSTUFE_2), FinanzServiceFac.DEFAULT_TEXT_MAHNSTUFE_2);
			}
			...
			if (mahntextDto3 == null) {
				DelegateFactory.getInstance().getFinanzServiceDelegate().createDefaultMahntext(
						new Integer(FinanzServiceFac.MAHNSTUFE_3), FinanzServiceFac.DEFAULT_TEXT_MAHNSTUFE_3);
			}
			...
			if (mahntextDto99 == null) {
				DelegateFactory.getInstance().getFinanzServiceDelegate().createDefaultMahntext(
						new Integer(FinanzServiceFac.MAHNSTUFE_99), FinanzServiceFac.DEFAULT_TEXT_MAHNSTUFE_99);
			}
			String[] aWhichStandardButtonIUse = { PanelBasis.ACTION_NEW };

			panelQueryMahntext = new PanelQuery(null, null, QueryParameters.UC_ID_MAHNTEXT, aWhichStandardButtonIUse,
					getInternalFrame(), LPMain.getInstance().getTextRespectUISPr("lp.mahntext"), true);

			panelBottomMahntext = new PanelStammdatenCRUD(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.mahntext"), null, HelperClient.SCRUD_MAHNTEXT_FILE,
					getInternalFrame(), HelperClient.LOCKME_MAHNTEXT);

			panelSplitMahntext = new PanelSplit(getInternalFrame(), panelBottomMahntext, panelQueryMahntext,
					400 - ((PanelStammdatenCRUD) panelBottomMahntext).getAnzahlControls() * 30);
