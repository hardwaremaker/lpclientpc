 ...
 */
public class ReportWarenausgangsjournal extends PanelReportJournalVerkauf implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportWarenausgangsjournal(InternalFrame internalFrame, String add2Title) throws Throwable {
	...
	private void jbInit() throws Exception {
		...
		jpaWorkingOn.add(wrbSortierungArtikel, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		wcbGruppierungNachStatistikAdresse
				.setText(LPMain.getTextRespectUISPr("warenausgang.gruppierung.nachstatistikadresse"));
		wcbGruppierungNachStatistikAdresse.setEnabled(true);

		wcbMitTexeingaben.setText(LPMain.getTextRespectUISPr("part.kunde.lieferstatistik.mittexteingaben"));
		wcbMitTexeingaben.setEnabled(true);
		jpaWorkingOn.add(wcbMitTexeingaben, new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wcbGruppierungNachStatistikAdresse, new GridBagConstraints(0, iZeile, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		wcbGutschriftenDrucken.setText(LPMain.getTextRespectUISPr("warenausgang.gutschriften.drucken"));
		wcbGutschriftenDrucken.setEnabled(true);
		wcbGutschriftenDrucken.setSelected(true);
		jpaWorkingOn.add(wcbGutschriftenDrucken, new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
