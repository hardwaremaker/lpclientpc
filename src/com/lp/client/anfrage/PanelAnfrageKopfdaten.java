...
public class PanelAnfrageKopfdaten extends PanelBasis {
	...
	private Integer anfragerIId=null;
	...
	public final static String ACTION_SPECIAL_ANFRAGER = "action_special_anforderer";

	private WrapperButton wbuAnfrager = null;
	private PanelQueryFLR panelQueryFLRAnfrager = null;
	private WrapperTextField wtfAnfrager = null;
	...
	private WrapperLabel wlaAbgabeterminAngebot = null;
	private WrapperDateField wdfAbgabeterminAngebot = null;
	...
	public PanelAnfrageKopfdaten(InternalFrame internalFrame, String add2TitleI, Object key) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wlaAnfrageart = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.anfrageart"));
		...
		wlaBelegdatum.setText(LPMain.getInstance().getTextRespectUISPr("label.belegdatum"));
		...
		jpaLieferant = new WrapperGotoLieferantMapButton(new IPartnerDto() {
			public PartnerDto getPartnerDto() {
				return tpAnfrage.getLieferantDto() == null ? null : tpAnfrage.getLieferantDto().getPartnerDto();
			}
		});
		jpaLieferant.setActionCommand(ACTION_SPECIAL_LIEFERANT);
		jpaLieferant.setText(LPMain.getInstance().getTextRespectUISPr("button.lieferant"));
		...
		wlaLieferantAbteilung = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("lp.abteilung"));
		...
		wbuLiefergruppe.setText(LPMain.getInstance().getTextRespectUISPr("part.liefergruppe.flr"));
		...
		wlaProjekt = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("label.projekt"));
		wtfProjekt = new WrapperTextField();
		wtfProjekt.setColumnsMax(80);

		wlaWaehrung = new WrapperLabel(LPMain.getTextRespectUISPr("label.waehrung"));

		wcbWaehrung = new WrapperComboBox();
		wcbWaehrung.setMandatoryFieldDB(true);

		wcbWaehrung.addActionListener(new PanelAnfrageKopfdaten_wcoWaehrungen_actionAdapter(this));

		wlaKurs = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("label.kurs"));
		...
		wlaAnliefertermin = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.anliefertermin"));

		wdfAnliefertermin = new WrapperDateField();

		wlaAbgabeterminAngebot = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.abgabeterminangebot"));
		wdfAbgabeterminAngebot = new WrapperDateField();
		...
		wlaBestellungen = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.bestellungen"));
		...
		wlaErzeugteAnfragen = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.erzeugteanfragen"));
		...
		wlaLiefergruppenanfrage = new WrapperLabel(
				LPMain.getInstance().getTextRespectUISPr("anf.liefergruppenanfrage"));
		...
		wlaAnfrageerledigungsgrund = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("anf.erledigungsgrund"));
		wtfAnfrageerledigungsgrund = new WrapperTextField();
		wtfAnfrageerledigungsgrund.setActivatable(false);

		wbuAnfrager = new WrapperButton();
		wbuAnfrager.setText(LPMain.getTextRespectUISPr("anf.button.anfrager"));
		wbuAnfrager.setActionCommand(ACTION_SPECIAL_ANFRAGER);
		wbuAnfrager.addActionListener(this);

		wtfAnfrager = new WrapperTextField();
		wtfAnfrager.setActivatable(false);
		wtfAnfrager.setColumnsMax(Facade.MAX_UNBESCHRAENKT);

		// Zeile
		jPanelWorkingOn.add(wlaAnfrageart, new GridBagConstraints(0, iZeile, 1, 1, 0.3, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jPanelWorkingOn.add(wcoAnfrageart, new GridBagConstraints(1, iZeile, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jPanelWorkingOn.add(wlaBelegdatum, new GridBagConstraints(2, iZeile, 1, 1, 0.3, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jPanelWorkingOn.add(wdfBelegdatum, new GridBagConstraints(3, iZeile, 1, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(jpaLieferant, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfLieferant, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wtfLieferantAdresse, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wlaLieferantAbteilung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfLieferantAbteilung, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wbuAnsprechpartner, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAnsprechpartner, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		
		iZeile++;
		jPanelWorkingOn.add(wbuAnfrager, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAnfrager, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wbuLieferadresse, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfLieferadresse, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wbuAnsprechpartnerLieferadresse, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAnsprechpartnerLieferadresse, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wbuLiefergruppe, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfLiefergruppe, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;

		jPanelWorkingOn.add(wlaProjekt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
		...
		if (LPMain.getInstance().getDesktop()
			...
			jPanelWorkingOn.add(wtfProjekt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(10, 2, 2, 2), 0, 0));

			jPanelWorkingOn.add(wsfProjekt.getWrapperGotoButton(), new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 2, 2, 2), 0, 0));
			jPanelWorkingOn.add(wsfProjekt.getWrapperTextField(), new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 2, 2, 2), 0, 0));

		} else {

			jPanelWorkingOn.add(wtfProjekt, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(10, 2, 2, 2), 0, 0));
		}

		// Zeile
		iZeile++;
		jPanelWorkingOn.add(wlaWaehrung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wcbWaehrung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaKurs, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wnfKurs, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile
		iZeile++;
		jPanelWorkingOn.add(wlaAnliefertermin, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wdfAnliefertermin, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jPanelWorkingOn.add(wlaAbgabeterminAngebot, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wdfAbgabeterminAngebot, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile
		iZeile++;
		jPanelWorkingOn.add(wbuKostenstelle, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfKostenstelle, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wlaAnfrageerledigungsgrund, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAnfrageerledigungsgrund, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wlaBestellungen, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtaBestellungen, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wlaErzeugteAnfragen, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtaErzeugteAnfragen, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jPanelWorkingOn.add(wlaLiefergruppenanfrage, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfLiefergruppenanfrage, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	}
	...
	public void setDefaults() throws Throwable {
		...
		ParametermandantDto parameter = (ParametermandantDto) DelegateFactory.getInstance().getParameterDelegate()
				.getParametermandant(ParameterFac.PARAMETER_ANGEBOTSABGABETERMIN_OFFSET, ParameterFac.KATEGORIE_ANFRAGE,
						LPMain.getInstance().getTheClient().getMandant());

		Integer iTage = (Integer) parameter.getCWertAsObject();

		wdfAbgabeterminAngebot.setDate(Helper.addiereTageZuDatum(new Date(System.currentTimeMillis()), iTage));
		...
		kostenstelleDto = DelegateFactory.getInstance().getPersonalDelegate()
		...
		PersonalDto anfragerDto = DelegateFactory.getInstance().getPersonalDelegate()
				.personalFindByPrimaryKey(LPMain.getTheClient().getIDPersonal());
		anfragerIId=anfragerDto.getIId();
		
		wtfAnfrager.setText(anfragerDto.getPartnerDto().formatAnrede());
		
		
	}

	public void initPanel() throws Throwable {
		wcoAnfrageart.setMap(DelegateFactory.getInstance().getAnfrageServiceDelegate()
	...
	protected void eventItemchanged(EventObject eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			if (e.getSource() == panelQueryFLRLieferant) {
				Object iIdLieferant = ((ISourceEvent) e.getSource()).getIdSelected();
				...
				if (iIdLieferant != null) {
					if (tpAnfrage.getAnfrageDto().getWaehrungCNr() != null) {
						waehrungOriDto = DelegateFactory.getInstance().getLocaleDelegate()
								.waehrungFindByPrimaryKey(tpAnfrage.getAnfrageDto().getWaehrungCNr());
					}

					tpAnfrage.setLieferantDto(DelegateFactory.getInstance().getLieferantDelegate()
							.lieferantFindByPrimaryKey((Integer) iIdLieferant));

					wtfLieferant.setText(tpAnfrage.getLieferantDto().getPartnerDto().formatTitelAnrede());
					wtfLieferantAdresse.setText(tpAnfrage.getLieferantDto().getPartnerDto().formatAdresse());
					wtfLieferantAbteilung
							.setText(tpAnfrage.getLieferantDto().getPartnerDto().getCName3vorname2abteilung());
					jpaLieferant.setOKey(tpAnfrage.getLieferantDto().getIId());
					...
					ParametermandantDto parameter = (ParametermandantDto) DelegateFactory.getInstance()
							.getParameterDelegate().getParametermandant(ParameterFac.PARAMETER_ANFRAGE_ANSP_VORBESETZEN,
									ParameterFac.KATEGORIE_ANFRAGE, LPMain.getInstance().getTheClient().getMandant());
					if ((Boolean) parameter.getCWertAsObject()) {
						anspDtoTemp = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
								.ansprechpartnerFindErstenEinesPartnersOhneExc(
										tpAnfrage.getLieferantDto().getPartnerIId());
					}
					if (anspDtoTemp != null) {
					...
					waehrungDto = DelegateFactory.getInstance().getLocaleDelegate()
							.waehrungFindByPrimaryKey(tpAnfrage.getLieferantDto().getWaehrungCNr());
					wcbWaehrung.setSelectedItem(waehrungDto.getCNr());
					setzeWechselkurs();

					if (waehrungOriDto.getCNr() != null
							&& !waehrungOriDto.getCNr().equals(wcbWaehrung.getSelectedItem())) {
						...
						aOptionen[indexWaehrungNeuCNr] = wcbWaehrung.getSelectedItem();

						int iAuswahl = DialogFactory.showModalDialog(getInternalFrame(),
								LPMain.getInstance().getTextRespectUISPr("lp.waehrungunterschiedlich"),
					...
					if (tpAnfrage.getLieferantDto().getIIdKostenstelle() != null) {
						kostenstelleDto = DelegateFactory.getInstance().getSystemDelegate()
								.kostenstelleFindByPrimaryKey(tpAnfrage.getLieferantDto().getIIdKostenstelle());
				...
				AnsprechpartnerDto ansprechpartnerLieferadresseDto = DelegateFactory.getInstance()
				...
				tpAnfrage.getAnfrageDto().setAnsprechpartnerIIdLieferadresse(iIdAnsprechpartner);
			} else if (e.getSource() == panelQueryFLRAnfrager) {
				...
				tpAnfrage.getAnfrageDto().setPersonalIIdAnfrager(pkPersonal);
				
				anfragerIId=pkPersonal;
				

			} else if (e.getSource() == this.panelQueryFLRLieferadresse) {
				Integer pkPartner = (Integer) ((ISourceEvent) e.getSource()).getIdSelected();
				PartnerDto lieferadresseDto = DelegateFactory.getInstance().getPartnerDelegate()
						.partnerFindByPrimaryKey(pkPartner);

				wtfLieferadresse.setText(lieferadresseDto.formatAnrede());
				tpAnfrage.getAnfrageDto().setPartnerIIdLieferadresse(pkPartner);

			} else if (e.getSource() == panelQueryFLRLiefergruppe) {
				Object liefergruppeIId = ((ISourceEvent) e.getSource()).getIdSelected();

				if (liefergruppeIId != null) {
					tpAnfrage.setLiefergruppeDto(DelegateFactory.getInstance().getLieferantServicesDelegate()
							.lfliefergruppeFindByPrimaryKey((Integer) liefergruppeIId));

					String liefergruppeCBez = tpAnfrage.getLiefergruppeDto().getCNr();
					if (tpAnfrage.getLiefergruppeDto().getLfliefergruppesprDto() != null
							&& tpAnfrage.getLiefergruppeDto().getLfliefergruppesprDto().getCBez() != null) {
						liefergruppeCBez = tpAnfrage.getLiefergruppeDto().getLfliefergruppesprDto().getCBez();
					}

					wtfLiefergruppe.setText(liefergruppeCBez);
				}
			} else if (e.getSource() == panelQueryFLRAnsprechpartner) {
				Object iIdAnsprechpartner = ((ISourceEvent) e.getSource()).getIdSelected();

				if (iIdAnsprechpartner != null) {
					ansprechpartnerDto = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
							.ansprechpartnerFindByPrimaryKey((Integer) iIdAnsprechpartner);
			...
			if (e.getSource() == panelQueryFLRAnsprechpartner) {
				...
				tpAnfrage.getAnfrageDto().setPartnerIIdLieferadresse(null);
				wtfLieferadresse.setText("");
				components2Dto();
			} else if (e.getSource() == panelQueryFLRAnsprechpartnerLieferadresse) {
				tpAnfrage.getAnfrageDto().setAnsprechpartnerIIdLieferadresse(null);
				wtfAnsprechpartnerLieferadresse.setText("");
			} else if (e.getSource() == panelQueryFLRAnfrager) {
				tpAnfrage.getAnfrageDto().setPersonalIIdAnfrager(null);
				anfragerIId=null;
				wtfAnfrager.setText("");
			}
		}
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI, boolean bNeedNoNewI) throws Throwable {
		...
		tpAnfrage.resetDtos();
		tpAnfrage.setTitleAnfrage(LPMain.getInstance().getTextRespectUISPr("anf.anfrage"));
	...
	public void eventActionNewLiefergruppenanfrage(EventObject eventObject, boolean bLockMeI, boolean bNeedNoNewI)
			throws Throwable {
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		...
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_ANSPRECHPARTNER_LIEFERANT)) {
		...
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_ANFRAGER)) {
			dialogQueryAnfrager();
	...
	private void dialogQueryAnfrager() throws Throwable {

		panelQueryFLRAnfrager = PersonalFilterFactory.getInstance().createPanelFLRPersonal(getInternalFrame(), true,
				true, tpAnfrage.getAnfrageDto().getPersonalIIdAnfrager());
		new DialogQuery(panelQueryFLRAnfrager);

	}

	private void dialogQueryLieferant() throws Throwable {
		panelQueryFLRLieferant = PartnerFilterFactory.getInstance().createPanelFLRLieferant(intFrame,
	...
	private void dialogQueryLiefergruppe() throws Throwable {
		panelQueryFLRLiefergruppe = PartnerFilterFactory.getInstance().createPanelFLRLiefergruppeMindestensEinLieferant(
				intFrame, false, false, tpAnfrage.getLiefergruppeDto().getIId()); // UW->JO,
																					// //beim
																					// sort()
																					// seltsame
																					// Hibernate
	...
	private void dialogQueryAnsprechpartnerLieferadresse() throws Throwable {
		Integer ansprechpartnerIId = tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferadresse();
		panelQueryFLRAnsprechpartnerLieferadresse = PartnerFilterFactory.getInstance().createPanelFLRAnsprechpartner(
				getInternalFrame(), tpAnfrage.getAnfrageDto().getPartnerIIdLieferadresse(), ansprechpartnerIId, true,
				true);
	...
	private void dialogQueryLieferadresse() throws Throwable {
		...
		panelQueryFLRLieferadresse = new PanelQueryFLR(null, null, QueryParameters.UC_ID_PARTNER, aWhichButtonIUse,
				getInternalFrame(), LPMain.getTextRespectUISPr("bes.title.lieferadresseauswahlliste"));
	...
	private void dialogQueryAnsprechpartnerLieferant() throws Throwable {
		if (tpAnfrage.getLieferantDto().getIId() == null) {
			DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.error"),
					LPMain.getInstance().getTextRespectUISPr("lp.error.lieferantnichtgewaehlt"));
		} else {
			panelQueryFLRAnsprechpartner = PartnerFilterFactory.getInstance().createPanelFLRAnsprechpartner(intFrame,
					tpAnfrage.getLieferantDto().getPartnerDto().getIId(),
					tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferant(), true, true);
	...
	private void dto2Components() throws Throwable {
		if (tpAnfrage.pruefeAktuelleAnfrage()) {
			...
			jpaLieferant.setOKey(tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse());
			wdfBelegdatum.setDate(tpAnfrage.getAnfrageDto().getTBelegdatum());

			wtfProjekt.setText(tpAnfrage.getAnfrageDto().getCBez());
			wcbWaehrung.setSelectedItem(tpAnfrage.getAnfrageDto().getWaehrungCNr());
			wnfKurs.setDouble(tpAnfrage.getAnfrageDto().getFWechselkursmandantwaehrungzubelegwaehrung());

			wdfAnliefertermin.setDate(tpAnfrage.getAnfrageDto().getTAnliefertermin());
			wdfAbgabeterminAngebot.setDate(tpAnfrage.getAnfrageDto().getTAbgabetermin());

			kostenstelleDto = DelegateFactory.getInstance().getSystemDelegate()
					.kostenstelleFindByPrimaryKey(tpAnfrage.getAnfrageDto().getKostenstelleIId());
			wtfKostenstelle.setText(kostenstelleDto.getCBez());

			// zu dieser Anfrage erfasste Bestellungen anzeigen
			BestellungDto[] aBestellungDto = DelegateFactory.getInstance().getBestellungDelegate()
			...
			if (tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERGRUPPE)
					&& tpAnfrage.getAnfrageDto().getIId() != null) {
				AnfrageDto[] aAnfrageDto = DelegateFactory.getInstance().getAnfrageDelegate()
						.anfrageFindByAnfrageIIdLiefergruppenanfrage(tpAnfrage.getAnfrageDto().getIId());
				wtaErzeugteAnfragen.setText(formatAnfragen(aAnfrageDto));
			}

			if (tpAnfrage.getAnfrageDto().getAnfrageIIdLiefergruppenanfrage() != null) {
				AnfrageDto liefergruppenanfrageDto = DelegateFactory.getInstance().getAnfrageDelegate()
						.anfrageFindByPrimaryKey(tpAnfrage.getAnfrageDto().getAnfrageIIdLiefergruppenanfrage());
				wtfLiefergruppenanfrage.setText(liefergruppenanfrageDto.getCNr());
			}

			if (tpAnfrage.getAnfrageDto().getPersonalIIdAnfrager() != null) {
				PersonalDto anfrageeDto = DelegateFactory.getInstance().getPersonalDelegate()
						.personalFindByPrimaryKey(tpAnfrage.getAnfrageDto().getPersonalIIdAnfrager());
				wtfAnfrager.setText(anfrageeDto.getPartnerDto().formatAnrede());
			} else {
				wtfAnfrager.setText("");
			}
			...
			if (tpAnfrage.getAnfrageDto().getAnfrageerledigungsgrundIId() != null) {
				...
				AnfrageerledigungsgrundDto grundDto = DelegateFactory.getInstance().getAnfrageServiceDelegate()
						.anfrageerledigungsgrundFindByPrimaryKey(
								tpAnfrage.getAnfrageDto().getAnfrageerledigungsgrundIId());
			...
			if (tpAnfrage.getAnfrageDto().getPartnerIIdLieferadresse() != null) {
				PartnerDto lieferadresseDto = DelegateFactory.getInstance().getPartnerDelegate()
						.partnerFindByPrimaryKey(tpAnfrage.getAnfrageDto().getPartnerIIdLieferadresse());

				wtfLieferadresse.setText(lieferadresseDto.formatAnrede());
			} else {
				wtfLieferadresse.setText(null);
			}
			if (tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferadresse() != null) {
				AnsprechpartnerDto ansprechpartnerLieferadresseDto = DelegateFactory.getInstance()
						.getAnsprechpartnerDelegate().ansprechpartnerFindByPrimaryKey(
								tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferadresse());
				wtfAnsprechpartnerLieferadresse
						.setText(ansprechpartnerLieferadresseDto.formatFixTitelVornameNachnameNTitel());
			} else {
				wtfAnsprechpartnerLieferadresse.setText(null);
	...
	private void components2Dto() throws Throwable {
		if (tpAnfrage.getAnfrageDto() == null || tpAnfrage.getAnfrageDto().getIId() == null) {
			...
			tpAnfrage.getAnfrageDto().setMandantCNr(LPMain.getInstance().getTheClient().getMandant());
			tpAnfrage.getAnfrageDto().setArtCNr((String) wcoAnfrageart.getKeyOfSelectedItem());
			tpAnfrage.getAnfrageDto().setStatusCNr(AnfrageServiceFac.ANFRAGESTATUS_ANGELEGT);
			tpAnfrage.getAnfrageDto().setBelegartCNr(LocaleFac.BELEGART_ANFRAGE);
			tpAnfrage.getAnfrageDto().setFAllgemeinerRabattsatz(new Double(0));

			// Konditionen vorbelegen
			if (tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERANT)) {

				// Aufgrund SP8891 auskommentiert
				/*
				...
				if (tpAnfrage.getLieferantDto().getLieferartIId() != null) {
					tpAnfrage.getAnfrageDto().setLieferartIId(tpAnfrage.getLieferantDto().getLieferartIId());
				}
				if (tpAnfrage.getLieferantDto().getZahlungszielIId() != null) {
					tpAnfrage.getAnfrageDto().setZahlungszielIId(tpAnfrage.getLieferantDto().getZahlungszielIId());
				}

				if (tpAnfrage.getLieferantDto().getIdSpediteur() != null) {
					tpAnfrage.getAnfrageDto().setSpediteurIId(tpAnfrage.getLieferantDto().getIdSpediteur());
				}
			}

			tpAnfrage.getAnfrageDto().setPersonalIIdAnfrager(anfragerIId);
			
			
			tpAnfrage.getAnfrageDto().setNTransportkosteninanfragewaehrung(new BigDecimal(0));

			// speziell in ANF: die Anfragetexte in Kopfdaten vorbelegen
			String localeCNr = LPMain.getInstance().getTheClient().getLocUiAsString();

			if (wcoAnfrageart.getKeyOfSelectedItem().equals(AnfrageServiceFac.ANFRAGEART_LIEFERANT)
					&& tpAnfrage.getLieferantDto().getPartnerDto().getLocaleCNrKommunikation() != null) {
				localeCNr = tpAnfrage.getLieferantDto().getPartnerDto().getLocaleCNrKommunikation();
			}

			AnfragetextDto anfragetextDto = DelegateFactory.getInstance().getAnfrageServiceDelegate()
					.anfragetextFindByMandantLocaleCNr(localeCNr, MediaFac.MEDIAART_KOPFTEXT);

			tpAnfrage.getAnfrageDto().setBelegtextIIdKopftext(anfragetextDto.getIId());

			anfragetextDto = DelegateFactory.getInstance().getAnfrageServiceDelegate()
					.anfragetextFindByMandantLocaleCNr(localeCNr, MediaFac.MEDIAART_FUSSTEXT);

			tpAnfrage.getAnfrageDto().setBelegtextIIdFusstext(anfragetextDto.getIId());
		...
		if (tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERANT)) {
			tpAnfrage.getAnfrageDto().setLieferantIIdAnfrageadresse(tpAnfrage.getLieferantDto().getIId());
			tpAnfrage.getAnfrageDto().setAnsprechpartnerIIdLieferant(ansprechpartnerDto.getIId());
		} else if (tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERGRUPPE)) {
			tpAnfrage.getAnfrageDto().setLiefergruppeIId(tpAnfrage.getLiefergruppeDto().getIId());
		}

		tpAnfrage.getAnfrageDto().setCBez(wtfProjekt.getText());
		tpAnfrage.getAnfrageDto().setWaehrungCNr((String) wcbWaehrung.getSelectedItem());
		tpAnfrage.getAnfrageDto().setFWechselkursmandantwaehrungzubelegwaehrung(wnfKurs.getDouble());
		tpAnfrage.getAnfrageDto().setTAnliefertermin(wdfAnliefertermin.getTimestamp());
		tpAnfrage.getAnfrageDto().setTAbgabetermin(wdfAbgabeterminAngebot.getTimestamp());
	...
	private void aktualisiereStatusbar() throws Throwable {
		...
		String status = DelegateFactory.getInstance().getVersandDelegate().getVersandstatus(LocaleFac.BELEGART_ANFRAGE,
				tpAnfrage.getAnfrageDto().getIId());
		if (status != null) {
			setStatusbarSpalte5(LPMain.getInstance().getTextRespectUISPr("lp.versandstatus") + ": " + status);
		} else {
			setStatusbarSpalte5("");
		}
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI) throws Throwable {
		...
		Integer oKey = tpAnfrage.getAnfrageDto().getIId();
		...
		if (oKey != null) {
			tpAnfrage.setAnfrageDto(
					DelegateFactory.getInstance().getAnfrageDelegate().anfrageFindByPrimaryKey((Integer) oKey));

			if (tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse() != null) {
				tpAnfrage.setLieferantDto(DelegateFactory.getInstance().getLieferantDelegate()
						.lieferantFindByPrimaryKey(tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse()));
			}

			dto2Components();

			tpAnfrage.setTitleAnfrage(LPMain.getInstance().getTextRespectUISPr("anf.panel.kopfdaten"));
		}

		// statuskopfdaten: 1
		tpAnfrage.getAnfrageKopfdaten().updateButtons(getLockedstateDetailMainKey());
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI) throws Throwable {
		if (allMandatoryFieldsSetDlg()) {
			...
			if (tpAnfrage.getAnfrageDto().getIId() == null) {
				Integer iIdAnfrage = DelegateFactory.getInstance().getAnfrageDelegate()
						.createAnfrage(tpAnfrage.getAnfrageDto());

				tpAnfrage.setAnfrageDto(
						DelegateFactory.getInstance().getAnfrageDelegate().anfrageFindByPrimaryKey(iIdAnfrage));

				setKeyWhenDetailPanel(iIdAnfrage);
				if (tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse() != null) {
					DelegateFactory.getInstance().getLieferantDelegate().pruefeLieferant(
							tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse(), LocaleFac.BELEGART_ANFRAGE,
							getInternalFrame());
				}
			} else {
				...
				if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_OFFEN)) {
					if (DialogFactory.showMeldung(LPMain.getInstance().getTextRespectUISPr("lp.hint.offennachangelegt"),
				...
				// PJ18030
				AnfrageDto aDtoVorhanden = DelegateFactory.getInstance().getAnfrageDelegate()
						.anfrageFindByPrimaryKey(tpAnfrage.getAnfrageDto().getIId());
				if (aDtoVorhanden.getLieferantIIdAnfrageadresse() != null
						&& !aDtoVorhanden.getLieferantIIdAnfrageadresse()
								.equals(tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse())) {

					DialogGeaenderteKonditionenEK dialog = new DialogGeaenderteKonditionenEK(tpAnfrage.getAnfrageDto(),
							tpAnfrage.getAnfrageDto().getLieferantIIdAnfrageadresse(), getInternalFrame());
					...
					if (dialog.bKonditionenUnterschiedlich == true) {
						...
						if (dialog.bAbgebrochen == false) {
							tpAnfrage.setAnfrageDto((AnfrageDto) dialog.getBelegDto());
						} else {
							bUpdate = false;
						}
					}
				...
				if (bUpdate) {
					DelegateFactory.getInstance().getAnfrageDelegate().updateAnfrage(tpAnfrage.getAnfrageDto(), true,
...
//			tpAnfrage.checkDisableTabs();
	...
	protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI, boolean bNeedNoDeleteI)
			throws Throwable {
		if (!isLockedDlg()) {
			DelegateFactory.getInstance().getAnfrageDelegate().storniereAnfrage(tpAnfrage.getAnfrageDto().getIId());
	...
	public boolean handleOwnException(ExceptionLP exfc) {
		...
		case EJBExceptionLP.FEHLER_BELEG_WURDE_NICHT_MANUELL_ERLEDIGT:
			DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.error"),
					LPMain.getInstance().getTextRespectUISPr("lp.error.manuellerledigen"));
			break;
	...
	private void setzeAnfrageart(String cNrAnfrageartI) throws Throwable {
		...
		wcoAnfrageart.setKeyOfSelectedItem(tpAnfrage.getAnfrageDto().getArtCNr());
		...
		if (cNrAnfrageartI.equals(AnfrageServiceFac.ANFRAGEART_LIEFERANT)) {
			...
			if (tpAnfrage.getLieferantDto() != null) {
				wtfLieferant.setText(tpAnfrage.getLieferantDto().getPartnerDto().formatTitelAnrede());
				wtfLieferantAdresse.setText(tpAnfrage.getLieferantDto().getPartnerDto().formatAdresse());
				wtfLieferantAbteilung.setText(tpAnfrage.getLieferantDto().getPartnerDto().getCName3vorname2abteilung());
			}

			if (tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferant() != null) {
				ansprechpartnerDto = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
						.ansprechpartnerFindByPrimaryKey(tpAnfrage.getAnfrageDto().getAnsprechpartnerIIdLieferant());
		...
		} else if (cNrAnfrageartI.equals(AnfrageServiceFac.ANFRAGEART_LIEFERGRUPPE)) {
			jpaLieferant.setEnabled(false);
			wbuAnsprechpartner.setEnabled(false);
			wbuLieferadresse.setEnabled(false);
			wbuAnsprechpartnerLieferadresse.setEnabled(false);
			...
			if (tpAnfrage.getAnfrageDto().getIId() == null) { // bei einer neuen
				...
				if ((tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_ANGELEGT)
						...
						&& DelegateFactory.getInstance().getAnfragepositionDelegate()
								.getAnzahlMengenbehafteteAnfragepositionen(tpAnfrage.getAnfrageDto().getIId()) <= 0
				...
				} else if ((tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_ANGELEGT)
						|| tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_OFFEN))
						&& DelegateFactory.getInstance().getAnfragepositionDelegate()
								.getAnzahlMengenbehafteteAnfragepositionen(tpAnfrage.getAnfrageDto().getIId()) > 0
						&& super.getLockedstateDetailMainKey().getIState() == LOCK_IS_LOCKED_BY_ME) {
	...
	public LockStateValue getLockedstateDetailMainKey() throws Throwable {
		...
		if (tpAnfrage.getAnfrageDto().getIId() != null) {
			if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_OFFEN)
					&& tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERGRUPPE)) {
				lockStateValue = new LockStateValue(PanelBasis.LOCK_ENABLE_REFRESHANDUPDATEANDPRINT_ONLY);
			} else if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_STORNIERT)) {
				lockStateValue = new LockStateValue(PanelBasis.LOCK_ENABLE_REFRESHANDUPDATEANDPRINT_ONLY);
			} else if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_ERFASST)) {
				lockStateValue = new LockStateValue(PanelBasis.LOCK_ENABLE_REFRESHANDPRINT_ONLY);
			} else if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_ERLEDIGT)) {
				if (tpAnfrage.getAnfrageDto().getArtCNr().equals(AnfrageServiceFac.ANFRAGEART_LIEFERGRUPPE)) {
					lockStateValue = new LockStateValue(PanelBasis.LOCK_ENABLE_REFRESHANDPRINT_ONLY);
				} else {
					lockStateValue = new LockStateValue(PanelBasis.LOCK_ENABLE_REFRESHANDUPDATEANDPRINT_ONLY);
				}
			} else if (tpAnfrage.getAnfrageDto().getStatusCNr().equals(AnfrageServiceFac.ANFRAGESTATUS_OFFEN)
...
class PanelAnfrageKopfdaten_wcoWaehrungen_actionAdapter implements java.awt.event.ActionListener {

	private PanelAnfrageKopfdaten adaptee = null;

	public PanelAnfrageKopfdaten_wcoWaehrungen_actionAdapter(PanelAnfrageKopfdaten adaptee) {
