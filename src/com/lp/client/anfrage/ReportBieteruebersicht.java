...
public class ReportBieteruebersicht extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportBieteruebersicht(InternalFrameAnfrage internalFrame, Integer anfrageIId, String add2Title)
			throws Throwable {
	...
	public String getReportname() {
		return AnfrageReportFac.REPORT_BIETERUEBERSICHT;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getAnfrageReportDelegate().printBieteruebersicht(anfrageIId);
	}
