 ...
 */
public class ReportKassenjournal extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private Integer kassabuchIId=null;

	public ReportKassenjournal(InternalFrame internalFrame,Integer kassabuchIId,
			String sAdd2Title) throws Throwable {
		super(internalFrame, sAdd2Title);
		this.kassabuchIId=kassabuchIId;
		jbInit();
		setDefaults();
		initComponents();
	}
	...
	public String getReportname() {
		return FinanzReportFac.REPORT_KASSENJOURNAL;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory
				...
				.printKassenjournal(kassabuchIId, (Integer) wcoJahr.getKeyOfSelectedItem());
	}
