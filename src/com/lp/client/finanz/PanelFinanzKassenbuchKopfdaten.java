 ...
 */
public class PanelFinanzKassenbuchKopfdaten extends PanelBasis {
	/**
	 * 
	 */
	...
	private static final String ACTION_SPECIAL_KASSENBUCH_KONTO = "action_special_kassenbuch_konto";
	...
	private String[] getActionButtons() {
		...
		try {
			isChefBuchhalter = DelegateFactory.getInstance()
					.getTheJudgeDelegate()
		...
		if (bVollversion) {
			...
			return isChefBuchhalter ? new String[] { ACTION_UPDATE,
					ACTION_SAVE, ACTION_DELETE, ACTION_DISCARD }
					: new String[] {};
		} else {

			return isChefBuchhalter ? new String[] { ACTION_UPDATE,
					ACTION_SAVE, ACTION_DELETE, ACTION_DISCARD, ACTION_PRINT }
					: new String[] {};
		}
	...
	private void jbInit() throws Throwable {
		...
		wlaGueltigVon.setText(LPMain.getInstance().getTextRespectUISPr(
				"lp.gueltigab"));
		wcbHauptkassenbuch.setText(LPMain.getInstance().getTextRespectUISPr(
				"finanz.hauptkassenbuch"));
		...
		wlaBreite1.setMinimumSize(new Dimension(100, Defaults.getInstance()
				.getControlHeight()));
		wlaBreite1.setPreferredSize(new Dimension(100, Defaults.getInstance()
				.getControlHeight()));
		wlaGueltigBis.setText(LPMain.getInstance()
				.getTextRespectUISPr("lp.bis"));
		wtfKontoBezeichnung.setActivatable(false);
		wrapperLabel2.setMinimumSize(new Dimension(30, Defaults.getInstance()
				.getControlHeight()));
		wrapperLabel2.setPreferredSize(new Dimension(30, Defaults.getInstance()
				.getControlHeight()));
		...
		wcbNegativErlaubt.setText(LPMain.getInstance().getTextRespectUISPr(
				"finanz.negativerlaubt"));
		...
		this.add(getPanelStatusbar(), new GridBagConstraints(0, 2, 1, 1, 1.0,
				...
				new Insets(0, 0, 0, 0), 0, 0));
		jPanelWorkingOn.add(wlaBezeichnung, new GridBagConstraints(0, 0, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfBezeichnung, new GridBagConstraints(1, 0, 3, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfKontoNummer, new GridBagConstraints(1, 1, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wdfGueltigVon, new GridBagConstraints(1, 2, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaGueltigVon, new GridBagConstraints(0, 2, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wbuKonto, new GridBagConstraints(0, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wrapperLabel2, new GridBagConstraints(2, 4, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 0), 0, 0));
		jPanelWorkingOn.add(wtfKontoBezeichnung, new GridBagConstraints(2, 1,
				2, 1, 2.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wnfSaldo, new GridBagConstraints(1, 4, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaBreite1, new GridBagConstraints(0, 5, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaSaldo, new GridBagConstraints(0, 4, 1, 1, 0.0,
				0.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL,
				new Insets(3, 4, 1, 0), 0, 0));
		jPanelWorkingOn.add(wdfGueltigBis, new GridBagConstraints(1, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaGueltigBis, new GridBagConstraints(0, 3, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wcbHauptkassenbuch, new GridBagConstraints(2, 3, 2,
				1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wcbNegativErlaubt, new GridBagConstraints(2, 4, 2,
	...
	private void dto2Components() throws Throwable {
		KassenbuchDto kassenbuchDto = getTabbedPaneKassenbuch()
				.getKassenbuchDto();
		kontoDto = DelegateFactory.getInstance().getFinanzDelegate()
				.kontoFindByPrimaryKeySmall(kassenbuchDto.getKontoIId());
		dto2ComponentsKonto();
		...
		this.setStatusbarPersonalIIdAnlegen(kassenbuchDto
				.getPersonalIIdAnlegen());
		this.setStatusbarTAnlegen(kassenbuchDto.getTAnlegen());
		this.setStatusbarPersonalIIdAendern(kassenbuchDto
				.getPersonalIIdaendern());
		this.setStatusbarTAendern(kassenbuchDto.getTAendern());
	}

	private BigDecimal calculateSaldo(Integer kontoIId) throws ExceptionLP,
			Throwable {
		BuchenDelegate delegate = DelegateFactory.getInstance()
				.getBuchenDelegate();
		int geschaeftsjahr = getInternalFrameFinanz()
				.getIAktuellesGeschaeftsjahr();

		BigDecimal saldo = delegate.getSaldoVonKonto(kontoIId,
				getInternalFrameFinanz().getIAktuellesGeschaeftsjahr(), 12,
				true);
	...
	private void components2Dto() throws Throwable {
		...
		kassenbuchDto.setBHauptkassenbuch(Helper
				.boolean2Short(wcbHauptkassenbuch.isSelected()));
	...
	protected void eventActionDelete(ActionEvent e,
		...
		if (kassenbuchDto != null) {
			DelegateFactory.getInstance().getFinanzDelegate()
					.removeKassenbuch(kassenbuchDto);
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
			KassenbuchDto kassenbuchDto = DelegateFactory
					.getInstance()
					.getFinanzDelegate()
					.updateKassenbuch(
							getTabbedPaneKassenbuch().getKassenbuchDto());
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (!bNeedNoYouAreSelectedI) {
			...
			if (kassenbuchDto != null) {
				...
				getTabbedPaneKassenbuch().setKassenbuchDto(
						DelegateFactory.getInstance().getFinanzDelegate()
	...
	protected void eventActionPrint(ActionEvent e) throws Throwable {
		if (getTabbedPaneKassenbuch().getKassenbuchDto() != null) {
			if (!((InternalFrameFinanz) getInternalFrame()).getBVollversion()) {

				getInternalFrame()
						.showReportKriterien(
								new ReportKassenjournal(
										getInternalFrame(),
										getTabbedPaneKassenbuch()
												.getKassenbuchDto().getIId(),
										LPMain.getTextRespectUISPr("fb.report.kassenjournal")));
