...
public class ScriptParameterNichtGefundenError implements IErrorAction {
	public ScriptParameterNichtGefundenError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.parameternichtgefunden", allInfos.toArray());
	}
