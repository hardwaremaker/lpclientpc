...
public class LosausgabeHttpPostUnerwarteterStatusCodeError implements IErrorAction {
	...
	public String getMsg(ExceptionLP exception) {
		if (exception.getExceptionData() instanceof UnerwarteterStatusCodeBeiHttpLosExc) {
			...
			return LPMain.getMessageTextRespectUISPr("fert.losausgabe.error.http.statuscode", 
