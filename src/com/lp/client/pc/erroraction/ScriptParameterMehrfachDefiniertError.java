...
public class ScriptParameterMehrfachDefiniertError implements IErrorAction {
	public ScriptParameterMehrfachDefiniertError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.parametermehrfachdefiniert", allInfos.toArray());
	}
