...
public class ScriptInstanzierungNichtMoeglichIOError implements IErrorAction {
	public ScriptInstanzierungNichtMoeglichIOError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.nichtinstanzierbario", allInfos.toArray());
	}
