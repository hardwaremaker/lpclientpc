...
public class ScriptKlasseNichtGefundenError implements IErrorAction {
	public ScriptKlasseNichtGefundenError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.klassenichtgefunden", allInfos.toArray());
	}
