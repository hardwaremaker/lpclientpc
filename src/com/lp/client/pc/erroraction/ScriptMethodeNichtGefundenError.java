...
public class ScriptMethodeNichtGefundenError implements IErrorAction {
	public ScriptMethodeNichtGefundenError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.methodenichtgefunden", allInfos.toArray());
	}
