...
public class ScriptNichtUebersetzbarError implements IErrorAction {
	public ScriptNichtUebersetzbarError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.nichtuebersetzbar", allInfos.toArray());
	}
