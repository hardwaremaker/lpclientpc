...
public class ScriptFehlerhafterZugriffError implements IErrorAction {
	public ScriptFehlerhafterZugriffError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.fehlerhafterzugriff", allInfos.toArray());
	}
