...
public class ScriptMethodeNichtAufrufbarError implements IErrorAction {
	public ScriptMethodeNichtAufrufbarError() {	
	}
	
	@Override
	public String getMsg(ExceptionLP ex) {
		List<?> allInfos = ex.getAlInfoForTheClient();
		return LPMain.getMessageTextRespectUISPr("lp.script.methodenichtaufrufbar", allInfos.toArray());
	}
