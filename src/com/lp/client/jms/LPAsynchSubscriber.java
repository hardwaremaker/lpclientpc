 ...
 *
 * <p>
 * Diese Klasse kuemmert sich um alle asynchronen Jobs, die an den Server gehen.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Erstellung: Josef Ornetsmueller; 28.06.06
 * </p>
 *
 * <p>
 * @author $Author: adi $
 ...
 */
public class LPAsynchSubscriber implements MessageListener {
	...
	public LPAsynchSubscriber() throws NamingException, JMSException {
		...
		try {
			...
			queueSender = (javax.jms.Queue) initialContext.lookup("queue/LPQueue");
		} catch (Throwable e) {
			//WILDFLY
			connectionFactory = (ConnectionFactory) initialContext.lookup("jms/RemoteConnectionFactory");
			connection = connectionFactory.createConnection("jmsuser","jmsuser");
			queueSender = (javax.jms.Queue) initialContext.lookup("jms/queue/LPQueue");
		}
	 ...
	 */
	public ArrayList<Object> browse() throws Exception {
	 ...
	 * @throws Exception
	 */
	public void send(LPMessage lPMessageI) throws JMSException, Exception {
	...
	public LPMessage getLpmLast() throws JMSException {
