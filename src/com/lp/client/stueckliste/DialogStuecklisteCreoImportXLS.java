...
public class DialogStuecklisteCreoImportXLS extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public DialogStuecklisteCreoImportXLS(byte[] xlsDatei, TabbedPaneStueckliste tpPartner) throws Throwable {
		super(LPMain.getInstance().getDesktop(), "Creo-XLS importieren", true);
	...
	private void jbInit() throws Throwable {
		...
		ImportErroInfo info = DelegateFactory.getInstance().getStuecklisteDelegate()
				.pruefeUndImportiereCreoXLS(xlsDatei, false, false);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(wbuImportieren)) {
			try {
				ImportErroInfo info = DelegateFactory.getInstance().getStuecklisteDelegate()
						.pruefeUndImportiereCreoXLS(xlsDatei, true, wcbVorhandenePositionenLoeschen.isSelected());
