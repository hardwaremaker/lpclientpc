...
public class ReportStklPruefplan extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportStklPruefplan(InternalFrameStueckliste internalFrame, String add2Title, Integer stuecklisteIId)
			throws Throwable {
	...
	private void jbInit() throws Exception {
		...
		jpaWorkingOn.add(wlaStueckliste, new GridBagConstraints(0, 0, 1, 1, 0.5, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtStueckliste, new GridBagConstraints(1, 0, 2, 1, 1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		
		wcbAlle.setText(LPMain.getTextRespectUISPr("stkl.report.pruefplan.alle"));
		
		jpaWorkingOn.add(wcbAlle, new GridBagConstraints(1, 1, 2, 1, 1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
	...
	public String getReportname() {
		return StuecklisteReportFac.REPORT_STUECKLISTE_PRUEFPLAN;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		if (wcbAlle.isSelected()) {
			return DelegateFactory.getInstance().getStuecklisteReportDelegate().printPruefplan(null);
		} else {
			return DelegateFactory.getInstance().getStuecklisteReportDelegate().printPruefplan(stuecklisteIId);
		}
