...
public class ReportWaffenregister extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportWaffenregister(InternalFrameStueckliste internalFrame,
	...
	public String getReportname() {
		return StuecklisteReportFac.REPORT_STUECKLISTE_WAFFENREGISTER;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		JasperPrintLP p = DelegateFactory
				...
				.printWaffenregister(stuecklisteIId);
		return p;
