...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportFreigabe(InternalFrameStueckliste internalFrame,
                           String add2Title, Integer stuecklisteIId)
      throws Throwable {
    super(internalFrame, add2Title);
    LPMain.getInstance().getTextRespectUISPr("stk.report.freigabe");
  ...
  public String getReportname() {
    return StuecklisteReportFac.REPORT_STUECKLISTE_FREIGABE;
  }
  ...
  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getStuecklisteReportDelegate().printFreigabe(
        stuecklisteIId);
  }
