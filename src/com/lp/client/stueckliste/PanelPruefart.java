...
public class PanelPruefart extends PanelBasis {
	...
	private PruefartDto pruefartDto = null;

	public PanelPruefart(InternalFrame internalFrame, String add2TitleI,
	...
	protected void components2Dto() {
		...
		if (pruefartDto.getPruefartsprDto() == null) {
			pruefartDto.setPruefartsprDto(new PruefartsprDto());
		}
		pruefartDto.getPruefartsprDto().setCBez(wtfBezeichnung.getText());
		pruefartDto.setCNr(wtfKennung.getText());
	}

	protected void dto2Components() {
		if (pruefartDto.getPruefartsprDto() != null) {
			wtfBezeichnung.setText(pruefartDto.getPruefartsprDto().getCBez());
		} else {
			wtfBezeichnung.setText(null);
		}

		wtfKennung.setText(pruefartDto.getCNr());
	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			DelegateFactory.getInstance().getStuecklisteDelegate()
					.updatePruefartspr(pruefartDto);

			super.eventActionSave(e, true);

			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame()
						.setKeyWasForLockMe(pruefartDto.getIId() + "");
			}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			pruefartDto = DelegateFactory.getInstance()
					.getStuecklisteDelegate()
					.pruefartFindByPrimaryKey((Integer) key);
