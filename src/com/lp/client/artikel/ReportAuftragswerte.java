...
public class ReportAuftragswerte extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperCheckBox wcbMitKonsignationslagern = null;
	...
	public ReportAuftragswerte(InternalFrameArtikel internalFrame,
			String add2Title) throws Throwable {
		super(internalFrame, add2Title);
		LPMain.getInstance().getTextRespectUISPr(
				"artikel.report.auftragswerte");
		jbInit();
		initComponents();
	...
	private void jbInit() throws Throwable {
		...
		wcbMitKonsignationslagern=new WrapperCheckBox(LPMain
				.getInstance()
				.getTextRespectUISPr(
						"artikel.auftragswerte.mitkonsigantionslagern"));
		...
		jpaWorkingOn.add(wcbMitKonsignationslagern,
	...
	public String getReportname() {
		return ArtikelReportFac.REPORT_AUFTRAGSWERTE;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory
				...
				.printAuftragswerte( wtfArtikelnrVon.getText(),
						wtfArtikelnrBis.getText(),wcbMitKonsignationslagern.isSelected());
	}
