...
public class ReportArtikelreservierungen extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperCheckBox wcbAlleMandanten = new WrapperCheckBox();

	public ReportArtikelreservierungen(InternalFrameArtikel internalFrame, String add2Title) throws Throwable {
	...
	private void jbInit() throws Exception {
		...
		wlaVon.setText(LPMain.getInstance().getTextRespectUISPr("artikel.report.reservierung.lieferterminvon"));
		...
		wcbAlleMandanten.setText(LPMain.getInstance().getTextRespectUISPr("report.reservierungen.allemandanten"));

		wcbMonatsstatistik.setText(LPMain.getInstance().getTextRespectUISPr("lp.statistik.monate"));
		...
		jpaWorkingOn.add(wcbMonatsstatistik, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfArtikel, new GridBagConstraints(2, 2, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaArtikel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wcbAlleMandanten, new GridBagConstraints(4, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
	...
	public String getReportname() {
		if (wcbMonatsstatistik.isSelected()) {
			return ReservierungFac.REPORT_ARTIKELRESERVIERUNG_MONATSSTATISTIK;
		} else {
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getReservierungDelegate().printArtikelreservierungen(artikelIId,
				wdfVon.getDate(), wdfBis.getDate(), wcbAlleMandanten.isSelected(), wcbMonatsstatistik.isSelected());
