 ...
 */
public class PanelTrumpf extends PanelBasis {
	/**
	 * 
	 */
	...
	public PanelTrumpf(InternalFrame internalFrame, String add2TitleI, Object key) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		jPanelWorkingOn.add(wifArtikel.getWbuArtikel(), new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jPanelWorkingOn.add(wifArtikel.getWtfIdent(), new GridBagConstraints(1, iZeile, 1, 1, 0, 0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wifArtikel.getWtfBezeichnung(), new GridBagConstraints(2, iZeile, 2, 1, 0, 0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		...
		jPanelWorkingOn.add(jspScrollPaneFehlertext, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.1, GridBagConstraints.WEST,
...
iZeile++;
		...
		jPanelWorkingOn.add(wlaExportBeginnArtikel, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 100, 0));

		jPanelWorkingOn.add(wdfExportBeginnArtikel, new GridBagConstraints(1, iZeile, 1, 1, 0, 0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 200, 0));

		jPanelWorkingOn.add(wlaExportEndeArtikel, new GridBagConstraints(2, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 100, 0));
		...
		jPanelWorkingOn.add(wlaFehlercodeArtikel, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		...
		jPanelWorkingOn.add(wlaFehlertextArtikel, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jPanelWorkingOn.add(jspScrollPaneFehlertextArtikel, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.1, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	...
	private void dto2Components() throws Throwable {
		...
		HvOptional<ArtikelTruTopsDto>  artikelTruTopsDto = DelegateFactory.getInstance().getArtikelDelegate().artikelTruTopsFindByArtikelId(
				new ArtikelId(lossollmaterialDto.getArtikelIId()));
