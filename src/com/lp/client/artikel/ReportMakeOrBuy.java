...
public class ReportMakeOrBuy extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
...
private WrapperButton wbuArtikelgruppeFLR = null;
	...
	private WrapperLabel wlaZeitraumAblieferungen = new WrapperLabel();
	...
	private WrapperDateField wdfZeitraumAblieferungenVon = new WrapperDateField();
	private WrapperDateField wdfZeitraumAblieferungenBis = new WrapperDateField();
	...
	public ReportMakeOrBuy(InternalFrameArtikel internalFrame, String add2Title) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wlaPreisgueltigkeit.setText(LPMain.getInstance().getTextRespectUISPr("artikel.report.makeorbuy.preisgueltigkeitek"));

		wlaZeitraumAblieferungen.setText(LPMain.getInstance().getTextRespectUISPr("artikel.report.makeorbuy.ablieferzeitraum"));
		...
		wdfZeitraumAblieferungenVon.setMandatoryField(true);
		wdfZeitraumAblieferungenVon.setDate(Helper.addiereTageZuDatum(new java.util.Date(), -60));
		
		wdfZeitraumAblieferungenBis.setMandatoryField(true);
		wdfZeitraumAblieferungenBis.setDate(new java.util.Date());
		...
		jpaWorkingOn.add(wlaPreisgueltigkeit, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wdfPreisgueltigkeit, new GridBagConstraints(2, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wlaZeitraumAblieferungen, new GridBagConstraints(0, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wdfZeitraumAblieferungenVon, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0));
		
		jpaWorkingOn.add(new WrapperLabel("bis"), new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		
		jpaWorkingOn.add(wdfZeitraumAblieferungenBis, new GridBagConstraints(2, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		jpaWorkingOn.add(wtfArtikelnrVon, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wbuArtikelnrBis, new GridBagConstraints(2, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 70, 0));
		jpaWorkingOn.add(wtfArtikelnrBis, new GridBagConstraints(3, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getArtikelReportDelegate().printMakeOrBuy(artikelgruppeIId,
				artikelklasseIId, wtfArtikelnrVon.getText(), wtfArtikelnrBis.getText(), wdfPreisgueltigkeit.getDate(),
				wdfZeitraumAblieferungenVon.getDate(), wdfZeitraumAblieferungenBis.getDate(), wcbVersteckte.isSelected());
	}
