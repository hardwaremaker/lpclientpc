...
public class ReportChargeneigenschaften
...
private Integer lagerbewegungIIdBuchung = null;
  public ReportChargeneigenschaften(InternalFrame internalFrame,
  ...
  public String getReportname() {
    return LagerReportFac.REPORT_CHARGENEIGENSCHAFTEN;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getLagerReportDelegate().printChargeneigenschaften(lagerbewegungIIdBuchung);
  }
