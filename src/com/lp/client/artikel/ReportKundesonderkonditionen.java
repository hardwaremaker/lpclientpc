...
public class ReportKundesonderkonditionen extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperRadioButton wrbSortierungArtikelnummer = new WrapperRadioButton();
	private WrapperRadioButton wrbSortierungKunde = new WrapperRadioButton();

	public ReportKundesonderkonditionen(InternalFrameArtikel internalFrame, String add2Title) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wrbSortierungArtikelnummer.setText(LPMain.getInstance().getTextRespectUISPr("artikel.artikelnummer"));
		wrbSortierungKunde.setText(LPMain.getInstance().getTextRespectUISPr("label.kunde"));

		ButtonGroup buttonGroupSortierung = new ButtonGroup();
		buttonGroupSortierung.add(wrbSortierungArtikelnummer);
		buttonGroupSortierung.add(wrbSortierungKunde);

		wrbSortierungKunde.setSelected(true);
		...
		iZeile++;
		jpaWorkingOn.add(wlaSortierung, new GridBagConstraints(0, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbSortierungKunde, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbSortierungArtikelnummer, new GridBagConstraints(2, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	...
	public String getReportname() {
		return ArtikelReportFac.REPORT_KUNDENSONDERKONDITIONEN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		ReportKundensonderkoditionenSortierung sort = ReportKundensonderkoditionenSortierung.SORT_ARTIKELNUMMER;
		if(wrbSortierungKunde.isSelected()){
			sort=ReportKundensonderkoditionenSortierung.SORT_KUNDE;
		}

		return DelegateFactory.getInstance().getArtikelReportDelegate().printKundensonderkonditionen(artikelgruppeIId,
				artikelklasseIId, wtfArtikelnrVon.getText(), wtfArtikelnrBis.getText(), wcbVersteckte.isSelected(),
				sort);
	}
