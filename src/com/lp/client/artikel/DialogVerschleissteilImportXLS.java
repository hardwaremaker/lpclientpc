...
public class DialogVerschleissteilImportXLS extends JDialog implements
		ActionListener {
	/**
	 * 
	 */
	...
	public DialogVerschleissteilImportXLS(TabbedPane tp) throws Throwable {
		super(LPMain.getInstance().getDesktop(),
				"Verschleissteile importieren", true);
		...
		XlsFileOpener xlsOpener = FileOpenerFactory.verschleissteilImportOpenXls(tp.getInternalFrame());
	...
	private void jbInit() throws Throwable {
		...
		wtaFehler.setText(DelegateFactory.getInstance().getArtikelDelegate()
				.importiereVerschleissteileXLS(xlsDatei, false));
		...
		if (e.getSource().equals(wbuImportieren)) {
			try {
				DelegateFactory.getInstance().getArtikelDelegate()
						.importiereVerschleissteileXLS(xlsDatei, true);
