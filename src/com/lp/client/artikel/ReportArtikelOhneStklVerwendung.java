...
public class ReportArtikelOhneStklVerwendung extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportArtikelOhneStklVerwendung(InternalFrameArtikel internalFrame,
	...
	private void jbInit() throws Exception {
		...
		this.add(jpaWorkingOn, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0,
						0, 0, 0), 0, 0));
		jpaWorkingOn.add(wcbVersteckte, new GridBagConstraints(2, 2, 4, 1, 1.0,
	...
	public String getReportname() {
		return ArtikelReportFac.REPORT_ARTIKEL_OHNE_STKL_VERWENDUNG;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory.getInstance().getArtikelReportDelegate()
				.printArtikelOhneStklVerwendung(wcbVersteckte.isSelected());
