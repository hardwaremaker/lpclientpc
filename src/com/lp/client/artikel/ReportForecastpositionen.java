...
public class ReportForecastpositionen
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportForecastpositionen(InternalFrameArtikel internalFrame, String add2Title)
      throws Throwable {
  ...
  private void jbInit()
    ...
    jpaWorkingOn.add(wcbAlleMandanten, new GridBagConstraints(2, 3, 3, 1, 0.1, 0.0
            , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2),
            0, 0));
  ...
  public String getReportname() {
    return ForecastReportFac.REPORT_FORECASTPOSITIONEN;
  }


  public JasperPrintLP getReport(String sDrucktype)
      throws Throwable {
    return DelegateFactory.getInstance().getForecastReportDelegate().printForecastpositionen(
        artikelIId,wcbAlleMandanten.isSelected());
  }
