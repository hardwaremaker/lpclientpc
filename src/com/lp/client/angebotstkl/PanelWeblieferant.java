...
public class PanelWeblieferant extends PanelBasis {
	...
	private WeblieferantDto weblieferantDto = null;

	public PanelWeblieferant(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		weblieferantDto = new WeblieferantDto();
	...
	protected void eventActionDelete(ActionEvent e,
			...
			throws Throwable {
		DelegateFactory.getInstance().getAngebotstklDelegate().removeWeblieferant(weblieferantDto.getIId());
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() throws Throwable {
//		weblieferantDto.setLieferantIId(wsfLieferant.getIKey());
	}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_WEBLIEFERANT;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null
			...
			weblieferantDto = DelegateFactory.getInstance()
					.getAngebotstklDelegate()
					.weblieferantFindByPrimaryKey((Integer) key);
