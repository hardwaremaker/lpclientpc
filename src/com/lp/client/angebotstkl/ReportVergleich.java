...
public class ReportVergleich extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportVergleich(InternalFrameAngebotstkl internalFrame, String add2Title, Integer einkaufsangebotIId)
			throws Throwable {
	...
	private void jbInit() throws Exception {
		...
		wcoSortierung1.setKeyOfSelectedItem(new Integer(SORT_SORT));
		...
		jpaWorkingOn.add(wcoSortierung1, new GridBagConstraints(1, iZeile, 1, 1, 0.9, 0.0, GridBagConstraints.WEST,
	...
	public String getReportname() {
		return AngebotstklreportFac.REPORT_VERGLEICH;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory.getInstance().getAngebotstklDelegate().printVergleich(einkaufsangebotIId, iSortierung);
	}
