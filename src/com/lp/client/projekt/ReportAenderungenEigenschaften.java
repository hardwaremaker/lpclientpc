...
public class ReportAenderungenEigenschaften extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportAenderungenEigenschaften(Integer projektIId,
	...
	public String getReportname() {
		return ProjektReportFac.REPORT_AENDERUNGEN_EIGENSCHAFTEN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getProjektDelegate()
				.printAenderungenEigenschaften(projektIId);
	}
