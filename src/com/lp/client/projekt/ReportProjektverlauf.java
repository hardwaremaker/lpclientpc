...
public class ReportProjektverlauf extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperCheckBox wcbMitAZDetails = new WrapperCheckBox();

	public ReportProjektverlauf(InternalFrameProjekt internalFrameProjekt,
	...
	private void jbInit() throws Throwable {
		...
		wcbMitAZDetails.setText(LPMain
				.getTextRespectUISPr("proj.verlauf.mitazdetails"));
		...
		jpaWorkingOn.add(wcbMitAZDetails, new GridBagConstraints(0, iZeile, 1,
