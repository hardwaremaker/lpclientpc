...
public class ReportProjektforecast extends PanelReportJournalPersonal implements
		PanelReportIfJRDS {
	...
	public ReportProjektforecast(InternalFrameProjekt internalFrame,
	...
	public String getReportname() {
		return ProjektReportFac.REPORT_PROJEKT_JOURNAL_FORECAST;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory
				.getInstance()
				.getProjektDelegate()
				.printProjektForecast(getKriterien(), bereichIId,
						wdfStichtag.getDate());
