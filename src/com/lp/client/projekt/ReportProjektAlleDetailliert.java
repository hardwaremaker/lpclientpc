...
public class ReportProjektAlleDetailliert extends PanelReportJournalPersonal implements
		PanelReportIfJRDS {
	...
	public ReportProjektAlleDetailliert(InternalFrameProjekt internalFrame,
	...
	public String getReportname() {
		return ProjektReportFac.REPORT_PROJEKT_JOURNAL_ALLE_DETAILLLIERT;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory
				.getInstance()
				.getProjektDelegate()
				.printProjektAlleDetailliert(getKriterien(), bereichIId, datedStichtag,
