...
public class PanelNachrichtengruppeteilnehmer extends PanelBasis {
	...
	private NachrichtengruppeteilnehmerDto nachrichtengruppeteilnehmerDto = null;
	...
	public PanelNachrichtengruppeteilnehmer(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		nachrichtengruppeteilnehmerDto = new NachrichtengruppeteilnehmerDto();
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getNachrichtenDelegate()
				.removeNachrichtengruppeteilnehmer(nachrichtengruppeteilnehmerDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		nachrichtengruppeteilnehmerDto.setNachrichtengruppeIId(internalFrameNachrichten.getNachrichtengruppeDto().getIId());
	}
	...
	protected void dto2Components() throws ExceptionLP, Throwable {
		...
		if (nachrichtengruppeteilnehmerDto.getPersonalIId() != null) {
			wtfPersonal.setText(DelegateFactory
					.getInstance()
					.getPersonalDelegate()
					.personalFindByPrimaryKey(
							nachrichtengruppeteilnehmerDto.getPersonalIId()).formatAnrede());
		} else {
			wtfPersonal.setText("");
		}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
			if (nachrichtengruppeteilnehmerDto.getIId() == null) {
				nachrichtengruppeteilnehmerDto.setIId(DelegateFactory.getInstance()
						.getNachrichtenDelegate()
						.createNachrichtengruppeteilnehmer(nachrichtengruppeteilnehmerDto));
				setKeyWhenDetailPanel(nachrichtengruppeteilnehmerDto.getIId());
			} else {
				DelegateFactory.getInstance().getNachrichtenDelegate()
						.updateNachrichtengruppeteilnehmer(nachrichtengruppeteilnehmerDto);
			}
			super.eventActionSave(e, true);
			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(
						nachrichtengruppeteilnehmerDto.getIId() + "");
			}
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			 if (e.getSource() == panelQueryFLRPersonal) {
				...
				if (key != null) {
					...
					nachrichtengruppeteilnehmerDto.setPersonalIId((Integer) key);
				}
			}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			nachrichtengruppeteilnehmerDto = DelegateFactory.getInstance()
					.getNachrichtenDelegate()
					.nachrichtengrupperteilnehmerFindByPrimaryKey((Integer) key);
			dto2Components();
		}
	}
