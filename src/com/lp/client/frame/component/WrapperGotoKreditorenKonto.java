...
public class WrapperGotoKreditorenKonto extends WrapperGotoButton implements WrapperGotoConstants {
	private static final long serialVersionUID = -6603684874016621939L;
	
	public WrapperGotoKreditorenKonto() {
		super(GOTO_KONTO) ;
	}
	
	public WrapperGotoKreditorenKonto(String text) {
	...
	protected void geheZuImpl(Integer where, Object okey) throws Throwable {
		...
		if (LPMain.getInstance().getDesktop()
			...
			ifF.geheZu(
					ifF.IDX_TABBED_PANE_KREDITORENKONTEN,
