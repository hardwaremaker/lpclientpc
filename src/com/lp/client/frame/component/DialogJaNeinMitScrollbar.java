...
public class DialogJaNeinMitScrollbar extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public DialogJaNeinMitScrollbar(String title,String message, boolean bEnableScrollPane) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wbuAbbrechen.setText(LPMain.getMessageTextRespectUISPr("lp.abbrechen"));
		...
		panelUrlaubsanspruch.add(wbuOK, new GridBagConstraints(0, 1, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(2, 40, 2, 2), 100, 0));
		panelUrlaubsanspruch.add(wbuAbbrechen, new GridBagConstraints(1, 1, 2, 1, 0.0,
