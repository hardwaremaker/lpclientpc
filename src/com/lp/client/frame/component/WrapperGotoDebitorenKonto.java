...
public class WrapperGotoDebitorenKonto extends WrapperGotoButton implements WrapperGotoConstants {
	private static final long serialVersionUID = -6603684874016621939L;
	
	public WrapperGotoDebitorenKonto() {
		super(GOTO_KONTO) ;
	}
	
	public WrapperGotoDebitorenKonto(String text) {
	...
	protected void geheZuImpl(Integer where, Object okey) throws Throwable {
		...
		if (LPMain.getInstance().getDesktop()
			...
			ifF.geheZu(
					ifF.IDX_TABBED_PANE_DEBITORENKONTEN,
