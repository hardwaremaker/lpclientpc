...
/**
 * Entspricht genau einem JPanel, implementiert aber Scrollable und trackt die
 * Breite des Viewports. Dadurch bekommt das Panel auch in einem
 * {@link JScrollPane} mit vertikaler Scrollbar die richtige Breite
 * 
...
public class ScrollableJPanel extends JPanel implements Scrollable {
	...
	public int getScrollableUnitIncrement(Rectangle visibleRect, int orientation, int direction) {
		return Defaults.getInstance().getControlHeight();
	}
