...
public abstract class PanelDialogPreisvorschlag extends PanelDialogKriterien {
	...
	private WrapperLabel wlaRevision = null;
	private WrapperTextField wtfRevision = null;

	private WrapperLabel wlaIndex = null;
	private WrapperTextField wtfIndex = null;
	...
	private ButtonGroup bgMaterialzuschlag = new ButtonGroup();
	...
	protected WrapperRadioButton wrbMaterialzuschlag = new WrapperRadioButton();
	protected WrapperLabel wlaMaterialzuschlagZumBelegdatum = null;
	protected WrapperRadioButton wrbMaterialzuschlagZumBelegdatum = null;
	protected WrapperLabel wlaMaterialzuschlagWaehrung = null;
	protected WrapperNumberField wnfMaterialzuschlag = null;
	protected WrapperNumberField wnfMaterialzuschlagZumBelegdatum = null;
	 ...
	 * Konstruktor.
	 * 
	 * @param internalFrameI                wir sitzen in diesem InternalFrame
	 * @param title                         der Titel des Fensters
	 * @param panelDialogPreisvorschlagDtoI PanelDialogPreisvorschlagDto
	 * @throws Throwable Ausnahme
	 */
	public PanelDialogPreisvorschlag(InternalFrame internalFrameI, String title,
			PanelDialogPreisvorschlagDto panelDialogPreisvorschlagDtoI) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wlaIdent = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("label.ident"));
		...
		wlaZusatzbezeichnung = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("lp.zusatzbezeichnung"));
		wtfZusatzbezeichnung = new WrapperTextField();
		wtfZusatzbezeichnung.setEditable(false);

		wlaRevision = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("artikel.revision"));
		wtfRevision = new WrapperTextField();
		wtfRevision.setEditable(false);

		wlaIndex = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("artikel.index"));
		wtfIndex = new WrapperTextField();
		wtfIndex.setEditable(false);

		wlaGestehungspreis = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("lp.gestehungspreis"));
		...
		wlaMinverkaufspreis = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("lp.minverkaufspreis"));
		...
		wlaVerkaufspreisbasis = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.verkaufspreisbasis"));
		...
		wlaWaehrungVerkaufspreisbasis.setHorizontalAlignment(SwingConstants.LEADING);

		if (panelDialogPreisvorschlagDto.getNMenge() != null) {
			wlaMengeFuer = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.preisfuer") + " "
		...
		if (panelDialogPreisvorschlagDto.getNMenge() != null) {
			wlaStaffelmenge = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.preisfuer"));
		}
		wlaStaffelmenge.setHorizontalAlignment(SwingConstants.CENTER);

		wlaEk1 = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.ek1"));
		...
		wlaEk2 = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.ek2"));
		...
		wlaEk3 = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("vkpf.ek3"));
		...
		String sAnzeige = LPMain.getInstance().getTextRespectUISPr("vkpf.verkaufspreisbasis");
		...
		// Zeile
		jpaWorkingOn.add(wlaFormat1, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat2, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat3, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat4, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat5, new GridBagConstraints(4, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat6, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaFormat7, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile
		iZeile++;
		jpaWorkingOn.add(wlaIdent, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfIdent, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaNichtRabattierbar, new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0,
		...
		jpaWorkingOn.add(wlaRevision, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfRevision, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile
		iZeile++;
		jpaWorkingOn.add(wlaZusatzbezeichnung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jpaWorkingOn.add(wtfZusatzbezeichnung, new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));

		jpaWorkingOn.add(wlaIndex, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 50, 0));
		jpaWorkingOn.add(wtfIndex, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 10, 2), 0, 0));

		// Zeile
		iZeile++;
		jpaWorkingOn.add(wlaGestehungspreis, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfGestehungspreis, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaWaehrungGestehungspreis, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaEk1, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfEk1, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaWaehrungEk1, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile
		iZeile++;
		jpaWorkingOn.add(wlaMinverkaufspreis, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfMinverkaufspreis, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaWaehrungMinverkaufspreis, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaEk2, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfEk2, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaWaehrungEk2, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		if (bVKPreisbasis_ist_lief1preis) {
			jpaWorkingOn.add(wlaStaffelmenge, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(12, 2, 2, 2), 0, 0));
		} else {
			jpaWorkingOn.add(wrbVerkaufspreisbasis, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
			jpaWorkingOn.add(wnfVerkaufspreisbasis, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
			jpaWorkingOn.add(wlaWaehrungVerkaufspreisbasis, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		}
		jpaWorkingOn.add(wlaEk3, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jpaWorkingOn.add(wnfEk3, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		jpaWorkingOn.add(wlaWaehrungEk3, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 10, 2), 0, 0));
		if (!bVKPreisbasis_ist_lief1preis) {
			jpaWorkingOn.add(wlaMengeFuer, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
	...
	private void setDefaults() throws Throwable {
		...
		wlaWaehrungGestehungspreis.setText(panelDialogPreisvorschlagDto.getCNrWaehrung());
		wlaWaehrungMinverkaufspreis.setText(panelDialogPreisvorschlagDto.getCNrWaehrung());
		wlaWaehrungVerkaufspreisbasis.setText(panelDialogPreisvorschlagDto.getCNrWaehrung());
		...
		if (Helper.short2Boolean(panelDialogPreisvorschlagDto.getArtikelDto().getBRabattierbar())) {
			wlaNichtRabattierbar.setText("");
		} else {
			wlaNichtRabattierbar.setText(LPMain.getInstance().getTextRespectUISPr("artikel.nichtrabattierbar"));
		}

		wtfIndex.setText(panelDialogPreisvorschlagDto.getArtikelDto().getCIndex());
		wtfRevision.setText(panelDialogPreisvorschlagDto.getArtikelDto().getCRevision());

		if (panelDialogPreisvorschlagDto.getArtikelDto().getArtikelsprDto() != null) {
			wtfBezeichnung.setText(panelDialogPreisvorschlagDto.getArtikelDto().getArtikelsprDto().getCBez());
			wtfZusatzbezeichnung.setText(panelDialogPreisvorschlagDto.getArtikelDto().getArtikelsprDto().getCZbez());
		}
		...
		BigDecimal nGestehungspreis = DelegateFactory.getInstance().getLagerDelegate()
				.getGemittelterGestehungspreisEinesLagers(panelDialogPreisvorschlagDto.getArtikelDto().getIId(),
						panelDialogPreisvorschlagDto.getLagerIId());

		nGestehungspreisInBelegwaehrung = nGestehungspreis
				.multiply(new BigDecimal(panelDialogPreisvorschlagDto.getDdWechselkurs().doubleValue()));
		...
		try {
			BigDecimal nMinverkaufspreis = DelegateFactory.getInstance().getLagerDelegate().getMindestverkaufspreis(
					panelDialogPreisvorschlagDto.getArtikelDto().getIId(), panelDialogPreisvorschlagDto.getLagerIId(),
					panelDialogPreisvorschlagDto.getNMenge());
		...
		try {
			...
			nVkbasisInBelegwaehrung = DelegateFactory.getInstance().getVkPreisfindungDelegate().ermittlePreisbasis(
					panelDialogPreisvorschlagDto.getArtikelDto().getIId(),
					panelDialogPreisvorschlagDto.getDatGueltigkeitsdatumFuerPreise(),
					panelDialogPreisvorschlagDto.getIIdPreislisteZuletztGewaehlt(),
					panelDialogPreisvorschlagDto.getNMenge(), panelDialogPreisvorschlagDto.getCNrWaehrung());
		...
		if (bVKPreisbasis_ist_lief1preis) {
			nStaffelmenge = DelegateFactory.getInstance().getVkPreisfindungDelegate().ermittlePreisbasisStaffelmenge(
					panelDialogPreisvorschlagDto.getArtikelDto().getIId(),
					panelDialogPreisvorschlagDto.getDatGueltigkeitsdatumFuerPreise(),
					panelDialogPreisvorschlagDto.getNMenge());
		}
		...
		if (nStaffelmenge != null) {
			wlaStaffelmenge.setText(LPMain.getInstance().getTextRespectUISPr("vkpf.preisbasisfuer") + " "
					+ Helper.formatZahl(nStaffelmenge, iMengeUINachkommastellen, LPMain.getTheClient().getLocUi()));
		}
		...
		// hinterlegt check CK
		ArtikellieferantDto[] aArtikellieferantDto = DelegateFactory.getInstance().getArtikelDelegate()
				.artikellieferantFindByArtikelIId(panelDialogPreisvorschlagDto.getArtikelDto().getIId());
		...
		for (int i = 0; i < 3; i++) {
			...
			case 0:
				...
				if (aArtikellieferantDto != null && aArtikellieferantDto.length > 0) {
					LieferantDto lieferantDto = DelegateFactory.getInstance().getLieferantDelegate()
							.lieferantFindByPrimaryKey(aArtikellieferantDto[0].getLieferantIId());

					if (aArtikellieferantDto[0].getLief1Preis() != null) {
						nEinkaufspreis1 = DelegateFactory.getInstance().getLocaleDelegate().rechneUmInAndereWaehrung(
								aArtikellieferantDto[0].getLief1Preis(), lieferantDto.getWaehrungCNr(),
								panelDialogPreisvorschlagDto.getCNrWaehrung());
					}

					wlaEk1.setText(lieferantDto.getPartnerDto().getCName1nachnamefirmazeile1());
				}
			...
			case 1:
				...
				if (aArtikellieferantDto != null && aArtikellieferantDto.length > 1) {
					LieferantDto lieferantDto = DelegateFactory.getInstance().getLieferantDelegate()
							.lieferantFindByPrimaryKey(aArtikellieferantDto[1].getLieferantIId());

					if (aArtikellieferantDto[1].getLief1Preis() != null) {
						nEinkaufspreis2 = DelegateFactory.getInstance().getLocaleDelegate().rechneUmInAndereWaehrung(
								aArtikellieferantDto[1].getLief1Preis(), lieferantDto.getWaehrungCNr(),
								panelDialogPreisvorschlagDto.getCNrWaehrung());
					}

					wlaEk2.setText(lieferantDto.getPartnerDto().getCName1nachnamefirmazeile1());
				}
			...
			case 2:
				...
				if (aArtikellieferantDto != null && aArtikellieferantDto.length > 2) {
					LieferantDto lieferantDto = DelegateFactory.getInstance().getLieferantDelegate()
							.lieferantFindByPrimaryKey(aArtikellieferantDto[2].getLieferantIId());

					if (aArtikellieferantDto[2].getLief1Preis() != null) {
						nEinkaufspreis3 = DelegateFactory.getInstance().getLocaleDelegate().rechneUmInAndereWaehrung(
								aArtikellieferantDto[2].getLief1Preis(), lieferantDto.getWaehrungCNr(),
								panelDialogPreisvorschlagDto.getCNrWaehrung());
					}

					wlaEk3.setText(lieferantDto.getPartnerDto().getCName1nachnamefirmazeile1());
				}
		...
		String sAnzeige = LPMain.getInstance().getTextRespectUISPr("vkpf.handeingabefixpreis");
		wrbHandeingabeFixpreis = new WrapperRadioButton(true, sAnzeige);
		wrbHandeingabeFixpreis.setActionCommand(ACTION_SPECIAL_HANDEINGABE_FIXPREIS);
		...
		wnfHandeingabeFixpreis.addFocusListener(this);
		wlaHandeingabeFixpreisWaehrung = new WrapperLabel(panelDialogPreisvorschlagDto.getCNrWaehrung());
		wlaHandeingabeFixpreisWaehrung.setHorizontalAlignment(SwingConstants.LEADING);

		// RadioButton fuer Handeingabe Rabattsatz
		sAnzeige = LPMain.getInstance().getTextRespectUISPr("vkpf.handeingaberabattsatz");
		wrbHandeingabeRabattsatz = new WrapperRadioButton(true, sAnzeige);
		wrbHandeingabeRabattsatz.setActionCommand(ACTION_SPECIAL_HANDEINGABE_RABATTSATZ);
		...
		wlaHandeingabeRabattsatzProzent = new WrapperLabel(LPMain.getInstance().getTextRespectUISPr("label.prozent"));
		wlaHandeingabeRabattsatzProzent.setHorizontalAlignment(SwingConstants.LEADING);
		...
		wrbMaterialzuschlag = new WrapperRadioButton(LPMain.getInstance().getTextRespectUISPr("lp.materialzuschlag"));
		if (panelDialogPreisvorschlagDto.getNMaterialzuschlagKurs() != null
				&& panelDialogPreisvorschlagDto.getTMaterialzuschlagDatum() != null) {
			wrbMaterialzuschlag.setToolTipText(
					LPMain.getInstance().getMessageTextRespectUISPr("vkpf.preisdialog.materialzuschlag.zum",
							Helper.formatZahl(panelDialogPreisvorschlagDto.getNMaterialzuschlagKurs(), 6,
									LPMain.getTheClient().getLocUi()),
							Helper.formatDatum(panelDialogPreisvorschlagDto.getTMaterialzuschlagDatum(),
									LPMain.getTheClient().getLocUi())));
		...
		wrbMaterialzuschlag.setHorizontalAlignment(SwingConstants.RIGHT);
		wrbMaterialzuschlag.setSelected(true);
		...
		wnfMaterialzuschlagZumBelegdatum = new WrapperNumberField();
		wnfMaterialzuschlagZumBelegdatum.setEditable(false);
		wnfMaterialzuschlagZumBelegdatum.setFractionDigits(iPreiseUINachkommastellen);

		wlaMaterialzuschlagWaehrung = new WrapperLabel(panelDialogPreisvorschlagDto.getCNrWaehrung());
		wlaMaterialzuschlagWaehrung.setHorizontalAlignment(SwingConstants.LEADING);

		wlaMaterialzuschlagZumBelegdatum = new WrapperLabel(
				LPMain.getInstance().getTextRespectUISPr("vkpf.zuschlag.zum") + " "
						+ Helper.formatDatum(panelDialogPreisvorschlagDto.getDatGueltigkeitsdatumFuerPreise(),
								LPMain.getTheClient().getLocUi()));
		wrbMaterialzuschlagZumBelegdatum = new WrapperRadioButton("");
		wrbMaterialzuschlagZumBelegdatum.setHorizontalAlignment(SwingConstants.RIGHT);

		bgMaterialzuschlag.add(wrbMaterialzuschlag);
		bgMaterialzuschlag.add(wrbMaterialzuschlagZumBelegdatum);
	...
	protected void eventActionAlt(ActionEvent e) throws Throwable {
		...
		if (e.getActionCommand().equals(ALTB)) {
			...
			wnfHandeingabeFixpreis.setEditable(false);
			wnfHandeingabeFixpreis.setMandatoryField(false);
		} else if (e.getActionCommand().equals(ALT1) || e.getActionCommand().equals(ALT2)
				|| e.getActionCommand().equals(ALT3) || e.getActionCommand().equals(ALT4)
				|| e.getActionCommand().equals(ALT5) || e.getActionCommand().equals(ALT6)
				|| e.getActionCommand().equals(ALT7) || e.getActionCommand().equals(ALT8)
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(ACTION_SPECIAL_OK)) {
			...
			if (wrbHandeingabeFixpreis.isSelected()
					&& (wnfHandeingabeFixpreis.getText() == null || wnfHandeingabeFixpreis.getText().length() == 0)) {
				DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.hint"),
						LPMain.getInstance().getTextRespectUISPr("vkpf.fixpreiseingeben"));
			} else if (wrbHandeingabeRabattsatz.isSelected() && (wnfHandeingabeRabattsatz.getText() == null
					|| wnfHandeingabeRabattsatz.getText().length() == 0)) {
				DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.hint"),
						LPMain.getInstance().getTextRespectUISPr("vkpf.rabattsatzeingeben"));
			} else {
				...
				if (bdAktuellerVerkaufspreis != null) {
					...
					// SP9288 Pruefung auf Unterpreisigkeit wurde hier entfernt, da doppelt. 
					// Es wird beim Speichern der Belegpositionen nochmals auf Unterpreisigkeit geprueft!
			...
			bDialogWirdGeradeAngezeigt = false;
			super.eventActionSpecial(e);
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_HANDEINGABE_FIXPREIS)) {
		...
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_HANDEINGABE_RABATTSATZ)) {
		...
		// alle anderen RadioButtons
		else if (e.getActionCommand().equals(ACTION_SPECIAL_PREISLISTE_GEWAEHLT)) {
			// wnfHandeingabeFixpreis.setText("");
			wnfHandeingabeFixpreis.setEditable(false);
			// wnfHandeingabeRabattsatz.setText("");
			wnfHandeingabeRabattsatz.setEditable(false);
			...
			pdPreisvorschlagVkstufe1 = new PanelDialogPreisvorschlagPreisliste(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.preisvorschlag.kundepreisliste"),
			...
			pdPreisvorschlagVkstufe2 = new PanelDialogPreisvorschlagVkmengenstaffel(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.preisvorschlag.vkmengenstaffel"),
					panelDialogPreisvorschlagDto);
			...
			pdPreisvorschlagVkstufe3 = new PanelDialogPreisvorschlagKundesokomengenstaffel(getInternalFrame(),
					LPMain.getInstance().getTextRespectUISPr("lp.preisvorschlag.kundesokomengenstaffel"),
					panelDialogPreisvorschlagDto);
	...
	protected void UpdateFixpreisFuerMenge() throws Throwable {
		if (wnfHandeingabeFixpreis.getBigDecimal() != null)
			wnfHandeingabeFuerMenge.setBigDecimal(
					wnfHandeingabeFixpreis.getBigDecimal().multiply(panelDialogPreisvorschlagDto.getNMenge()));
	}
	...
	/**
	 * Hier wird das Ergebnis zusammengebaut, das von aussen abgeholt werden kann.
	 * 
	 * @throws Throwable
	 */
	 ...
	 * angezeigt.
	 * 
	 * @param index Index der Zeile, die farbig markiert werden soll
	 * @throws Throwable
	 */
	protected abstract void setColorBerechneterPreis(int index) throws Throwable;

	/**
	 * Der Button fuer die Anzeige einer zweiten VK-Stufe muss initialisert werden.
	 * 
	 * @throws Throwable
	 */
	...
	/**
	 * Der Button fuer die Anzeige einer dritten VK-Stufe muss initialisert werden.
	 * 
	 * @throws Throwable
	 */
	...
	public Integer getIIdKundesokomengenstaffelZuletztGewaehlt() {
		return panelDialogPreisvorschlagDto.getIIdKundesokomengenstaffelZuletztGewaehlt();
	}

	public Integer getIIdVkmengenstaffelZuletztGewaehlt() {
		return panelDialogPreisvorschlagDto.getIIdVkmengenstaffelZuletztGewaehlt();
	}
	...
	protected void befuelleUndPrufeMaterialzuschlagZumGueltigkeitsdatum() throws Throwable {

		ParametermandantDto parametermandantDtoMZ = DelegateFactory.getInstance().getParameterDelegate()
				.getMandantparameter(LPMain.getInstance().getTheClient().getMandant(), ParameterFac.KATEGORIE_ARTIKEL,
		...
		if (bMaterialkursAufBasisRechnungsdatum == false) {
			...
			wnfMaterialzuschlagZumBelegdatum.setBigDecimal(DelegateFactory.getInstance().getMaterialDelegate()
					.getMaterialzuschlagVKInZielwaehrung(panelDialogPreisvorschlagDto.getArtikelDto().getIId(),
							panelDialogPreisvorschlagDto.getKundeDto().getIId(),
							panelDialogPreisvorschlagDto.getDatGueltigkeitsdatumFuerPreise(),
							panelDialogPreisvorschlagDto.getCNrWaehrung()));
			wnfMaterialzuschlag.setForeground(Color.BLACK);
			if (wnfMaterialzuschlagZumBelegdatum.getBigDecimal() != null
					&& wnfMaterialzuschlag.getBigDecimal() != null) {
				if (!wnfMaterialzuschlagZumBelegdatum.getBigDecimal().equals(wnfMaterialzuschlag.getBigDecimal())) {
					wnfMaterialzuschlag.setForeground(Color.RED);
				}
			}
		} else {
			wnfMaterialzuschlagZumBelegdatum.setBigDecimal(BigDecimal.ZERO);
		}
