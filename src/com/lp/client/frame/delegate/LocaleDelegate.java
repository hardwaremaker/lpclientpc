...
public class LocaleDelegate extends Delegate {
	private LocaleFac localeFac = null;
	private Context context;

	public LocaleDelegate() throws Exception {
		context = new InitialContext();
		localeFac = lookupFac(context, LocaleFac.class);

	}

	public String createLpLocale(LocaleDto localeDto) throws ExceptionLP {
	...
	public void removeLpLocale(String cNr) throws ExceptionLP {
	...
	public void removeLpLocale(LocaleDto localeDto) throws ExceptionLP {
	...
	public void updateLpLocale(LocaleDto localeDto) throws ExceptionLP {
	...
	public Map<?, ?> getAllLocales(Locale inLocale) throws ExceptionLP {
	...
	public HashMap<?, ?> getAllStatiIcon() throws ExceptionLP {
	...
	public LocaleDto localeFindByPrimaryKey(String cNr) throws ExceptionLP {
	...
	// *** Waehrung
	// *****************************************************************
	public void removeWaehrung(WaehrungDto waehrungDto) throws ExceptionLP {
		try {
	...
	public void updateWaehrung(WaehrungDto waehrungDto) throws ExceptionLP {
		try {
	 ...
	 */
	public Map<?, ?> getAllWaehrungen() throws ExceptionLP {
		Map<?, ?> m = null;
		try {
	...
	public WechselkursDto wechselkursFindByPrimaryKey(String waehrungCNrVon,
			String waehrungCNrZu, java.util.Date tDatum) throws ExceptionLP {

		WechselkursDto w = null;
		try {
			w = localeFac.wechselkursFindByPrimaryKey(waehrungCNrVon,
					waehrungCNrZu, tDatum);
		} catch (Throwable t) {
			handleThrowable(t);
		}
		return w;
	...
	public BigDecimal getWechselkurs2(String waehrungLocaleCNrVon,
			String waehrungLocaleCNrZu) throws ExceptionLP {
		...
		try {
			if (!waehrungLocaleCNrVon.equals(waehrungLocaleCNrZu)) {
				fWechselkurs = localeFac.getWechselkurs2(waehrungLocaleCNrVon,
						waehrungLocaleCNrZu, LPMain.getTheClient());
			}
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public BigDecimal rechneUmInAndereWaehrung(BigDecimal bdBetragI,
			String cCurrency1I, String cCurrency2I) throws ExceptionLP {

		try {
			return localeFac
					.rechneUmInAndereWaehrungZuDatum(bdBetragI, cCurrency1I,
							cCurrency2I, new Date(System.currentTimeMillis()),
							LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
	...
	public BigDecimal rechneUmInMandantenWaehrung(BigDecimal bdBetragI,
		...
		try {
			return localeFac.rechneUmInMandantenWaehrung(bdBetragI,
					bdKursMandantenwaehrungZuBelegwaehrung);
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
	...
	public String createBelegart(BelegartDto belegartDtoI) throws ExceptionLP {
		String s = null;
		try {
			return localeFac
					.createBelegart(belegartDtoI, LPMain.getTheClient());
		} catch (Throwable t) {
			handleThrowable(t);
		}
	...
	public BelegartDto belegartFindByPrimaryKey(String cNrI) throws ExceptionLP {

		BelegartDto belegartDto = null;
		try {
			belegartDto = localeFac.belegartFindByPrimaryKey(cNrI,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public void removeBelegart(String cNr) throws ExceptionLP {
	...
	public void removeBelegart(BelegartDto belegartDto) throws ExceptionLP {
		try {
	...
	public void updateBelegart(BelegartDto belegartDto) throws ExceptionLP {
		try {
	...
	public BelegartDto[] belegartFindAll() throws ExceptionLP {
		BelegartDto[] ab = null;
		try {
	...
	public BelegartsprDto belegartsprFindByPrimaryKey(String belegartCNr)
		...
		try {
			b = localeFac
					.belegartsprFindByPrimaryKey(belegartCNr, Helper
	 ...
	 * @return BelegartDto
	 */
	public BelegartDto belegartFindByCNr(String pCNr) throws ExceptionLP {
		BelegartDto b = null;
		try {
	...
	public void createLieferartspr(LieferartsprDto lieferartsprDto)
		...
		try {
			localeFac
					.createLieferartspr(lieferartsprDto, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	}

	public void removeLieferart(Integer iId) throws ExceptionLP {
		try {
	...
	public void removeLieferart(LieferartDto lieferartDto) throws ExceptionLP {
		try {
	...
	public void updateLieferart(LieferartDto lieferartDto) throws ExceptionLP {
		try {
	...
	public void updateLieferartspr(LieferartsprDto lieferartsprDto)
		...
		try {
			localeFac
					.updateLieferartspr(lieferartsprDto, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	}
	...
	public LieferartsprDto lieferartsprFindByPrimaryKey(Integer lieferartIId)
		...
		try {
			l = localeFac
					.lieferartsprFindByPrimaryKey(lieferartIId, Helper
							.locale2String(LPMain.getInstance()
	...
	// *** Status
	// *****************************************************************
	public String createStatus(StatusDto statusDto) throws ExceptionLP {
		String cNr = null;
		try {
	...
	public void removeStatus(StatusDto statusDto) throws ExceptionLP {
		try {
	...
	public void updateStatus(StatusDto statusDto) throws ExceptionLP {
		try {
	...
	public StatusDto statusFindByPrimaryKey(String cNrI) throws ExceptionLP {
	...
	public WaehrungDto waehrungFindByPrimaryKey(String cNrI) throws ExceptionLP {
	...
	public WaehrungDto waehrungFindByPrimaryKeyWithNull(String cNrI) throws ExceptionLP {

		WaehrungDto waehrungDto = null;
		try {
			waehrungDto = localeFac.waehrungFindByPrimaryKeyWithNull(cNrI);
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
		return waehrungDto;
	...
	public StatussprDto statussprFindByPrimaryKey(String cNrI)
		...
		try {
			status2sprDto = localeFac
					.statussprFindByPrimaryKey(cNrI, Helper
							.locale2String(LPMain.getInstance()
									.getUISprLocale()), LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
	...
	public void updateStatusspr(StatussprDto statussprDtoI) throws ExceptionLP {
		try {
	...
	public void removeStatusspr(StatussprDto statussprDtoI) throws ExceptionLP {
		try {
	...
	public void createStatusspr(StatussprDto statussprDtoI) throws ExceptionLP {
		try {
	...
	public FunktionsprPK createFunktionspr(FunktionsprDto funktionsprDto)
		...
		try {
			f = localeFac.createFunktionspr(funktionsprDto,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public void removeFunktionspr(Integer funktionIId, String localeCNr)
			throws ExceptionLP {
		try {
			localeFac.removeFunktionspr(funktionIId, localeCNr,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public FunktionsprDto funktionsprFindByPrimaryKey(Integer funktionIId,
	...
	// *** Funktion
	// *****************************************************************
	public Integer createFunktion(FunktionDto funktionDto) throws ExceptionLP {
	...
	public void removeFunktion(Integer iId) throws ExceptionLP {
		try {
	...
	public void removeFunktion(FunktionDto funktionDto) throws ExceptionLP {
		try {
	...
	public void updateFunktion(FunktionDto funktionDto) throws ExceptionLP {
		try {
	...
	public FunktionDto funktionFindByPrimaryKey(Integer iId) throws ExceptionLP {
		FunktionDto f = null;
		try {
	...
	public PositionsartsprPK createPositionsartspr(
			PositionsartsprDto positionsartsprDto) throws ExceptionLP {
	...
	public void removePositionsartspr(PositionsartsprDto positionsartsprDto)
			throws ExceptionLP {
		try {
			localeFac.removePositionsartspr(positionsartsprDto,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public void updatePositionsartspr(PositionsartsprDto positionsartsprDto)
			throws ExceptionLP {
		try {
			localeFac.updatePositionsartspr(positionsartsprDto,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public PositionsartsprDto positionsartsprFindByPrimaryKey(
			String positionsartCNr, String localeCNr) throws ExceptionLP {
		PositionsartsprDto p = null;
		try {
			p = localeFac.positionsartsprFindByPrimaryKey(positionsartCNr,
					localeCNr, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
		return p;
	...
	public void removePositionsart(String positionsartCNr, String localeCNr)
		...
		try {
			localeFac
					.removePositionsart(positionsartCNr, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	}
	...
	public void removePositionsart(PositionsartDto positionsartsprDto)
			throws ExceptionLP {
		try {
			localeFac.removePositionsart(positionsartsprDto,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public void updatePositionsart(PositionsartDto positionsartsprDto)
			throws ExceptionLP {
		try {
			localeFac.updatePositionsart(positionsartsprDto,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public PositionsartDto positionsartFindByPrimaryKey(String positionsartCNr)
		...
		try {
			p = localeFac.positionsartFindByPrimaryKey(positionsartCNr,
					LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	...
	public WechselkursDto getKursZuDatum(String waehrungCNrVonI,
		...
		try {
			wechselkursDto = localeFac.getKursZuDatum(waehrungCNrVonI,
					waehrungCNrNachI, dDatum, LPMain.getTheClient());
		} catch (Throwable t) {
			handleThrowable(t);
		}
	...
	public BigDecimal rechneUmInAndereWaehrungGerundetZuDatum(
			BigDecimal bdBetragI, String cCurrency1I, String cCurrency2I,
			java.sql.Date dDatum) throws ExceptionLP {
		try {
			return localeFac.rechneUmInAndereWaehrungGerundetZuDatum(bdBetragI,
					cCurrency1I, cCurrency2I, dDatum, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public WoerterbuchEintragIId createWoerterbuchEintrag(WoerterbuchEintragDto dto) throws ExceptionLP {
		try {
			return localeFac.createWoerterbuchEintrag(dto, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public void updateWoerterbuchEintrag(WoerterbuchEintragDto dto) throws ExceptionLP {
		try {
			localeFac.updateWoerterbuchEintrag(dto, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
		}
	}

	public WoerterbuchEintragDto woerterbuchEintragFindByPrimaryKey(WoerterbuchEintragIId id) throws ExceptionLP {
		try {
			return localeFac.woerterbuchEintragFindByPrimaryKey(id, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public List<WoerterbuchEintragDto> getAllWoerterbuchEintragZuSprache(String locale) throws ExceptionLP {
		try {
			return localeFac.getAllWoerterbuchEintraegeZuSprache(locale, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public List<WoerterbuchEintragDto> woerterbuchEintragBatchCRUD(List<WoerterbuchEintragDto> toCreate, List<WoerterbuchEintragDto> toUpdate,
			List<WoerterbuchEintragDto> toDelete) throws ExceptionLP{
		try {
			return localeFac.woerterbuchEintragBatchCRUD(toCreate, toUpdate, toDelete, LPMain.getTheClient());
		} catch(Throwable ex) {
			handleThrowable(ex);
			return null;
		}
