...
public class PanelEditor extends PanelDialog {
	...
	private void setupEditor(WrapperEditorField targetComponent, String text)
		...
		if(targetComponent.isRechtschreibpruefungAktiv()) {
			lpEditor.aktiviereRechtschreibpruefung();
			if(targetComponent.getRechtschreibpruefungLocale() != null) {
				lpEditor.setRechtschreibpruefungLocale(targetComponent.getRechtschreibpruefungLocale());
			}
		}
