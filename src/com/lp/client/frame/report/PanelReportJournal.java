...
public abstract class PanelReportJournal extends PanelBasis implements
		PropertyChangeListener, PanelReportNotifyIntialize {
	/**
	 * 
	 */
	...
	private final static String ACTION_SPECIAL_SORTIERUNG_IDENT = "action_special_sortierung_ident";
	...
	public int iZeileZwischenKostenstelleUndSortierung=0;
	...
	protected WrapperRadioButton wrbSortierungLieferadresse = new WrapperRadioButton();
	...
	/**
	 * Wird true sobald die gespeicherte konfiguration geladen ist
	 */
	...
	private final void setDefaults() {
		...
		wrbSortierungLieferadresse.setVisible(false);
	...
	private final void jbInit() throws Throwable {
		...
		wlaKostenstellen.setText(LPMain
		...
		wbuKostenstelle.setMinimumSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wbuKostenstelle.setPreferredSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wtfKostenstelleNummer.setMinimumSize(new Dimension(50, Defaults
				.getInstance().getControlHeight()));
		wtfKostenstelleNummer.setPreferredSize(new Dimension(50, Defaults
				.getInstance().getControlHeight()));
		...
		Dimension dimension = HelperClient.getSizeFactoredDimension(25);
		HelperClient.setMinimumAndPreferredSize(wlaVon1, dimension);
		HelperClient.setMinimumAndPreferredSize(wlaVon2, dimension);
		HelperClient.setMinimumAndPreferredSize(wlaBis1, dimension);
		HelperClient.setMinimumAndPreferredSize(wlaBis2, dimension);
		...
		wrbSortierungLieferadresse.setText(LPMain
		...
		wrbSortierungIdentNr.setText(LPMain
				.getTextRespectUISPr("auftrag.ident"));
		...
		wtfKostenstelleBezeichnung.setColumnsMax(Facade.MAX_UNBESCHRAENKT);
		...
		this.add(jpaWorkingOn, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0,
						0, 0, 0), 0, 0));
		jpaWorkingOn.add(wlaKostenstellen, new GridBagConstraints(0, iZeile, 4,
				1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbKostenstelleAlle, new GridBagConstraints(1, iZeile,
		...
		jpaWorkingOn.add(wrbKostenstelleEine, new GridBagConstraints(1, iZeile,
				1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(getPanelKostenstelle(), new GridBagConstraints(2,
				iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
		iZeileZwischenKostenstelleUndSortierung=iZeile;
		iZeile++;
		...
		iZeile++;
		jpaWorkingOn.add(wrbSortierungIdentNr, new GridBagConstraints(0,
				iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		
		iZeile++;
		jpaWorkingOn.add(wrbSortierungLieferadresse, new GridBagConstraints(0,
				iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		buttonGroupSortierung.add(wrbSortierungLieferadresse);
	...
	private JPanel getPanelKostenstelle() {
		if (jpaKostenstelle == null) {
			...
			jpaKostenstelle.add(wbuKostenstelle, new GridBagConstraints(0, 0,
					1, 1, 0.0, 0.0, GridBagConstraints.WEST,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jpaKostenstelle.add(wtfKostenstelleNummer, new GridBagConstraints(
	...
	protected void befuelleKriterien(ReportJournalKriterienDto krit) {
		if (wrbKostenstelleAlle.isSelected()) {
			krit.bSortiereNachKostenstelle = wcbSortiereNachKostenstelle
					.isSelected();
		} else {
		...
		} else if (wrbSortierungLieferadresse.isSelected()) {
			krit.iSortierung = ReportJournalKriterienDto.KRIT_SORT_NACH_LIEFERADRESSE;
		}else if (wrbSortierungLieferadresse.isSelected()) {
			krit.iSortierung = ReportJournalKriterienDto.KRIT_SORT_NACH_LIEFERADRESSE;
		}
