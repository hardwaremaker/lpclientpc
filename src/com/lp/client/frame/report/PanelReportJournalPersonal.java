 ...
 */
public abstract class PanelReportJournalPersonal extends PanelBasis implements
		PropertyChangeListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private final static String ACTION_SPECIAL_PERSONAL_ALLE = "action_special_personal_alle";
	private final static String ACTION_SPECIAL_PERSONAL_EINE = "action_special_personal_eine";
	private final static String ACTION_SPECIAL_SORTIERUNG_BELEGNUMMER = "action_special_sortierung_belegnummer";
	private final static String ACTION_SPECIAL_PERSONAL_AUSWAHL = "action_special_personal_auswahl";
	private final static String ACTION_SPECIAL_SORTIERUNG_PARTNER = "action_special_sortierung_partner";
	...
	protected final static String ACTION_SPECIAL_PARTNER_AUSWAHL = "action_special_partner_auswahl";
	protected final static String ACTION_SPECIAL_PARTNER_ALLE = "action_special_partner_alle";
	protected final static String ACTION_SPECIAL_PARTNER_EINER = "action_special_partner_einer";
	...
	public PanelReportJournalPersonal(InternalFrame internalFrame,
	...
	private void jbInit() throws Throwable {
		...
		wbuPersonal.setToolTipText(LPMain.getInstance().getTextRespectUISPr(
				"label.person"));
		wbuPartner.setMinimumSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wbuPartner.setPreferredSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wrbPersonalAlle.setMinimumSize(new Dimension(BREITE_SPALTE2, Defaults
				.getInstance().getControlHeight()));
		wrbPersonalAlle.setPreferredSize(new Dimension(BREITE_SPALTE2, Defaults
				.getInstance().getControlHeight()));
		...
		wbuPersonal.setMinimumSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wbuPersonal.setPreferredSize(new Dimension(BREITE_BUTTONS, Defaults
				.getInstance().getControlHeight()));
		wtfPersonalNummer.setMinimumSize(new Dimension(50, Defaults
				.getInstance().getControlHeight()));
		wtfPersonalNummer.setPreferredSize(new Dimension(50, Defaults
				.getInstance().getControlHeight()));
		jpaWorkingOn.setLayout(new GridBagLayout());
		wrbPersonalAlle.setSelected(true);
		wrbPersonalAlle.setText(LPMain.getInstance().getTextRespectUISPr(
				"label.alle"));
		wrbPersonalEine.setText(LPMain.getInstance().getTextRespectUISPr(
				"label.eine"));
		wrbPartnerAlle.setText(LPMain.getInstance().getTextRespectUISPr(
				"label.alle"));
		wrbPartnerEiner.setText(LPMain.getInstance().getTextRespectUISPr(
				"label.einer"));
		...
		Dimension dimensionVonBis = HelperClient.getSizeFactoredDimension(25);
		HelperClient.setMinimumAndPreferredSize(wlaVon1, dimensionVonBis);
		HelperClient.setMinimumAndPreferredSize(wlaVon2, dimensionVonBis);
		HelperClient.setMinimumAndPreferredSize(wlaBis1, dimensionVonBis);
		HelperClient.setMinimumAndPreferredSize(wlaBis2, dimensionVonBis);
		...
		wcbSortiereNachPersonal.setText(LPMain.getInstance()
				.getTextRespectUISPr("label.sortierungnachpersonal"));
		wrbSortierungBelegnummer.setText(LPMain.getInstance()
				.getTextRespectUISPr("label.belegnummer"));
		wrbBereichDatum.setText(LPMain.getInstance().getTextRespectUISPr(
				"lp.datum"));
		...
		wrbSortierungBelegnummer
				.setActionCommand(ACTION_SPECIAL_SORTIERUNG_BELEGNUMMER);
		wrbSortierungPartner
				.setActionCommand(ACTION_SPECIAL_SORTIERUNG_PARTNER);
		...
		this.add(jpaWorkingOn, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0,
						0, 0, 0), 0, 0));
		jpaWorkingOn.add(wlaPersonaln, new GridBagConstraints(0, iZeile, 4, 1,
				1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbPersonalAlle, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wcbSortiereNachPersonal, new GridBagConstraints(2,
				iZeile, 5, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbPersonalEine, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(getPanelPersonal(), new GridBagConstraints(2, iZeile,
		...
		jpaWorkingOn.add(wlaSortierung, new GridBagConstraints(0, iZeile, 1, 1,
				...
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaBereich, new GridBagConstraints(1, iZeile, 1, 1,
				0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbSortierungBelegnummer, new GridBagConstraints(0,
				...
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbBereichDatum, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(getJPanelBereichDatum(), new GridBagConstraints(2,
				iZeile, 5, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbBereichNummer, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		...
		jpaWorkingOn.add(wtfBis, new GridBagConstraints(5, iZeile, 1, 1, 1.0,
				...
				new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbSortierungPartner, new GridBagConstraints(0,
				iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wrbPartnerAlle, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wrbPartnerEiner, new GridBagConstraints(1, iZeile, 1,
				1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(getPanelPartner(), new GridBagConstraints(2, iZeile,
				4, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(this.ACTION_SPECIAL_PERSONAL_ALLE)) {
			setVisibilityPersonal(true);
				...
				this.ACTION_SPECIAL_PERSONAL_EINE)) {
			...
			if (personalDto == null) {
				...
				this.ACTION_SPECIAL_SORTIERUNG_BELEGNUMMER)) {
			// nix tun
		} else if (e.getActionCommand().equals(
				this.ACTION_SPECIAL_SORTIERUNG_PARTNER)) {
			// nix tun
		} else if (e.getActionCommand().equals(
				this.ACTION_SPECIAL_PERSONAL_AUSWAHL)) {
			dialogQueryPersonal();
		} else if (e.getActionCommand().equals(
				this.ACTION_SPECIAL_PARTNER_AUSWAHL)) {
			dialogQueryPartner();
		} else if (e.getActionCommand()
				.equals(this.ACTION_SPECIAL_PARTNER_ALLE)) {
			wbuPartner.setVisible(false);
			wtfPartner.setVisible(false);
			wtfPartner.setMandatoryField(false);
		} else if (e.getActionCommand().equals(
				this.ACTION_SPECIAL_PARTNER_EINER)) {
			wbuPartner.setVisible(true);
			wtfPartner.setVisible(true);
			wtfPartner.setMandatoryField(true);
		} else if (e.getActionCommand().equals(
				this.ACTION_SPECIAL_SORTIERUNG_BEREICH_DATUM)) {
			...
			wtfBis.setVisible(false);
				...
				this.ACTION_SPECIAL_SORTIERUNG_BEREICH_NUMMER)) {
	...
	private void setVisibilityPersonal(boolean alle) {
		...
		wtfPersonalBezeichnung.setMandatoryField(!alle && bPersonal);

	}

	private void dialogQueryPersonal() throws Throwable {
		panelQueryFLRPersonal = PersonalFilterFactory.getInstance()
				.createPanelFLRPersonal(getInternalFrame(), false, false);
		if (personalDto != null) {
	...
	private void dialogQueryPartner() throws Throwable {
	...
	private void dto2ComponentsPersonal() {
		if (personalDto != null) {
			wtfPersonalNummer.setText(personalDto.getPartnerDto()
					.formatTitelAnrede());
			wtfPersonalBezeichnung.setText(personalDto.getPartnerDto()
					.formatFixName2Name1());
		} else {
	...
	private JPanel getPanelPersonal() {
		if (jpaPersonal == null) {
			...
			jpaPersonal.add(wbuPersonal, new GridBagConstraints(0, 0, 1, 1,
					0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
					new Insets(2, 2, 2, 2), 0, 0));
			/*
			 * jpaPersonal.add(wtfPersonalNummer, new GridBagConstraints(1, 0,
			 * 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
			 * new Insets(2, 2, 2, 2), 0, 0));
			 */
			jpaPersonal.add(wtfPersonalBezeichnung, new GridBagConstraints(2,
	...
	private JPanel getPanelPartner() {
		if (jpaPartner == null) {
			...
			jpaPartner.add(wbuPartner, new GridBagConstraints(0, 0, 1, 1, 0.0,
					0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
					new Insets(2, 2, 2, 2), 0, 0));
			jpaPartner.add(wtfPartner, new GridBagConstraints(1, 0, 1, 1, 1.0,
					0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
					new Insets(2, 2, 2, 2), 0, 0));
		}
		return jpaPartner;
	...
	protected ReportJournalKriterienDto getKriterien() {
		...
		if (wrbPersonalEine.isSelected() && personalDto != null) {
