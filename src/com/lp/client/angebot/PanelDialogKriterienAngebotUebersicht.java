...
/**
 * <p>
 * <I>Dialog zur Eingabe der Kriterien fuer die Angebot Uebersicht.</I>
 * </p>
 * <p>
 * Copyright Logistik Pur Software GmbH (c) 2004-2008
 * </p>
 * <p>
 * Erstellungsdatum <I>21. 01. 2005</I>
 * </p>
 * <p>
 * </p>
 * 
 ...
 */
public class PanelDialogKriterienAngebotUebersicht extends PanelDialogKriterien {
	...
	private static final String ACTION_SPECIAL_FLR_VERTRETER = "action_special_flr_vertreter";
	static final private String ACTION_RADIOBUTTON_ALLE_VERTRETER = "action_radiobutton_alle_vertreter";
	static final private String ACTION_RADIOBUTTON_EIN_VERTRETER = "action_radiobutton_ein_vertreter";
	...
	private void jbInit() throws Throwable {
		...
		wrbAlleVertreter = new WrapperRadioButton(
				LPMain.getTextRespectUISPr("lp.allevertreter"));
		wrbAlleVertreter.setActionCommand(ACTION_RADIOBUTTON_ALLE_VERTRETER);
		wrbAlleVertreter.addActionListener(this);

		wrbEinVertreter = new WrapperRadioButton(
				LPMain.getTextRespectUISPr("lp.einvertreter"));
		...
		wlaGeschaeftsjahresbeginn = new WrapperLabel(
				LPMain.getTextRespectUISPr("lp.geschaeftsjahresbeginn"));
		wlaGeschaeftsjahresbeginn
		...
		wrbKalenderjahr.setText(LPMain
				.getTextRespectUISPr("label.kalenderjahr"));

		wrbGeschaeftsjahr = new WrapperRadioButton();
		wrbGeschaeftsjahr.setText(LPMain
		...
		iZeile++;
		jpaWorkingOn.add(wrbAlleVertreter, new GridBagConstraints(0, iZeile, 3,
				1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wrbEinVertreter, new GridBagConstraints(0, iZeile, 3,
				1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		...
		jpaWorkingOn.add(wbuVertreter, new GridBagConstraints(1, iZeile, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfVertreter, new GridBagConstraints(2, iZeile, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		...
		iZeile++;
		jpaWorkingOn.add(wlaGeschaeftsjahresbeginn, new GridBagConstraints(0,
				iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wlaDatum, new GridBagConstraints(1, iZeile, 1, 1, 0.0,
	...
	private void setDefaults() throws Throwable {
		...
		// @todo es gibt gemeinsame Elemente mit
		// PanelDialogKriterienAuftragUebersicht PJ 4909
		...
		ParametermandantDto pmBeginnMonat = DelegateFactory
				.getInstance()
		...
		DateFormatSymbols symbols = new DateFormatSymbols(LPMain.getTheClient()
				.getLocUi());
		defaultMonths = symbols.getMonths();

		String sNameMonat = defaultMonths[iIndexBeginnMonat];

		wlaDatum.setText("1. " + sNameMonat + " "
				+ gcReferenz.get(Calendar.YEAR));
		wrbGeschaeftsjahr.setSelected(true);
	}

	/**
	 * Die gewaehlten Kriterien zusammenbauen. <br>
	 * Es gilt fuer Angebot Uebersicht: <br>
	 * Krit1 : Geschaeftsjahr = Auswahl Geschaeftsjahr <br>
	 * Krit2 : Vertreter = null oder i_id; wenn null erfolgt die Auswertung
	 * ueber alle Vertreter
	 * 
	...
	public FilterKriterium[] buildFilterKriterien() throws Throwable {
		...
		if (wrbKalenderjahr.isSelected()) {
			...
			fkjahr = new FilterKriterium(
					AngebotFac.KRIT_UEBERSICHT_KALENDERJAHR, true,
		...
		if (wrbGeschaeftsjahr.isSelected()) {
			// Geschaeftsjahr
			fkjahr = new FilterKriterium(
					AngebotFac.KRIT_UEBERSICHT_GESCHAEFTSJAHR, true,
					wcoGeschaeftsjahr.getKeyOfSelectedItem().toString(),
					FilterKriterium.OPERATOR_EQUAL, false);
		...
		FilterKriterium fkVertreter = new FilterKriterium(
				AngebotFac.KRIT_UEBERSICHT_VERTRETER_I_ID, true, cVertreterIId,
				FilterKriterium.OPERATOR_EQUAL, false);
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_VERTRETER)) {
			...
			vertreterDto = new PersonalDto();
				...
				.equals(ACTION_RADIOBUTTON_EIN_VERTRETER)) {
			...
			if (e.getActionCommand().equals(ACTION_SPECIAL_CLOSE_PANELDIALOG)) {
				tpAngebot
						.setBKriterienAngebotUebersichtUeberMenueAufgerufen(false);
	...
	private void dialogQueryVertreter(ActionEvent e) throws Throwable {
		...
		DialogQuery dialogQueryVertreter = new DialogQuery(
