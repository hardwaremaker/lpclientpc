...
public class ReportMaschinenverwendung extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMaschinenverwendung(InternalFrameZeiterfassung internalFrame,
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getZeiterfassungReportDelegate()
				.printMaschinenverwendung(maschineIId);
	}
	...
	public String getReportname() {
		return ZeiterfassungReportFac.REPORT_MASCHINENVERWENDUNG;
	}
