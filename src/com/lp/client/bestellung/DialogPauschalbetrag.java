...
public class DialogPauschalbetrag extends JDialog implements ActionListener {
	...
	private WrapperNumberField wnfPauschalbetrag = null;
	...
	public DialogPauschalbetrag(TabbedPaneBestellung tpBestellung) {
		...
		setTitle(LPMain.getInstance().getTextRespectUISPr("bes.pauschalbetrag"));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(wbuSpeichern)) {
			try {
				...
				if (wnfPauschalbetrag.getBigDecimal() == null) {
				...
				DelegateFactory
						...
						.bestellungAufPauschalbetragSetzten(
								tpBestellung.getBesDto().getIId(),
								wnfPauschalbetrag.getBigDecimal());
	...
	private void jbInit() throws Exception {
		...
		wnfPauschalbetrag = new WrapperNumberField();
		wnfPauschalbetrag.setMinimumValue(0);
		wnfPauschalbetrag.setFractionDigits(2);
		if (neueLosgroesse != null) {
			wnfPauschalbetrag.setInteger(neueLosgroesse);
		}
		...
		WrapperLabel wlaNeueLosgroesse = new WrapperLabel(LPMain.getInstance()
				.getTextRespectUISPr("bes.pauschalbetrag")+": ("+tpBestellung.getBesDto().getWaehrungCNr()+")");
		...
		panel1.add(wnfPauschalbetrag, new GridBagConstraints(0, 1, 2, 1, 1.0,
				1.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(0, 0, 0, 0), 0, 0));
