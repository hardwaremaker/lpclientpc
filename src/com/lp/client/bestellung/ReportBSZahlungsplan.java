...
public class ReportBSZahlungsplan extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportBSZahlungsplan(InternalFrame internalFrame,
	...
	public String getReportname() {
		return BestellungReportFac.REPORT_ZAHLUNGSPLAN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getBestellungDelegate()
				.printZahlungsplan(wdfStichtag.getTimestamp());
	}
