...
public class DialogPositionSplitten extends JDialog implements ActionListener,
		FocusListener {
	...
	private BestellpositionDto bsposDto = null;
	...
	private Integer bestellpositionIIdNeu = null;

	public Integer getBestellpositionIIdNeu() {
		return bestellpositionIIdNeu;
	}
	...
	public DialogPositionSplitten(Integer bestellpositionIId,
			InternalFrame iFrame) throws Throwable {
		super(LPMain.getInstance().getDesktop(), "", true);
		this.iFrame = iFrame;

		bsposDto = DelegateFactory.getInstance().getBestellungDelegate()
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(wbuSpeichern)) {
			...
			try {
				...
				bestellpositionIIdNeu = DelegateFactory
						.getInstance()
						.getBestellungDelegate()
						.bestellpositionSplitten(bsposDto.getIId(),
	...
	private void jbInit() throws Throwable {
		...
		wnfMenge.setBigDecimal(bsposDto.getNMenge());
		wdfLiefertermin.setTimestamp(bsposDto.getTUebersteuerterLiefertermin());
