...
public class PanelInternebestellung extends PanelBasis {
	...
	private WrapperGotoButton wbuStueckliste = new WrapperGotoButton(GotoHelper.GOTO_STUECKLISTE_DETAIL);
	...
	public PanelInternebestellung(InternalFrame internalFrame, String add2TitleI, Object key,
			TabbedPaneInternebestellung tabbedPaneInternebestellung) throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wdfProduktionsbeginn.getDisplay().addFocusListener(new PanelInternebestellung_focusAdapter(this));
		wdfProduktionsende.getDisplay().addFocusListener(new PanelInternebestellung_focusAdapter(this));
		...
		wlaStandort = new WrapperLabel(LPMain.getTextRespectUISPr("ib.bedarfsstandort"));

		wcbStandort = new WrapperComboBox();
		wcbStandort.setMandatoryField(true);
		wcbStandort.setActivatable(false);
		...
		if (bAutomatischeErmittlungProduktionsende == false) {
		...
		wnfLosgroesse.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wnfLosgroesse.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		this.add(getPanelStatusbar(), new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wbuAuftrag, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAuftragNummer, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAuftragBezeichnung, new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wbuAuftragposition, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAuftragpositionNummer, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAuftragpositionBezeichnung, new GridBagConstraints(2, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wlaKunde, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfKunde, new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wtfAdresse, new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wlaAbteilung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfAbteilung, new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wbuStueckliste, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 25), 0, 0));

		jPanelWorkingOn.add(wbuArtikel.getWrapperButtonGoTo(), new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 10, 0));

		jPanelWorkingOn.add(wtfStuecklisteNummer, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wtfStuecklisteBezeichnung, new GridBagConstraints(2, iZeile, 3, 1, 1.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wlaLosgroesse, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wnfLosgroesse, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wlaEinheit, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jPanelWorkingOn.add(wlaProduktionsbeginn, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jPanelWorkingOn.add(wdfProduktionsbeginn, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		if (bAutomatischeErmittlungProduktionsende == false) {

			jPanelWorkingOn.add(wlaDauer, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jPanelWorkingOn.add(wnfDauer, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 20, 0));
			jPanelWorkingOn.add(wlaTage, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

			iZeile++;
			jPanelWorkingOn.add(wlaProduktionsende, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jPanelWorkingOn.add(wdfProduktionsende, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		if (lagerminJeLager) {
			...
			jPanelWorkingOn.add(wlaStandort, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jPanelWorkingOn.add(wcbStandort, new GridBagConstraints(1, iZeile, 2, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI) throws Throwable {
		if (allMandatoryFieldsSetDlg()) {
			...
			if (ibDto != null) {
				// speichern
				InternebestellungDto savedDto = DelegateFactory.getInstance().getFertigungDelegate()
	...
	private void components2Dto() throws Throwable {
		...
		dto.setPartnerIIdStandort((Integer) wcbStandort.getKeyOfSelectedItem());
	...
	private void dto2Components() throws Throwable {
		InternebestellungDto ibDto = getTabbedPaneInternebestellung().getInternebestellungDto();
		if (ibDto.getBelegartCNr() != null && ibDto.getBelegartCNr().equals(LocaleFac.BELEGART_AUFTRAG)) {
		...
		wcbStandort.setKeyOfSelectedItem(ibDto.getPartnerIIdStandort());

		wnfDauer.setInteger(Helper.getDifferenzInTagen(ibDto.getTProduktionsbeginn(), ibDto.getTLiefertermin()));
	...
	private void dto2ComponentsStueckliste() throws Throwable {
		if (getTabbedPaneInternebestellung().getStuecklisteDto() != null) {
			...
			if (stuecklisteDto != null) {
				wbuArtikel.setOKey(stuecklisteDto.getArtikelIId());
			}

			wtfStuecklisteNummer.setText(stuecklisteDto.getArtikelDto().getCNr());

			if (stuecklisteDto.getArtikelDto().getArtikelsprDto() != null) {
				wtfStuecklisteBezeichnung.setText(stuecklisteDto.getArtikelDto().getArtikelsprDto().getCBez());
			} else {
	...
	protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI, boolean bNeedNoDeleteI)
		...
		if (ibDto != null) {
			if (ibDto.getIId() != null) {
				if (!isLockedDlg()) {
					Object[] o = getTabbedPaneInternebestellung().getPanelQueryInternebestellung(true).getSelectedIds();
					if (o != null) {
						for (int i = 0; i < o.length; i++) {
							InternebestellungDto toRemove = new InternebestellungDto();
							toRemove.setIId((Integer) o[i]);

							DelegateFactory.getInstance().getFertigungDelegate().removeInternebestellung(toRemove);
						}
					}
					getTabbedPaneInternebestellung().setInternebestellungDto(null);
					this.leereAlleFelder(this);
	...
	private void holeAuftragposition(Object key) throws Throwable {
		if (key != null) {
			auftragpositionDto = DelegateFactory.getInstance().getAuftragpositionDelegate()
					.auftragpositionFindByPrimaryKeyOhneExc((Integer) key);
		} else {
	...
	private void dialogQueryAuftragposition(ActionEvent e) throws Throwable {
		...
		panelQueryFLRAuftragposition = new PanelQueryFLR(null, filtersPositionen, QueryParameters.UC_ID_AUFTRAGPOSITION,
				aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("title.auftragauswahlliste"));
		if (auftragpositionDto != null) {
	...
	protected final void setAnzahlEintraege(String s) throws Throwable {
		setStatusbarSpalte5(s);
	...
	public void eventActionUpdate(ActionEvent aE, boolean bNeedNoUpdateI) throws Throwable {
	...
	protected void focusLostPI(FocusEvent e) throws Throwable {
		if (e.getSource() == wnfDauer || e.getSource() == wdfProduktionsbeginn.getDisplay()) {
			Date dEnde = wdfProduktionsende.getDate();
			if (wdfProduktionsbeginn.getDate() != null && wnfDauer.getInteger() != null) {
				dEnde = Helper.addiereTageZuDatum(wdfProduktionsbeginn.getDate(), wnfDauer.getInteger().intValue());
			...
			if (wdfProduktionsende.getDate() != null && wnfDauer.getInteger() != null) {
...
class PanelInternebestellung_focusAdapter implements java.awt.event.FocusListener {
