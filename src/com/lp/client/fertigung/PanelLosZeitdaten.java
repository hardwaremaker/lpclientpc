...
public class PanelLosZeitdaten extends PanelBasis {
	...
	private WrapperSpinner wspRuestzeitStunden = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(50000),
			new Integer(1));
	private WrapperSpinner wspRuestzeitMinuten = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(59),
			new Integer(1));
	private WrapperSpinner wspRuestzeitSekunden = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(59),
			new Integer(1));
	...
	private WrapperSpinner wspStueckzeitStunden = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(50000),
			new Integer(1));
	private WrapperSpinner wspStueckzeitMinuten = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(59),
			new Integer(1));
	private WrapperSpinner wspStueckzeitSekunden = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(59),
			new Integer(1));

	private WrapperSpinner wspMillisekundenStueckzeit = null;

	private WrapperSpinner wspMillisekundenRuestzeit = null;
	private WrapperSpinner wspTageRuestzeit = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(999),
			new Integer(1));
	private WrapperSpinner wspTageStueckzeit = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(999),
			new Integer(1));

	private WrapperSelectField wsfApkommentar = new WrapperSelectField(WrapperSelectField.APKOMMENTAR,
	...
	private JLabel wlaFertig = new JLabel();
	...
	private WrapperNumberField wnfFortschritt = new WrapperNumberField();
	...
	public PanelLosZeitdaten(InternalFrame internalFrame, String add2TitleI, Object key, TabbedPaneLos tabbedPaneLos)
			throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wlaPPM.setText(LPMain.getTextRespectUISPr("stkl.arbeitsplan.ppm"));
		wnfPPM.setFractionDigits(Defaults.getInstance().getIUINachkommastellenMenge());

		wnfFortschritt.setMinimumValue(0);
		wnfFortschritt.setMaximumValue(100);
		...
		ParametermandantDto parameter = (ParametermandantDto) DelegateFactory.getInstance().getParameterDelegate()
				.getParametermandant(ParameterFac.PARAMETER_THEORETISCHE_IST_ZEIT_RECHNUNG,
		...
		parameter = (ParametermandantDto) DelegateFactory.getInstance().getParameterDelegate().getParametermandant(
				ParameterFac.PARAMETER_ANZEIGE_IN_ARBEITSPLAN, ParameterFac.KATEGORIE_FERTIGUNG,
		...
		Map<String, String> m = DelegateFactory.getInstance().getStuecklisteDelegate().getAllArbeitsgangarten();
		wcoAgart.setMap(m);
		wcoAgart.addActionListener(this);
		wcbFertig.setText(LPMain.getTextRespectUISPr("lp.fertig"));
		wcbAutoEndeBeiGeht.setText(LPMain.getTextRespectUISPr("fert.loszeitdaten.autoendebeigeht"));
		wcbNurMaschinenzeit.setText(LPMain.getTextRespectUISPr("fert.loszeitdaten.nurmaschinenzeit"));

		wnfAufspannung.setFractionDigits(0);
		wnfAufspannung.setMinimumValue(1);
		wspMillisekundenStueckzeit = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(999),
				new Integer(1));

		wspMillisekundenRuestzeit = new WrapperSpinner(new Integer(0), new Integer(0), new Integer(999),
				new Integer(1));
		wlaKostenAG.setHorizontalAlignment(SwingConstants.LEFT);

		wifArtikel.getWbuArtikel().setText(LPMain.getTextRespectUISPr("button.taetigkeit"));
		wifArtikel.getWbuArtikel().setToolTipText(LPMain.getTextRespectUISPr("button.taetigkeit.tooltip"));
		wlaArbeitsgang.setText(LPMain.getTextRespectUISPr("stkl.arbeitsplan.arbeitsgang"));
		wlaRuestzeit.setText(LPMain.getTextRespectUISPr("stkl.arbeitsplan.ruestzeit"));
		wlaStueckzeit.setText(LPMain.getTextRespectUISPr("stkl.arbeitsplan.stueckzeit"));
		...
		wlaMaschinenversatztage.setText(LPMain.getTextRespectUISPr("fert.arbeitsplan.maschinenversatztage"));
		...
		wsfPersonalZugeordneter = new WrapperSelectField(WrapperSelectField.PERSONAL, getInternalFrame(), true);
		...
		jPanelWorkingOn.setBorder(BorderFactory.createEmptyBorder(0, 10, 10, 0));
		JPanel panelButtonAction = getToolsPanel();
		getInternalFrame().addItemChangedListener(this);

		wifArtikel.getWbuArtikel().setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wifArtikel.getWbuArtikel().setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wspMillisekundenRuestzeit.setMinimumSize(new Dimension(50, Defaults.getInstance().getControlHeight()));
		wspMillisekundenRuestzeit.setPreferredSize(new Dimension(50, Defaults.getInstance().getControlHeight()));

		wspMillisekundenStueckzeit.setMinimumSize(new Dimension(50, Defaults.getInstance().getControlHeight()));
		wspMillisekundenStueckzeit.setPreferredSize(new Dimension(50, Defaults.getInstance().getControlHeight()));

		wifArtikel.setDefaultFilter(ArtikelFilterFactory.getInstance().createFKArtikellisteNurArbeitszeit());
		...
		JPanel zeiten = new JPanel(
				new MigLayout("flowy, wrap 3", iAnzeigeArbeitszeit == 1 ? "[33%][33%][33%]" : "[25%][25%][25%][25%]"));
		...
		jPanelWorkingOn.add(wnfFortschritt, "growx");
		...
		jPanelWorkingOn.add(new WrapperLabel(LPMain.getTextRespectUISPr("stkl.aufspannung")), "growx");
		...
		if (LPMain.getInstance().getDesktop()
			...
			jPanelWorkingOn.add(wnfAufspannung, "growx");
			jPanelWorkingOn.add(wlaPPM, "growx");
			jPanelWorkingOn.add(wnfPPM, "growx, wrap");
		...
		jPanelWorkingOn.add(wsfApkommentar.getWrapperButton(), "growx");
		jPanelWorkingOn.add(wsfApkommentar.getWrapperTextField(), "growx, span 7");
		...
		getToolBar().addButtonCenter("/com/lp/client/res/check2.png",
				LPMain.getTextRespectUISPr("fert.arbeitsplan.togglefertig"), ACTION_SPECIAL_TOGGLE_AG_FERTIG, null,
				null);
		getToolBar().getToolsPanelCenter().add(wlaFertig);

	}

	void dialogQueryLossollarbeitsplanFromListe() throws Throwable {
		panelQueryFLRSollmaterial = FertigungFilterFactory.getInstance().createPanelFLRLossollmaterial(
				getInternalFrame(), getTabbedPaneLos().getLosDto().getIId(), loszeitDto.getLossollmaterialIId(), true);
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI) throws Throwable {
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
			if (loszeitDto != null) {
				LossollarbeitsplanDto savedDto = DelegateFactory.getInstance().getFertigungDelegate()
	...
	private void components2Dto() throws Throwable {
		...
		loszeitDto.setNPpm(wnfPPM.getBigDecimal());

		loszeitDto.setApkommentarIId(wsfApkommentar.getIKey());
		...
		long sTage = wspTageStueckzeit.getInteger().longValue() * (3600000 * 24);
		...
		loszeitDto.setPersonalIIdZugeordneter(wsfPersonalZugeordneter.getIKey());
		loszeitDto.setFFortschritt(wnfFortschritt.getDouble());

		if (wdfMaschinenversatztage.getTimestamp() != null) {

			int i = Helper.ermittleTageEinesZeitraumes(getTabbedPaneLos().getLosDto().getTProduktionsbeginn(),
	...
	private void dto2Components() throws Throwable {
		if (loszeitDto != null) {
			...
			wsfApkommentar.setKey(loszeitDto.getApkommentarIId());
			...
			wsfPersonalZugeordneter.setKey(loszeitDto.getPersonalIIdZugeordneter());
			wnfFortschritt.setDouble(loszeitDto.getFFortschritt());

			wnfPPM.setBigDecimal(loszeitDto.getNPpm());

			String text = "";

			if (loszeitDto.getTFertig() != null) {
				text = LPMain.getTextRespectUISPr("fert.loszeitfertig") + " "
						+ Helper.formatDatumZeit(loszeitDto.getTFertig(), LPMain.getTheClient().getLocUi());
			}
			if (loszeitDto.getPersonalIIdFertig() != null) {
				text += "(" + DelegateFactory.getInstance().getPersonalDelegate()
						.personalFindByPrimaryKey(loszeitDto.getPersonalIIdFertig()).getCKurzzeichen() + ")";
			}

			wlaFertig.setText(text);
			...
			if (dStueckzeit > 0) {
				...
				wspMillisekundenStueckzeit.setInteger(new Integer((int) sMsekunden));
			} else {
			...
			if (getTabbedPaneLos().getLosDto().getStuecklisteIId() != null) {
				StuecklisteDto stkDto = DelegateFactory.getInstance().getStuecklisteDelegate()
				...
				wlaLosgroesse.setText(LPMain.getTextRespectUISPr("label.losgroesse") + " = "
						+ Helper.formatZahl(getTabbedPaneLos().getLosDto().getNLosgroesse(), 0,
								LPMain.getInstance().getUISprLocale())
						+ " " + stkDto.getArtikelDto().getEinheitCNr().trim());
			} else {
				wlaLosgroesse.setText(LPMain.getTextRespectUISPr("label.losgroesse") + " = " + Helper.formatZahl(
						getTabbedPaneLos().getLosDto().getNLosgroesse(), 0, LPMain.getInstance().getUISprLocale()));
			}

			wcbAutoEndeBeiGeht.setVisible(true);
			...
			if (loszeitDto.getMaschineIId() != null) {
				...
				if(Helper.short2boolean(maschineDto.getBManuelleBedienung())) {
					wcbAutoEndeBeiGeht.setShort(Helper.boolean2Short(false));
					wcbAutoEndeBeiGeht.setVisible(false);
				} else {
					wcbAutoEndeBeiGeht.setVisible(true);
			...
			if (loszeitDto.getLossollmaterialIId() != null) {
				...
				LossollmaterialDto lossollmaterialDto = DelegateFactory.getInstance().getFertigungDelegate()
						.lossollmaterialFindByPrimaryKey(loszeitDto.getLossollmaterialIId());
			...
			if (Helper.short2Boolean(loszeitDto.getBNurmaschinenzeit()) == false) {
				BigDecimal preis = DelegateFactory.getInstance().getLagerDelegate()
						.getGemittelterGestehungspreisAllerLaegerEinesMandanten(loszeitDto.getArtikelIIdTaetigkeit());

				if (preis == null) {
					preis = new BigDecimal(0);
				}

				if (loszeitDto.getIAufspannung() != null && loszeitDto.getIAufspannung() >= 1) {
					preis = preis.divide(new BigDecimal(loszeitDto.getIAufspannung()), 4, BigDecimal.ROUND_HALF_EVEN);
				}
				kostenAG = kostenAG.add(preis.multiply(loszeitDto.getNGesamtzeit()));
				sKosten = LPMain.getTextRespectUISPr("fert.loszeitdaten.personalkosten") + " "

						+ Helper.formatZahl(preis, 2, LPMain.getTheClient().getLocUi()) + " "
			...
			if (loszeitDto.getMaschineIId() != null) {
				BigDecimal bdKosten = DelegateFactory.getInstance().getZeiterfassungDelegate()
						.getMaschinenKostenZumZeitpunkt(loszeitDto.getMaschineIId(), LocaleFac.BELEGART_LOS, loszeitDto.getIId());

				if (loszeitDto.getIAufspannung() != null && loszeitDto.getIAufspannung() >= 1) {
					bdKosten = bdKosten.divide(new BigDecimal(loszeitDto.getIAufspannung()), 4,
				...
				kostenAG = kostenAG.add(bdKosten.multiply(loszeitDto.getNGesamtzeit()));

				sKosten += LPMain.getTextRespectUISPr("fert.loszeitdaten.maschinenkosten") + " "

						+ Helper.formatZahl(bdKosten, 2, LPMain.getTheClient().getLocUi()) + " "
						+ LPMain.getTheClient().getSMandantenwaehrung();

			}

			wlaKostenAG.setText(Helper.formatZahl(loszeitDto.getNGesamtzeit(), 4, LPMain.getTheClient().getLocUi())
					+ " " + SystemFac.EINHEIT_STUNDE.trim() + "/ " + LPMain.getTextRespectUISPr("lp.kosten") + ": "
					+ Helper.formatZahl(kostenAG, 2, LPMain.getTheClient().getLocUi()) + " "
					+ LPMain.getTheClient().getSMandantenwaehrung());

			if (loszeitDto.getIMaschinenversatztage() != null) {

				wdfMaschinenversatztage.setDate(Helper.addiereTageZuDatum(
						getTabbedPaneLos().getLosDto().getTProduktionsbeginn(), loszeitDto.getIMaschinenversatztage()));
				...
				wdfMaschinenversatztage.setDate(getTabbedPaneLos().getLosDto().getTProduktionsbeginn());
			}
			...
			// Statusleiste
			this.setStatusbarPersonalIIdAendern(loszeitDto.getPersonalIIdAendern());
	...
	protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI, boolean bNeedNoDeleteI)
		...
		if (this.loszeitDto != null) {
			if (loszeitDto.getIId() != null) {
				if (!isLockedDlg()) {
					DelegateFactory.getInstance().getFertigungDelegate().removeLossollarbeitsplan(loszeitDto);
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		...
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_SOLLMATERIAL_FROM_LISTE)) {
			dialogQueryLossollarbeitsplanFromListe();
		}

		if (e.getActionCommand().equals(ACTION_SPECIAL_TOGGLE_AG_FERTIG)) {
			if (loszeitDto != null && loszeitDto.getIId() != null) {
				DelegateFactory.getInstance().getFertigungDelegate().toggleArbeitsplanFertig(loszeitDto.getIId());
				getTabbedPaneLos().getPanelQueryZeitdaten(false).eventYouAreSelected(false);
			}
		}
	...
	private void dialogQueryMaschineFromListe() throws Throwable {
		...
		if (LPMain.getInstance().getDesktop()
				...
				&& getTabbedPaneLos().getLosDto().getStuecklisteIId() != null) {

			// Alle moeglichen Maschinen holen

			List<Integer> al = DelegateFactory.getInstance().getStuecklisteDelegate()
					.getMoeglicheMaschinen(loszeitDto.getIId());

			if (al.size() == 0) {
				DialogFactory.showModalDialog(LPMain.getTextRespectUISPr("lp.error"),
						LPMain.getTextRespectUISPr("fert.keinemaschinegefunden"));
				return;
			}

			panelQueryFLRMaschine = ZeiterfassungFilterFactory.getInstance()
					.createPanelFLRAlternativmaschinen(getInternalFrame(), al, loszeitDto.getMaschineIId());
		} else {
	...
	private void holeArtikel(Object key) throws Throwable {
		...
		if (key != null) {
			artikelDto = DelegateFactory.getInstance().getArtikelDelegate().artikelFindByPrimaryKey((Integer) key);
		} else {
			artikelDto = null;
		}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI) throws Throwable {
		...
		if (!bNeedNoYouAreSelectedI) {
			...
			if (key == null || key.equals(LPMain.getLockMeForNew())) {
				...
				Integer i = DelegateFactory.getInstance().getFertigungDelegate()
						.getNextArbeitsgang(getTabbedPaneLos().getLosDto().getIId());
				if (i != null) {
					wnfArbeitsgang.setInteger(i);
				} else {
					wnfArbeitsgang.setInteger(new Integer(10));
				}
				wdfMaschinenversatztage.setMinimumValue(getTabbedPaneLos().getLosDto().getTProduktionsbeginn());
				wdfMaschinenversatztage.setDate(getTabbedPaneLos().getLosDto().getTProduktionsbeginn());
				...
				loszeitDto = DelegateFactory.getInstance().getFertigungDelegate()
