...
public class ReportNichtErfasstePruefergebnisse extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportNichtErfasstePruefergebnisse(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wlaVon.setText(LPMain.getInstance().getTextRespectUISPr(
				"fert.report.nichterfasste.pruefergebnisse.abgeliefert.von"));
	...
	public String getReportname() {
		return FertigungReportFac.REPORT_NICHT_ERFASSTE_PRUEFERGEBNISSE;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		JasperPrintLP jasperPrint = null;
			...
			jasperPrint = DelegateFactory
					...
					.printNichtErfasstePruefergebnisse(
