...
public class ReportBedarfsuebernahmeOffene extends PanelBasis implements
		PanelReportIfJRDS {
	...
	private WrapperCheckBox wcbnurRueckgaben = new WrapperCheckBox();
	...
	public ReportBedarfsuebernahmeOffene(InternalFrame internalFrame,
	...
	protected void eventItemchanged(EventObject eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			if (e.getSource() == panelQueryFLRLos) {
				Integer iKey = (Integer) panelQueryFLRLos.getSelectedId();

				LosDto losDto = DelegateFactory.getInstance()
						.getFertigungDelegate().losFindByPrimaryKey(iKey);
	...
	private void jbInit() throws Throwable {
		...
		wcbnurRueckgaben
				.setText(LPMain
						.getTextRespectUISPr("fert.bedarfsuebernahme.report.offene.nurrueckgaben"));
		...
		jpaWorkingOn.add(wtfLos, new GridBagConstraints(1, iZeile, 1, 1, 0,
				...
				new Insets(0, 0, 0, 0), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wcbnurRueckgaben, new GridBagConstraints(0, iZeile, 1,
	...
	public String getReportname() {
		return FertigungReportFac.REPORT_BEDARFSUEBERNAHME_OFFENE;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory
				...
				.printBedarfsuebernahmeOffene(wsfPersonal.getIKey(), losIId,
						wcbnurRueckgaben.isSelected());
	}
