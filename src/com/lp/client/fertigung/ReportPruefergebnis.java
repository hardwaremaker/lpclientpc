...
public class ReportPruefergebnis extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private WrapperLabel wrbErledigt = new WrapperLabel();
	...
	public ReportPruefergebnis(InternalFrame internalFrame, String add2Title)
			throws Throwable {
	...
	public String getReportname() {
		return FertigungReportFac.REPORT_PRUEFERGEBNIS;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		if (auftragIId == null && losIId == null) {
			...
			jasperPrint = DelegateFactory
					.getInstance()
					.getFertigungDelegate()
					.printPruefergebnis(null, null, losIId, stuecklisteIId,
							auftragIId);
