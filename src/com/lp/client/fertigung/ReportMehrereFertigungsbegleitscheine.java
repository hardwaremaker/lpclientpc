 ...
 */
public class ReportMehrereFertigungsbegleitscheine extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	private ArrayList<Integer> losIIds = null;

	public ReportMehrereFertigungsbegleitscheine(InternalFrame internalFrame,
			ArrayList<Integer> losIIds, String sAdd2Title) throws Throwable {
		// reporttitel: das PanelReport kriegt einen Titel, der wird vom
		// Framework hergenommen
		super(internalFrame, sAdd2Title);
		this.losIIds = losIIds;
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getFertigungDelegate()
				.printMehrereFertigungsbegleitscheine(losIIds);
	}
