...
public class PanelPersonal extends PanelBasis {
	...
	private WrapperGotoButton wbuPartner = new WrapperGotoButton(com.lp.util.GotoHelper.GOTO_PARTNER_AUSWAHL);
	...
	private WrapperMapButton wbuMapButton = null;

	public InternalFramePersonal getInternalFramePersonal() {
		return internalFramePersonal;
	}

	public PanelPersonal(InternalFrame internalFrame, String add2TitleI, Object pk) throws Throwable {
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI) throws Throwable {
		...
		if (key != null) {
			personalDto = DelegateFactory.getInstance().getPersonalDelegate()
					.personalFindByPrimaryKey(getInternalFramePersonal().getPersonalDto().getIId());

			dto2Components();
			getInternalFramePersonal().getTabbedPanePersonal().refreshTitle();
		} else {
			leereAlleFelder(this);
			wnfPersonalnummer.setText(DelegateFactory.getInstance().getPersonalDelegate().getNextPersonalnummer());
			try {
...
//				wtfStammkostenstelle.setText(dto.getCNr());
				...
				wtfStammkostenstelle.setText(kostenstelleDto.getCNr());
	...
	protected void dto2Components() throws Throwable {
		...
		wtfNachname.setText(personalDto.getPartnerDto().getCName1nachnamefirmazeile1());
		wtfTitel.setText(personalDto.getPartnerDto().getCTitel());
		wtfNtitel.setText(personalDto.getPartnerDto().getCNtitel());
		wtfVorname1.setText(personalDto.getPartnerDto().getCName2vornamefirmazeile2());
		wtfVorname2.setText(personalDto.getPartnerDto().getCName3vorname2abteilung());
		...
		if (personalDto.getPartnerDto().getLandplzortDto() != null) {
			wtfOrt.setText(personalDto.getPartnerDto().getLandplzortDto().formatLandPlzOrt());
		} else {
			wtfOrt.setText(null);
		}
		if (personalDto.getPersonalgruppeIId() != null) {
			...
			PersonalgruppeDto personalgruppeDto = DelegateFactory.getInstance().getPersonalDelegate()
					.personalgruppeFindByPrimaryKey(personalDto.getPersonalgruppeIId());
		...
		wcoPersonalfunktion.setKeyOfSelectedItem(personalDto.getPersonalfunktionCNr());
		if (personalDto.getKostenstelleDto_Abteilung() != null) {
			wtfAbteilung.setText(personalDto.getKostenstelleDto_Abteilung().formatKostenstellenbezeichnung());
		} else {
			wtfAbteilung.setText(null);
		}
		if (personalDto.getKostenstelleDto_Stamm() != null) {
			wtfStammkostenstelle.setText(personalDto.getKostenstelleDto_Stamm().formatKostenstellenbezeichnung());
		} else {
		...
		if (personalDto.getPartnerDto().getCHandy() != null) {
			wtfHandy.setPartnerKommunikationDto(personalDto.getPartnerDto(), personalDto.getPartnerDto().getCHandy());
		} else {
			wtfHandy.setPartnerKommunikationDto(null, null);
		}

		wtfEmail.setEmail(personalDto.getPartnerDto().getCEmail(), null);
		wtfEmail.setMailLocale(Helper.string2Locale(personalDto.getPartnerDto().getLocaleCNrKommunikation()));
		...
		wbuMapButton.setPartnerDto(personalDto.getPartnerDto());
	...
	void dialogQueryKostenstelleAbteilungFromListe(ActionEvent e) throws Throwable {
		panelQueryFLRKostenstelleAbteilung = SystemFilterFactory.getInstance()
				.createPanelFLRKostenstelle(getInternalFrame(), false, true, personalDto.getKostenstelleIIdAbteilung());
		new DialogQuery(panelQueryFLRKostenstelleAbteilung);
	}

	void dialogQueryKostenstelleHeimatkostenstelleFromListe(ActionEvent e) throws Throwable {
		panelQueryFLRHeimatKostenstelle = SystemFilterFactory.getInstance()
				.createPanelFLRKostenstelle(getInternalFrame(), false, true, personalDto.getKostenstelleIIdStamm());
	...
	void dialogQueryPersonalgruppeFromListe(ActionEvent e) throws Throwable {
		panelQueryFLRPersonalgruppe = PersonalFilterFactory.getInstance()
				.createPanelFLRPersonalgruppe(getInternalFrame(), personalDto.getPersonalgruppeIId(), true);
	...
	void dialogQueryOrtFromListe(ActionEvent e) throws Throwable {
		...
		panelQueryFLROrt = SystemFilterFactory.getInstance().createPanelFLRLandplzort(getInternalFrame(), selectedId,
				true);
	...
	private void jbInit() throws Throwable {
		...
		wbuPartner.setText(LPMain.getTextRespectUISPr("lp.name") + "...");
		wrbMaennlich.setSelected(true);
		wrbMaennlich.setText(LPMain.getTextRespectUISPr("lp.maennlich"));
		wrbWeiblich.setText(LPMain.getTextRespectUISPr("lp.weiblich"));
		wlaVorname2.setText(LPMain.getTextRespectUISPr("lp.vorname") + " 2");
		wlaVorname1.setText(LPMain.getTextRespectUISPr("lp.vorname") + " 1");
		wlaKurzkennung.setText(LPMain.getTextRespectUISPr("personal.kurzbez"));
		wlaStrasse.setText(LPMain.getTextRespectUISPr("lp.strasse"));
		wbuOrt.setText(LPMain.getTextRespectUISPr("lp.label.ort") + "...");
		...
		wtfNachname.addFocusListener(new PanelPersonal_wtfNachname_focusAdapter(this));
		wlaPersonalart.setText(LPMain.getTextRespectUISPr("pers.personal.personalart"));
		wcoPersonalart.setMandatoryFieldDB(true);
		wcoPersonalart.setMandatoryField(true);
		wlaPersonalfunktion.setText(LPMain.getTextRespectUISPr("pers.personal.personalfunktion"));
		...
		wbuAbteilung.setText(LPMain.getTextRespectUISPr("lp.abteilung") + "...");
		wbuAbteilung.setActionCommand(PanelPersonal.ACTION_SPECIAL_KOSTENSTELLE_ABTEILUNG_FROM_LISTE);
		wbuAbteilung.addActionListener(this);
		wbuStammkostenstelle.setText(LPMain.getTextRespectUISPr("pers.personal.heimatkostenstelle") + "...");
		wbuStammkostenstelle.setActionCommand(PanelPersonal.ACTION_SPECIAL_HEIMATKOSTENSTELLE_FROM_LISTE);
		wbuStammkostenstelle.addActionListener(this);
		wlaGeschlecht.setText(LPMain.getTextRespectUISPr("lp.geschlecht"));
		wlaPersonalnummer.setText(LPMain.getTextRespectUISPr("pers.personal.personalnummer"));

		wbuPersonalgruppe = new WrapperButton(LPMain.getTextRespectUISPr("pers.personalgruppe") + "...");

		wbuPersonalgruppe.setActionCommand(PanelPersonal.ACTION_SPECIAL_PERSONALGRUPPE_FROM_LISTE);
		wbuPersonalgruppe.addActionListener(this);

		wtfPersonalgruppe = new WrapperTextField();
		wtfPersonalgruppe.setActivatable(false);

		wlaKurzzeichen.setText(LPMain.getTextRespectUISPr("pers.personal.kurzzeichen"));
		...
		wbuPartner.setActionCommand(PanelPersonal.ACTION_SPECIAL_PARTNER_FROM_LISTE);
		...
		wlaFax.setText(LPMain.getTextRespectUISPr("lp.fax"));
		wlaHomepage.setText(LPMain.getTextRespectUISPr("lp.homepage"));

		wlaHandy.setText(LPMain.getTextRespectUISPr("lp.handy"));
		...
		jpaWorkingOn.add(wlaVorname1, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaVorname2, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaStrasse, new GridBagConstraints(0, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfNachname, new GridBagConstraints(1, 2, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfVorname1, new GridBagConstraints(1, 5, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfVorname2, new GridBagConstraints(1, 6, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfStrasse, new GridBagConstraints(1, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wbuPartner, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wtfStammkostenstelle, new GridBagConstraints(1, 12, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wbuStammkostenstelle, new GridBagConstraints(0, 12, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wbuAbteilung, new GridBagConstraints(3, 12, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfAbteilung, new GridBagConstraints(4, 12, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wbuOrt, new GridBagConstraints(0, 10, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfOrt, new GridBagConstraints(1, 10, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaPersonalart, new GridBagConstraints(3, 7, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOn.add(wcoPersonalart, new GridBagConstraints(4, 7, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wbuPersonalgruppe, new GridBagConstraints(3, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOn.add(wtfPersonalgruppe, new GridBagConstraints(4, 8, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaPersonalfunktion, new GridBagConstraints(3, 10, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wcoPersonalfunktion, new GridBagConstraints(4, 10, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaGeschlecht, new GridBagConstraints(0, 7, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), -1, 0));
		jpaWorkingOn.add(wrbMaennlich, new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 70, 0));
		jpaWorkingOn.add(wrbWeiblich, new GridBagConstraints(1, 7, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 70, 0));
		jpaWorkingOn.add(wnfPersonalnummer, new GridBagConstraints(1, 0, 1, 1, 0.07, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaKurzzeichen, new GridBagConstraints(3, 0, 1, 1, 0.05, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 0, 0, 0), 0, 0));
		jpaWorkingOn.add(wlaPersonalnummer, new GridBagConstraints(0, 0, 1, 1, 0.05, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfKurzzeichen, new GridBagConstraints(4, 0, 1, 1, 0.07, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(10, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaAusweis, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfAusweis, new GridBagConstraints(1, 1, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaKurzkennung, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfKurzkennung, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		if (DelegateFactory.getInstance().getTheJudgeDelegate()
				.hatRecht(com.lp.server.benutzer.service.RechteFac.RECHT_LP_DARF_VERSTECKTE_SEHEN)) {
			jpaWorkingOn.add(wcbVersteckt, new GridBagConstraints(2, 3, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
					GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		}

		jpaWorkingOn.add(wlaTitel, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfTitel, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaNtitel, new GridBagConstraints(3, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfNtitel, new GridBagConstraints(4, 4, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaTelefon, new GridBagConstraints(0, 14, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaFax, new GridBagConstraints(0, 15, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaHandy, new GridBagConstraints(0, 16, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfTelefon, new GridBagConstraints(1, 14, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wtfFax, new GridBagConstraints(1, 15, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wtfHandy, new GridBagConstraints(1, 16, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaEmail, new GridBagConstraints(3, 14, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfEmail, new GridBagConstraints(4, 14, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaHomepage, new GridBagConstraints(3, 15, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfHomepage, new GridBagConstraints(4, 15, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wmcBild, new GridBagConstraints(0, 17, 5, 1, 1, 1, GridBagConstraints.CENTER,
		...
		wbuMapButton = new WrapperMapButton(new PartnerDto());
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		...
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_PARTNER_FROM_LISTE)) {
			dialogQueryPartnerFromListe(e);
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_HEIMATKOSTENSTELLE_FROM_LISTE)) {
			dialogQueryKostenstelleHeimatkostenstelleFromListe(e);
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_PERSONALGRUPPE_FROM_LISTE)) {
	...
	protected void setDefaults() throws Throwable {
		wcoPersonalart.setMap(DelegateFactory.getInstance().getPersonalDelegate().getAllSprPersonalarten());
		wcoPersonalfunktion.setMap(DelegateFactory.getInstance().getPersonalDelegate().getAllSprPersonalfunktionen());
	}

	protected void components2Dto() throws Throwable {
		personalDto.setPersonalartCNr((String) wcoPersonalart.getKeyOfSelectedItem());
		personalDto.setPersonalfunktionCNr((String) wcoPersonalfunktion.getKeyOfSelectedItem());
		...
		personalDto.getPartnerDto().setCName1nachnamefirmazeile1(wtfNachname.getText());
		personalDto.getPartnerDto().setCName2vornamefirmazeile2(wtfVorname1.getText());
		personalDto.getPartnerDto().setCName3vorname2abteilung(wtfVorname2.getText());
		...
		personalDto.getPartnerDto().setOBild(wmcBild.getImageOriginalBytes());
...
//				Helper.imageToByteArray((BufferedImage) wmcBild.getImage()));
	...
	protected void eventActionDelete(ActionEvent e, boolean bAdministrateLockKeyI, boolean bNeedNoDeleteI)
		...
		Object[] options = { LPMain.getTextRespectUISPr("lp.ja"),
				LPMain.getTextRespectUISPr("pers.nurpersonalloeschen") };

		int iOption = DialogFactory.showModalDialog(getInternalFrame(),
				LPMain.getTextRespectUISPr("pers.frage.zugehoerigerpartnerloeschen"), "", options, options[1]);

		if (iOption == JOptionPane.YES_OPTION) {
			DelegateFactory.getInstance().getPersonalDelegate().removePersonal(personalDto);
			try {
				DelegateFactory.getInstance().getPartnerDelegate().removePartner(personalDto.getPartnerDto());
			} catch (ExceptionLP ex) {
				if (ex.getICode() == EJBExceptionLP.FEHLER_BEIM_LOESCHEN) {
					DialogFactory.showModalDialog(LPMain.getTextRespectUISPr("lp.error"),
							LPMain.getTextRespectUISPr("part.zugehoerigerpartnerkonntenichtgeloeschtwerden"));
				}
			}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI) throws Throwable {
		if (allMandatoryFieldsSetDlg()) {
			...
			if (personalDto.getIId() == null) {
				personalDto.setIId(DelegateFactory.getInstance().getPersonalDelegate().createPersonal(personalDto));
				...
				try {
					...
					if (ex.getICode() == EJBExceptionLP.FEHLER_PERSONAL_DUPLICATE_AUSWEIS) {
						String msg = LPMain.getTextRespectUISPr("pers.error.doppelteausweisnummern");

						PersonalDto personalDtoTemp = DelegateFactory.getInstance().getPersonalDelegate()
								.personalFindByCAusweis(personalDto.getCAusweis());
						if (personalDtoTemp.getMandantCNr().equals(LPMain.getTheClient().getMandant())) {
							PartnerDto partnerDtoTemp = DelegateFactory.getInstance().getPartnerDelegate()
									.partnerFindByPrimaryKey(personalDtoTemp.getPartnerIId());
							msg += " (Person: " + partnerDtoTemp.formatFixTitelName1Name2() + ")";
						} else {
							msg += " (Bei Mandant " + personalDtoTemp.getMandantCNr() + ")";
						}
			...
			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(personalDto.getIId().toString());
			}
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			if (e.getSource() == panelQueryFLROrt) {
				...
				if (partnerDto.getLandplzortDto() != null) {
					wtfOrt.setText(partnerDto.getLandplzortDto().formatLandPlzOrt());
				} else {
					wtfOrt.setText(null);
				}
				...
				wtfAbteilung.setText(kostenstelleDto.formatKostenstellenbezeichnung());
				...
				KostenstelleDto kostenstelleDto = null;
				kostenstelleDto = DelegateFactory.getInstance().getSystemDelegate().kostenstelleFindByPrimaryKey(key);
				wtfStammkostenstelle.setText(kostenstelleDto.formatKostenstellenbezeichnung());
	...
	public void wtfNachname_focusLost(FocusEvent e) {
		...
		try {
			if (personalDto.getPartnerIId() == null) {
				...
				if (wtfNachname != null && wtfNachname.getText() != null && !wtfNachname.getText().equals("")) {
					...
					if (p.length > 0) {
						...
						try {
							...
							for (int i = 0; i < p.length; i++) {
								sP += p[i].formatTitelAnrede() + " " + (p[i].getCUid() == null ? "" : p[i].getCUid());
								sP += " | ";
							}
							Object pattern[] = { sP };
		...
		if (!bExit) {
			...
			if (wtfKurzkennung != null) {
				iLK = wtfKurzkennung.getText() == null ? 0 : wtfKurzkennung.getText().length();
			}

			if (iLK == 0) {
				String sN1 = " ";
				if (wtfNachname != null) {
					sN1 = wtfNachname.getText() == null ? " " : wtfNachname.getText() + " ";
				}
