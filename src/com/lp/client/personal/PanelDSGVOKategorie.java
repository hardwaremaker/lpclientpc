...
public class PanelDSGVOKategorie extends PanelBasis {
	...
	private DsgvokategorieDto dsgvokategorieDto = null;
	private WrapperLabel wlaBezeichnung = new WrapperLabel();
	private WrapperTextField wtfBezeichnung = new WrapperTextField();

	public PanelDSGVOKategorie(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		dsgvokategorieDto = new DsgvokategorieDto();
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getPartnerServicesDelegate()
				.removeDsgvokategorie(dsgvokategorieDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		dsgvokategorieDto.setCNr(wtfKennung.getText());
		if (dsgvokategorieDto.getDsgvokategoriesprDto() == null) {
			dsgvokategorieDto.setDsgvokategoriesprDto(new DsgvokategoriesprDto());
		}
		dsgvokategorieDto.getDsgvokategoriesprDto().setCBez(wtfBezeichnung.getText());

	}

	protected void dto2Components() {
		wtfKennung.setText(dsgvokategorieDto.getCNr());
		if (dsgvokategorieDto.getDsgvokategoriesprDto() != null) {
			wtfBezeichnung.setText(dsgvokategorieDto.getDsgvokategoriesprDto()
					.getCBez());
		} else {
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
				...
				DelegateFactory.getInstance().getPartnerServicesDelegate()
						.updateDsgvokategorie(dsgvokategorieDto);
			
			super.eventActionSave(e, true);

			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(dsgvokategorieDto.getCNr());
			}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_DSGVOKATEGORIE;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			dsgvokategorieDto = DelegateFactory.getInstance()
					.getPartnerServicesDelegate()
					.dsgvokategorieFindByPrimaryKey((Integer) key);
