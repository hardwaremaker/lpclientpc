...
import com.lp.server.partner.service.DsgvokategoriesprDto;
import com.lp.server.personal.service.AbwesenheitsartDto;
import com.lp.server.personal.service.AbwesenheitsartsprDto;
import com.lp.server.personal.service.PersonalFac;

@SuppressWarnings("static-access")
public class PanelAbwesenheitsart extends PanelBasis {
	...
	private AbwesenheitsartDto abwesenheitsartDto = null;
	private WrapperLabel wlaBezeichnung = new WrapperLabel();
	private WrapperTextField wtfBezeichnung = new WrapperTextField();

	public PanelAbwesenheitsart(InternalFrame internalFrame, String add2TitleI,
	...
	public void eventActionNew(EventObject eventObject, boolean bLockMeI,
		...
		abwesenheitsartDto = new AbwesenheitsartDto();
	...
	protected void eventActionDelete(ActionEvent e,
		...
		DelegateFactory.getInstance().getPersonalDelegate()
				.removeAbwesenheitsart(abwesenheitsartDto);
		this.setKeyWhenDetailPanel(null);
		super.eventActionDelete(e, false, false);
	}

	protected void components2Dto() {
		abwesenheitsartDto.setCNr(wtfKennung.getText());
		if (abwesenheitsartDto.getAbwesenheitsartsprDto() == null) {
			abwesenheitsartDto.setAbwesenheitsartsprDto(new AbwesenheitsartsprDto());
		}
		abwesenheitsartDto.getAbwesenheitsartsprDto().setCBez(wtfBezeichnung.getText());

	}

	protected void dto2Components() {
		wtfKennung.setText(abwesenheitsartDto.getCNr());
		if (abwesenheitsartDto.getAbwesenheitsartsprDto() != null) {
			wtfBezeichnung.setText(abwesenheitsartDto.getAbwesenheitsartsprDto()
					.getCBez());
		} else {
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI)
		...
		if (allMandatoryFieldsSetDlg()) {
			components2Dto();
				...
				DelegateFactory.getInstance().getPersonalDelegate()
						.updateAbwesenheitsart(abwesenheitsartDto);
			
			super.eventActionSave(e, true);

			if (getInternalFrame().getKeyWasForLockMe() == null) {
				getInternalFrame().setKeyWasForLockMe(abwesenheitsartDto.getCNr());
			}
	...
	protected String getLockMeWer() throws Exception {
		return HelperClient.LOCKME_ABWESENHEITSART;
	}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI)
		...
		if (key == null || (key.equals(LPMain.getLockMeForNew()))) {
			...
			abwesenheitsartDto = DelegateFactory.getInstance()
					.getPersonalDelegate()
					.abwesenheitsartFindByPrimaryKey((Integer) key);
