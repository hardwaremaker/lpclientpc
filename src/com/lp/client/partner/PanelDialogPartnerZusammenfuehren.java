...
public class PanelDialogPartnerZusammenfuehren extends PanelDialog {
	...
	public PanelDialogPartnerZusammenfuehren(PartnerDto partnerZielDto, InternalFrame internalFrame, String add2TitleI)
			throws Throwable {

		super(internalFrame, add2TitleI + " | " + partnerZielDto.formatFixTitelName1Name2());

		partnerZielDto.setBankDto(DelegateFactory.getInstance().getPartnerbankDelegate()
	...
	private void jbInit() throws Throwable {
		...
		jScrollPanePartner = new javax.swing.JScrollPane(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		wbuZielPartnerAuswaehlen.setText(LPMain.getInstance().getTextRespectUISPr("part.partner") + "...");
		wbuZielPartnerAuswaehlen.setToolTipText(LPMain.getInstance().getTextRespectUISPr("title.partnerauswahlliste"));
		wbuZielPartnerAuswaehlen.addActionListener(this);
		wbuZielPartnerAuswaehlen.setActionCommand(ACTION_ZIELPARTNER_AUSWAEHLEN);
		wbuZielPartnerAuswaehlen.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuZielPartnerAuswaehlen.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wbuZielPartnerAuswaehlen.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		...
		wbuQuellPartnerAuswaehlen.setText(LPMain.getInstance().getTextRespectUISPr("part.partner") + "...");
		wbuQuellPartnerAuswaehlen.setToolTipText(LPMain.getInstance().getTextRespectUISPr("title.partnerauswahlliste"));
		wbuQuellPartnerAuswaehlen.addActionListener(this);
		wbuQuellPartnerAuswaehlen.setActionCommand(ACTION_QUELLPARTNER_AUSWAEHLEN);
		wbuQuellPartnerAuswaehlen.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuQuellPartnerAuswaehlen.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wbuQuellPartnerAuswaehlen.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		...
		wbuZielPartnerAnsprechpartnerAuswaehlen
				.setText(LPMain.getInstance().getTextRespectUISPr("label.ansprechpartner") + "...");
		wbuZielPartnerAnsprechpartnerAuswaehlen
				.setToolTipText(LPMain.getInstance().getTextRespectUISPr("title.ansprechpartnerauswahlliste"));
		wbuZielPartnerAnsprechpartnerAuswaehlen.addActionListener(this);
		wbuZielPartnerAnsprechpartnerAuswaehlen.setActionCommand(ACTION_ZIELPARTNERANSPRECHPARTNER_AUSWAEHLEN);
		wbuZielPartnerAnsprechpartnerAuswaehlen
				.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuZielPartnerAnsprechpartnerAuswaehlen
				.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wbuZielPartnerAnsprechpartnerAuswaehlen
				.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		...
		wbuQuellPartnerAnsprechpartnerAuswaehlen.setActionCommand(ACTION_QUELLPARTNERANSPRECHPARTNER_AUSWAEHLEN);
		wbuQuellPartnerAnsprechpartnerAuswaehlen
				.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuQuellPartnerAnsprechpartnerAuswaehlen
				.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wlaAnrede.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaAnrede.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaAnrede.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerAnrede.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnrede.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnrede.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerAnrede.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerAnrede.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerAnrede.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaTitel.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaTitel.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaTitel.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerTitel.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerTitel.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerTitel.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerTitel.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerTitel.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerTitel.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaName1.setText(LPMain.getInstance().getTextRespectUISPr("part.firma_nachname") + ": ");
		wlaName1.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaName1.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaName1.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerName1.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName1.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName1.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerName1.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName1.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName1.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaName2.setText(LPMain.getInstance().getTextRespectUISPr("lp.name") + ": "); // hole Text aus
																						// messages.properties
		wlaName2.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaName2.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaName2.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerName2.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName2.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName2.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerName2.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName2.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName2.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaName3.setText(LPMain.getInstance().getTextRespectUISPr("lp.abteilung") + ": ");
		wlaName3.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaName3.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaName3.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerName3.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName3.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerName3.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerName3.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName3.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerName3.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaStrasse.setText(LPMain.getInstance().getTextRespectUISPr("lp.strasse") + ": ");
		wlaStrasse.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaStrasse.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaStrasse.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerStrasse.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerStrasse.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerStrasse.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerStrasse.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerStrasse.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerStrasse.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaOrt.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaOrt.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaOrt.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerOrt.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerOrt.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerOrt.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerOrt.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerOrt.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerOrt.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPostfachort.setText(LPMain.getInstance().getTextRespectUISPr("lp.postfach") + ": ");
		wlaPostfachort.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPostfachort.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPostfachort.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuPostfachortDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		...
		wtfZielPartnerPostfachort.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPostfachort.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPostfachort.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerPostfachort.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPostfachort.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPostfachort.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPostfachnr.setText(LPMain.getInstance().getTextRespectUISPr("lp.postfach.nr") + ": ");
		wlaPostfachnr.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPostfachnr.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPostfachnr.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuPostfachnrDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		...
		wtfZielPartnerPostfachnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPostfachnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPostfachnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerPostfachnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPostfachnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPostfachnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKurzbez.setText(LPMain.getInstance().getTextRespectUISPr("lp.kurzbez") + ": ");
		wlaKurzbez.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaKurzbez.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaKurzbez.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerKurzbez.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerKurzbez.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerKurzbez.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerKurzbez.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerKurzbez.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerKurzbez.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPartnerart.setText(LPMain.getInstance().getTextRespectUISPr("part.partnerart") + ": ");
		wlaPartnerart.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPartnerart.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPartnerart.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuPartnerartDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		...
		wtfZielPartnerPartnerart.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPartnerart.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPartnerart.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerPartnerart.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPartnerart.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPartnerart.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaUid.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaUid.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaUid.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerUid.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerUid.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerUid.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerUid.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerUid.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerUid.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKommunikationsspr.setText(LPMain.getInstance().getTextRespectUISPr("part.sprache.kommunikation") + ": ");
		wlaKommunikationsspr.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaKommunikationsspr.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaKommunikationsspr.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wbuKommunikationssprDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuKommunikationssprDatenrichtung);
		...
		wtfZielPartnerKommunikationsspr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerKommunikationsspr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerKommunikationsspr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerKommunikationsspr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerKommunikationsspr
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerKommunikationsspr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaIln.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaIln.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaIln.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerIln.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerIln.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerIln.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerIln.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerIln.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerIln.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaFilialnr.setText(LPMain.getInstance().getTextRespectUISPr("lp.filialnr") + ": ");
		wlaFilialnr.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaFilialnr.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaFilialnr.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerFilialnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFilialnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFilialnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerFilialnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFilialnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFilialnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaGerichtsstand.setText(LPMain.getInstance().getTextRespectUISPr("lp.gerichtsstand") + ": ");
		wlaGerichtsstand.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaGerichtsstand.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaGerichtsstand.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuGerichtsstandDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuGerichtsstandDatenrichtung);
		...
		wtfZielPartnerGerichtsstand.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerGerichtsstand.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerGerichtsstand.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerGerichtsstand.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerGerichtsstand.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerGerichtsstand.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaFirmenbuchnr.setText(LPMain.getInstance().getTextRespectUISPr("lp.firmenbuchnr") + ": ");
		wlaFirmenbuchnr.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaFirmenbuchnr.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaFirmenbuchnr.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuFirmenbuchnrDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		...
		wtfZielPartnerFirmenbuchnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFirmenbuchnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFirmenbuchnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerFirmenbuchnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFirmenbuchnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFirmenbuchnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPartnerklasse.setText(LPMain.getInstance().getTextRespectUISPr("part.partnerklasse.label") + ": ");
		wlaPartnerklasse.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPartnerklasse.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPartnerklasse.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuPartnerklasseDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuPartnerklasseDatenrichtung);
		...
		wtfZielPartnerPartnerklasse.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPartnerklasse.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerPartnerklasse.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerPartnerklasse.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPartnerklasse.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerPartnerklasse.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaBranche.setText(LPMain.getInstance().getTextRespectUISPr("lp.branche") + ": ");
		wlaBranche.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaBranche.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaBranche.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerBranche.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerBranche.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerBranche.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerBranche.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerBranche.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerBranche.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaTelefon.setText(LPMain.getInstance().getTextRespectUISPr("lp.telefon") + ": ");
		wlaTelefon.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaTelefon.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaTelefon.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerTelefon.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerTelefon.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerTelefon.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerTelefon.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerTelefon.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerTelefon.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaHandy.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaHandy.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaHandy.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerHandy.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerHandy.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerHandy.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerHandy.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerHandy.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerHandy.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaEmail.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaEmail.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaEmail.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerEmail.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerEmail.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerEmail.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerEmail.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerEmail.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerEmail.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaFax.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaFax.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaFax.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerFax.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFax.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerFax.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerFax.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFax.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerFax.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaHomepage.setText(LPMain.getInstance().getTextRespectUISPr("lp.homepage") + ": ");
		wlaHomepage.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaHomepage.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaHomepage.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielPartnerHomepage.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerHomepage.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerHomepage.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerHomepage.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerHomepage.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerHomepage.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaDirektfax.setText(LPMain.getInstance().getTextRespectUISPr("lp.direktfax") + ": ");
		wlaDirektfax.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaDirektfax.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaDirektfax.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuDirektfaxDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		...
		wtfZielPartnerDirektfax.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerDirektfax.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerDirektfax.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerDirektfax.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerDirektfax.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerDirektfax.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPartnerbemerkung.setText(LPMain.getInstance().getTextRespectUISPr("lp.bemerkung") + ": ");
		wlaPartnerbemerkung.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPartnerbemerkung.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPartnerbemerkung.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuPartnerbemerkungDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		wbuPartnerbemerkungDatenrichtung.setButtonKombinierbar(true);
		vWrapperButtonsZusammenfuehren.addElement(wbuPartnerbemerkungDatenrichtung);
		vAnsprechpartnerkomponenten.addElement(wbuPartnerbemerkungDatenrichtung);
		...
		jScrollPaneZielPartnerBemerkung.setViewportView(wtaZielPartnerPartnerbemerkung);
		...
		jScrollPaneQuellPartnerBemerkung.setViewportView(wtaQuellPartnerPartnerbemerkung);
		...
		vAnsprechpartnerkomponenten.addElement(jScrollPaneQuellPartnerBemerkung);
		...
		wlaBLZ.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaBLZ.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaBLZ.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielBLZ.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielBLZ.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielBLZ.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellBLZ.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellBLZ.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellBLZ.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaBIC.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaBIC.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaBIC.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielBIC.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielBIC.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielBIC.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellBIC.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellBIC.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellBIC.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaAnsprGeburtsdatum
				.setText(LPMain.getInstance().getTextRespectUISPr("pers.personalangehoerige.geburtsdatum") + ": ");
		wlaAnsprGeburtsdatum.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaAnsprGeburtsdatum.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaAnsprGeburtsdatum.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuAnsprGeburtsdatumDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuAnsprGeburtsdatumDatenrichtung);
		vPartnerkomponenten.addElement(wbuAnsprGeburtsdatumDatenrichtung);
		vAnsprechpartnerkomponenten.addElement(wbuAnsprGeburtsdatumDatenrichtung);

		wtfZielPartnerAnsprGeburtsdatum = new WrapperTextFieldZusammenfuehren();
		wtfZielPartnerAnsprGeburtsdatum.setText("");
		wtfZielPartnerAnsprGeburtsdatum.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnsprGeburtsdatum.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnsprGeburtsdatum.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellPartnerAnsprGeburtsdatum.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerAnsprGeburtsdatum
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellPartnerAnsprGeburtsdatum.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		vAnsprechpartnerkomponenten.addElement(wtfQuellPartnerAnsprGeburtsdatum);

		// Ansprechpartnerfunktion
		wlaAnsprechpartnerfunktion = new WrapperLabel();
		wlaAnsprechpartnerfunktion.setText(LPMain.getInstance().getTextRespectUISPr("part.ansprechpartnerfkt") + ": ");
		wlaAnsprechpartnerfunktion.setMaximumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaAnsprechpartnerfunktion.setPreferredSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaAnsprechpartnerfunktion.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wbuAnsprechpartnerfunktionDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuAnsprechpartnerfunktionDatenrichtung);
		vAnsprechpartnerkomponenten.addElement(wbuAnsprechpartnerfunktionDatenrichtung);

		wtfZielPartnerAnsprechpartnerfunktion = new WrapperTextFieldZusammenfuehren();
		wtfZielPartnerAnsprechpartnerfunktion.setText("");
		wtfZielPartnerAnsprechpartnerfunktion
				.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnsprechpartnerfunktion
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnsprechpartnerfunktion
				.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielPartnerAnsprechpartnerfunktion.setActivatable(false);
		vZielfelder.addElement(wtfZielPartnerAnsprechpartnerfunktion);
		vAnsprechpartnerkomponenten.addElement(wtfZielPartnerAnsprechpartnerfunktion);
		...
		vAnsprechpartnerkomponenten.addElement(wtfQuellPartnerAnsprechpartnerfunktion);
		...
		jpaAutomatischZusammenfuehren.setLayout(gridBagLayoutAutomatischZusammenfuehren);
		vPartnerkomponenten.addElement(jpaAutomatischZusammenfuehren);

		wlaAutomatischZusammenfuehren = new WrapperLabel();
		wlaAutomatischZusammenfuehren
				.setText(LPMain.getInstance().getTextRespectUISPr("part.zusammenfuehren.automatisch") + ": ");
		wlaAutomatischZusammenfuehren.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wlaAutomatischZusammenfuehren.setPreferredSize(new Dimension(160, Defaults.getInstance().getControlHeight()));
		wlaAutomatischZusammenfuehren.setMinimumSize(new Dimension(160, Defaults.getInstance().getControlHeight()));
		vPartnerkomponenten.addElement(wlaAutomatischZusammenfuehren);

		wcbKundeZusammenfuehren = new WrapperCheckBox();
		wcbKundeZusammenfuehren.setText(LPMain.getInstance().getTextRespectUISPr("lp.kunde"));
		wcbKundeZusammenfuehren.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		try {
			bDarfKundeZusammenfuehren = DelegateFactory.getInstance().getTheJudgeDelegate()
		...
		wcbLieferantZusammenfuehren.setText(LPMain.getInstance().getTextRespectUISPr("label.lieferant"));
		wcbLieferantZusammenfuehren.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		vPartnerkomponenten.addElement(wcbLieferantZusammenfuehren);
		HelperClient.setToolTipTextMitRechtToComponent(wcbLieferantZusammenfuehren,
				RechteFac.RECHT_PART_LIEFERANT_ZUSAMMENFUEHREN_ERLAUBT);
		boolean bDarfLieferantZusammenfuehren = false;
		try {
			bDarfLieferantZusammenfuehren = DelegateFactory.getInstance().getTheJudgeDelegate()
		...
		jpaWorkingOnScroll.add(wlaAutomatischZusammenfuehren, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaAutomatischZusammenfuehren.add(wcbKundeZusammenfuehren, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaAutomatischZusammenfuehren.add(wcbLieferantZusammenfuehren, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		/*
		...
		jpaWorkingOnScroll.add(jpaAutomatischZusammenfuehren, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wbuZielPartnerAuswaehlen, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAuswahlReset, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuQuellPartnerAuswaehlen, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wbuZielPartnerAnsprechpartnerAuswaehlen, new GridBagConstraints(1, iZeile, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuQuellPartnerAnsprechpartnerAuswaehlen, new GridBagConstraints(3, iZeile, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaAnrede, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerAnrede, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAnredeDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerAnrede, new GridBagConstraints(3, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaTitel, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerTitel, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuTitelDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerTitel, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaName1, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerName1, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuName1Datenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerName1, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaName2, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerName2, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuName2Datenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerName2, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaName3, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerName3, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuName3Datenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerName3, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaStrasse, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerStrasse, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuStrasseDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerStrasse, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaOrt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerOrt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		/*
		 * jpaWorkingOnScroll.add(wbuOrtDatenrichtung, new GridBagConstraints(2, iZeile,
		 * 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new
		 * Insets(0, 0, 0, 0), 0, 0));
		 */

		jpaWorkingOnScroll.add(wtfQuellPartnerOrt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPostfachort, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerPostfachort, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPostfachortDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerPostfachort, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		jpaWorkingOnScroll.add(wlaPostfachnr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerPostfachnr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPostfachnrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerPostfachnr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKurzbez, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerKurzbez, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKurzbezDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerKurzbez, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPartnerart, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerPartnerart, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPartnerartDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerPartnerart, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaUid, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerUid, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		/*
		 * jpaWorkingOnScroll.add(wbuUidDatenrichtung, new GridBagConstraints(2, iZeile,
		 * 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new
		 * Insets(0, 0, 0, 0), 0, 0));
		 */

		jpaWorkingOnScroll.add(wtfQuellPartnerUid, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKommunikationsspr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerKommunikationsspr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKommunikationssprDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerKommunikationsspr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaIln, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerIln, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuIlnDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerIln, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaFilialnr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerFilialnr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuFilialnrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerFilialnr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaGerichtsstand, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerGerichtsstand, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuGerichtsstandDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerGerichtsstand, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaFirmenbuchnr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerFirmenbuchnr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuFirmenbuchnrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerFirmenbuchnr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaBLZ, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielBLZ, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuBLZ, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellBLZ, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaBIC, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielBIC, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuBIC, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellBIC, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPartnerklasse, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerPartnerklasse, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPartnerklasseDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerPartnerklasse, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaBranche, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerBranche, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuBrancheDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerBranche, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaTelefon, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerTelefon, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuTelefonDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerTelefon, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaHandy, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerHandy, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuHandyDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerHandy, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaFax, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerFax, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuFaxDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerFax, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaDirektfax, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerDirektfax, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuDirektfaxDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerDirektfax, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaEmail, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerEmail, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuEmailDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerEmail, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaHomepage, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerHomepage, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuHomepageDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerHomepage, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPartnerbemerkung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(jScrollPaneZielPartnerBemerkung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPartnerbemerkungDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(jScrollPaneQuellPartnerBemerkung, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaAnsprGeburtsdatum, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerAnsprGeburtsdatum, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAnsprGeburtsdatumDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerAnsprGeburtsdatum, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaAnsprechpartnerfunktion, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielPartnerAnsprechpartnerfunktion, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAnsprechpartnerfunktionDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0,
				0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellPartnerAnsprechpartnerfunktion, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jScrollPanePartner.setViewportView(jpaWorkingOnScroll);
		jScrollPanePartner.setAutoscrolls(true);

		jpaWorkingOn.add(jScrollPanePartner, new GridBagConstraints(0, iZeile, 1, 1, 1.0, 1.0,
	 ...
	 * @param boole  Boolean
	 */
	private void setzeFelderVonVektorSichtbar(Vector<JComponent> vector, Boolean boole) {
		int i = 0;
		for (Enumeration<JComponent> e2 = vector.elements(); e2.hasMoreElements(); e2.nextElement()) {
			if (vector.get(i) instanceof WrapperTextFieldZusammenfuehren) {
				((WrapperTextFieldZusammenfuehren) vector.get(i)).setActivatable(boole);
				((WrapperTextFieldZusammenfuehren) vector.get(i)).setVisible(boole);
				...
				((WrapperButtonZusammenfuehren) vector.get(i)).setActivatable(boole);
				((WrapperButtonZusammenfuehren) vector.get(i)).setEnabled(boole);
				((WrapperButtonZusammenfuehren) vector.get(i)).setVisible(boole);
			} else if (vector.get(i) instanceof WrapperTextAreaZusammenfuehren) {
				((WrapperTextAreaZusammenfuehren) vector.get(i)).setActivatable(boole);
				((WrapperTextAreaZusammenfuehren) vector.get(i)).setEnabled(boole);
				((WrapperTextAreaZusammenfuehren) vector.get(i)).setVisible(boole);
	 ...
	 */
	/*
	 * private void setzeFelderAnsprechpartnerSichtbar(Boolean boole) { int i = 0;
	 * for (Enumeration e2 = this.vAnsprechpartnerkomponenten.elements();
	 ...
	 * (WrapperLabel) this.vAnsprechpartnerkomponenten.get(i)).setEnabled(boole); (
	 * (WrapperLabel) this.vAnsprechpartnerkomponenten.get(i)).setVisible(boole); }
	 * else if (this.vAnsprechpartnerkomponenten.get(i) instanceof
	 ...
	 * (WrapperTextAreaZusammenfuehren)
	 * this.vAnsprechpartnerkomponenten.get(i)).setVisible(boole); } else if
	 * (this.vAnsprechpartnerkomponenten.get(i) instanceof javax.swing.JScrollPane)
	 * { ( (JScrollPane) this.vAnsprechpartnerkomponenten.get(i)).setEnabled(boole);
	 ...
	 * (WrapperCheckBox)
	 * this.vAnsprechpartnerkomponenten.get(i)).setActivatable(boole); (
	 * (WrapperCheckBox) this.vAnsprechpartnerkomponenten.get(i)).setEnabled(boole);
	 * ( (WrapperCheckBox)
	 ...
	 * hinterlegt angezeigt, wenn nicht ausgewaehlt, dann werden sie grau hinterlegt
	 * angezeigt
	 * 
	 * @param vButtons     Vector etnhaelt alle Buttons, au&szlig;er dem zentralen,
	 *                     welche die Datenrichtung bestimmen
	 * @param vZielfelder  Vector enthaelt alle Felder und Checkboxen der linken
	 *                     Seite
	 * @param vQuellfelder Vector enthaelt alle Felder und Checkboxen der rechten
	 *                     Seite
	 * @param initial      boolean beim initialen starten wird die linke seite
	 *                     ausgewaehlt
	 */
	private void setzeFarbenVonTextfeldern(Vector<WrapperButtonZusammenfuehren> vButtons,
			Vector<JComponent> vZielfelder, Vector<JComponent> vQuellfelder, boolean initial) {
		int i = 0;
		for (Enumeration<JComponent> e2 = vQuellfelder.elements(); e2.hasMoreElements(); e2.nextElement()) {
			if (initial) {
				...
				} else if (vButtons.get(i)
						.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
					if (vZielfelder.get(i) instanceof WrapperTextFieldZusammenfuehren) {
						((WrapperTextFieldZusammenfuehren) vZielfelder.get(i)).setSelectedData(true);
						((WrapperTextFieldZusammenfuehren) vQuellfelder.get(i)).setSelectedData(true);
					} else if (vZielfelder.get(i) instanceof WrapperTextAreaZusammenfuehren) {
	...
	private void befuelleFelderMitPartnerZielDto(PartnerDto pzDto) throws Throwable {
		...
		if (pzDto.getCName1nachnamefirmazeile1() != null && pzDto.getCName1nachnamefirmazeile1() != "") {
			wtfZielPartnerName1.setText(pzDto.getCName1nachnamefirmazeile1());
			wtfZielPartnerName1.setCaretPosition(0);
			wtfZielPartnerName1.setToolTipText(pzDto.getCName1nachnamefirmazeile1());
		} else {
			wtfZielPartnerName1.setText("");
			wtfZielPartnerName1.setToolTipText("");
		}

		if (pzDto.getCName2vornamefirmazeile2() != null && pzDto.getCName2vornamefirmazeile2() != "") {
			wtfZielPartnerName2.setText(pzDto.getCName2vornamefirmazeile2());
			wtfZielPartnerName2.setCaretPosition(0);
			wtfZielPartnerName2.setToolTipText(pzDto.getCName2vornamefirmazeile2());
		} else {
			wtfZielPartnerName2.setText("");
			wtfZielPartnerName2.setToolTipText("");
		}

		if (pzDto.getCName3vorname2abteilung() != null && pzDto.getCName3vorname2abteilung() != "") {
			wtfZielPartnerName3.setText(pzDto.getCName3vorname2abteilung());
			wtfZielPartnerName3.setCaretPosition(0);
			wtfZielPartnerName3.setToolTipText(pzDto.getCName3vorname2abteilung());
		} else {
			wtfZielPartnerName3.setText("");
		...
		if (pzDto.getLandplzortDto() != null && pzDto.getLandplzortDto().formatLandPlzOrt() != null
				&& pzDto.getLandplzortDto().formatLandPlzOrt() != "") {
			wtfZielPartnerOrt.setText(pzDto.getLandplzortDto().formatLandPlzOrt());
			wtfZielPartnerOrt.setCaretPosition(0);
			wtfZielPartnerOrt.setToolTipText(pzDto.getLandplzortDto().formatLandPlzOrt());
		} else {
			wtfZielPartnerOrt.setText("");
			wtfZielPartnerOrt.setToolTipText("");
		}

		if (pzDto.getLandplzortDto_Postfach() != null && pzDto.getLandplzortDto_Postfach().formatLandPlzOrt() != null
				&& pzDto.getLandplzortDto_Postfach().formatLandPlzOrt() != "") {
			wtfZielPartnerPostfachort.setText(pzDto.getLandplzortDto_Postfach().formatLandPlzOrt());
			wtfZielPartnerPostfachort.setCaretPosition(0);
			wtfZielPartnerPostfachort.setToolTipText(pzDto.getLandplzortDto_Postfach().formatLandPlzOrt());
		} else {
			wtfZielPartnerPostfachort.setText("");
		...
		if (pzDto.getLocaleCNrKommunikation() != null && pzDto.getLocaleCNrKommunikation() != "") {
			wtfZielPartnerKommunikationsspr.setText(pzDto.getLocaleCNrKommunikation());
			wtfZielPartnerKommunikationsspr.setCaretPosition(0);
			wtfZielPartnerKommunikationsspr.setToolTipText(pzDto.getLocaleCNrKommunikation());
		} else {
			wtfZielPartnerKommunikationsspr.setText("");
		...
		if (pzDto.getCGerichtsstand() != null && pzDto.getCGerichtsstand() != "") {
			wtfZielPartnerGerichtsstand.setText(pzDto.getCGerichtsstand());
			wtfZielPartnerGerichtsstand.setCaretPosition(0);
			wtfZielPartnerGerichtsstand.setToolTipText(pzDto.getCGerichtsstand());
		} else {
			wtfZielPartnerGerichtsstand.setText("");
		...
		if (pzDto.getPartnerklasseIId() != null) {
			PartnerklasseDto partnerklasseDto = DelegateFactory.getInstance().getPartnerDelegate()
					.partnerklasseFindByPrimaryKey(pzDto.getPartnerklasseIId());
			wtfZielPartnerPartnerklasse.setText(partnerklasseDto.getBezeichnung());
			wtfZielPartnerPartnerklasse.setCaretPosition(0);
			wtfZielPartnerPartnerklasse.setToolTipText(partnerklasseDto.getBezeichnung());
		} else {
			wtfZielPartnerPartnerklasse.setText("");
		...
		if (pzDto.getBrancheIId() != null) {
			BrancheDto brancheDto = DelegateFactory.getInstance().getPartnerDelegate()
					.brancheFindByPrimaryKey(pzDto.getBrancheIId());
		...
		if (pzDto.getXBemerkung() != null) {
			...
			wtaZielPartnerPartnerbemerkung.setCaretPosition(0);
			wtaZielPartnerPartnerbemerkung.setToolTipText(pzDto.getXBemerkung());
		} else {
		...
		if (pzDto.getDGeburtsdatumansprechpartner() != null) {
			wtfZielPartnerAnsprGeburtsdatum
					.setText(Helper.formatDatum(pzDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
			wtfZielPartnerAnsprGeburtsdatum.setCaretPosition(0);
			wtfZielPartnerAnsprGeburtsdatum
					.setToolTipText(Helper.formatDatum(pzDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
		} else {
			wtfZielPartnerAnsprGeburtsdatum.setText("");
	...
	private void setzeStatusVonButtonDatenrichtung() {
		if (this.partnerQuellDto != null && this.partnerZielDto != null) {
			if ((wtfQuellPartnerAnrede.getText() != null && wtfZielPartnerAnrede.getText() != null
					&& wtfQuellPartnerAnrede.getText().equals(wtfZielPartnerAnrede.getText()))
					|| (wtfQuellPartnerAnrede.getText() == null && wtfZielPartnerAnrede.getText() == null)) {
				wbuAnredeDatenrichtung.setEnabled(false);
			} else {
				wbuAnredeDatenrichtung.setEnabled(true);
			}

			if ((wtfQuellPartnerTitel.getText() != null && wtfZielPartnerTitel.getText() != null
					&& wtfQuellPartnerTitel.getText().equals(wtfZielPartnerTitel.getText()))
					|| (wtfQuellPartnerTitel.getText() == null && wtfZielPartnerTitel.getText() == null)) {
				wbuTitelDatenrichtung.setEnabled(false);
			} else {
				wbuTitelDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerName1.getText() != null && wtfQuellPartnerName1.getText() != null
					&& wtfQuellPartnerName1.getText().equals(wtfZielPartnerName1.getText()))
					|| (wtfZielPartnerName1.getText() == null && wtfQuellPartnerName1.getText() == null)) {
				wbuName1Datenrichtung.setEnabled(false);
			} else {
				wbuName1Datenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerName2.getText() != null && wtfQuellPartnerName2.getText() != null
					&& wtfQuellPartnerName2.getText().equals(wtfZielPartnerName2.getText()))
					|| (wtfZielPartnerName2.getText() == null && wtfQuellPartnerName2.getText() == null)) {
				wbuName2Datenrichtung.setEnabled(false);
			} else {
				wbuName2Datenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerName3.getText() != null && wtfQuellPartnerName3.getText() != null
					&& wtfQuellPartnerName3.getText().equals(wtfZielPartnerName3.getText()))
					|| (wtfZielPartnerName3.getText() == null && wtfQuellPartnerName3.getText() == null)) {
				wbuName3Datenrichtung.setEnabled(false);
			} else {
				wbuName3Datenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerStrasse.getText() != null && wtfQuellPartnerStrasse.getText() != null
					&& wtfQuellPartnerStrasse.getText().equals(wtfZielPartnerStrasse.getText()))
					|| (wtfZielPartnerStrasse.getText() == null && wtfQuellPartnerStrasse.getText() == null)) {
				wbuStrasseDatenrichtung.setEnabled(false);
			} else {
				wbuStrasseDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerOrt.getText() != null && wtfQuellPartnerOrt.getText() != null
					&& wtfQuellPartnerOrt.getText().equals(wtfZielPartnerOrt.getText()))
					|| (wtfZielPartnerOrt.getText() == null && wtfQuellPartnerOrt.getText() == null)) {
				wbuOrtDatenrichtung.setEnabled(false);
			} else {
				wbuOrtDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerPostfachort.getText() != null && wtfQuellPartnerPostfachort.getText() != null
					&& wtfQuellPartnerPostfachort.getText().equals(wtfZielPartnerPostfachort.getText()))
					|| (wtfZielPartnerPostfachort.getText() == null && wtfQuellPartnerPostfachort.getText() == null)) {
				wbuPostfachortDatenrichtung.setEnabled(false);
			} else {
				wbuPostfachortDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerPostfachnr.getText() != null && wtfQuellPartnerPostfachnr.getText() != null
					&& wtfQuellPartnerPostfachnr.getText().equals(wtfZielPartnerPostfachnr.getText()))
					|| (wtfZielPartnerPostfachnr.getText() == null && wtfQuellPartnerPostfachnr.getText() == null)) {
				wbuPostfachnrDatenrichtung.setEnabled(false);
			} else {
				wbuPostfachnrDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerKurzbez.getText() != null && wtfQuellPartnerKurzbez.getText() != null
					&& wtfQuellPartnerKurzbez.getText().equals(wtfZielPartnerKurzbez.getText()))
					|| (wtfZielPartnerKurzbez.getText() == null && wtfQuellPartnerKurzbez.getText() == null)) {
			...
			if ((wtfZielPartnerAnsprechpartnerfunktion.getText() != null
					&& wtfQuellPartnerAnsprechpartnerfunktion.getText() != null
					&& wtfQuellPartnerAnsprechpartnerfunktion.getText()
							.equals(wtfZielPartnerAnsprechpartnerfunktion.getText()))
					|| (wtfZielPartnerAnsprechpartnerfunktion.getText() == null
							&& wtfQuellPartnerAnsprechpartnerfunktion.getText() == null)) {
			...
			if ((wtfZielPartnerPartnerart.getText() != null && wtfQuellPartnerPartnerart.getText() != null
					&& wtfQuellPartnerPartnerart.getText().equals(wtfZielPartnerPartnerart.getText()))
					|| (wtfZielPartnerPartnerart.getText() == null && wtfQuellPartnerPartnerart.getText() == null)) {
				wbuPartnerartDatenrichtung.setEnabled(false);
			} else {
				wbuPartnerartDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerUid.getText() != null && wtfQuellPartnerUid.getText() != null
					&& wtfQuellPartnerUid.getText().equals(wtfZielPartnerUid.getText()))
					|| (wtfZielPartnerUid.getText() == null && wtfQuellPartnerUid.getText() == null)) {
				wbuUidDatenrichtung.setEnabled(false);
			} else {
				wbuUidDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerKommunikationsspr.getText() != null && wtfQuellPartnerKommunikationsspr.getText() != null
					&& wtfQuellPartnerKommunikationsspr.getText().equals(wtfZielPartnerKommunikationsspr.getText()))
					|| (wtfZielPartnerKommunikationsspr.getText() == null
							&& wtfQuellPartnerKommunikationsspr.getText() == null)) {
				wbuKommunikationssprDatenrichtung.setEnabled(false);
			} else {
				wbuKommunikationssprDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerIln.getText() != null && wtfQuellPartnerIln.getText() != null
					&& wtfQuellPartnerIln.getText().equals(wtfZielPartnerIln.getText()))
					|| (wtfZielPartnerIln.getText() == null && wtfQuellPartnerIln.getText() == null)) {
				wbuIlnDatenrichtung.setEnabled(false);
			} else {
				wbuIlnDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerFilialnr.getText() != null && wtfQuellPartnerFilialnr.getText() != null
					&& wtfQuellPartnerFilialnr.getText().equals(wtfZielPartnerFilialnr.getText()))
					|| (wtfZielPartnerFilialnr.getText() == null && wtfQuellPartnerFilialnr.getText() == null)) {
				wbuFilialnrDatenrichtung.setEnabled(false);
			} else {
				wbuFilialnrDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerGerichtsstand.getText() != null && wtfQuellPartnerGerichtsstand.getText() != null
					&& wtfQuellPartnerGerichtsstand.getText().equals(wtfZielPartnerGerichtsstand.getText()))
					|| (wtfZielPartnerGerichtsstand.getText() == null
							&& wtfQuellPartnerGerichtsstand.getText() == null)) {
				wbuGerichtsstandDatenrichtung.setEnabled(false);
			} else {
				wbuGerichtsstandDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerFirmenbuchnr.getText() != null && wtfQuellPartnerFirmenbuchnr.getText() != null
					&& wtfQuellPartnerFirmenbuchnr.getText().equals(wtfZielPartnerFirmenbuchnr.getText()))
					|| (wtfZielPartnerFirmenbuchnr.getText() == null
							&& wtfQuellPartnerFirmenbuchnr.getText() == null)) {
				wbuFirmenbuchnrDatenrichtung.setEnabled(false);
			} else {
				wbuFirmenbuchnrDatenrichtung.setEnabled(true);
			}
			if ((wtfZielBIC.getText() != null && wtfQuellBIC.getText() != null
					&& wtfQuellBIC.getText().equals(wtfZielBIC.getText()))
					|| (wtfZielBIC.getText() == null && wtfQuellBIC.getText() == null)) {
				wbuBIC.setEnabled(false);
			} else {
				wbuBIC.setEnabled(true);
			}
			if ((wtfZielBLZ.getText() != null && wtfQuellBLZ.getText() != null
					&& wtfQuellBLZ.getText().equals(wtfZielBLZ.getText()))
			...
			if ((wtfZielPartnerPartnerklasse.getText() != null && wtfQuellPartnerPartnerklasse.getText() != null
					&& wtfQuellPartnerPartnerklasse.getText().equals(wtfZielPartnerPartnerklasse.getText()))
					|| (wtfZielPartnerPartnerklasse.getText() == null
							&& wtfQuellPartnerPartnerklasse.getText() == null)) {
				wbuPartnerklasseDatenrichtung.setEnabled(false);
			} else {
				wbuPartnerklasseDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerBranche.getText() != null && wtfQuellPartnerBranche.getText() != null
					&& wtfQuellPartnerBranche.getText().equals(wtfZielPartnerBranche.getText()))
					|| (wtfZielPartnerBranche.getText() == null && wtfQuellPartnerBranche.getText() == null)) {
				wbuBrancheDatenrichtung.setEnabled(false);
			} else {
				wbuBrancheDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerTelefon.getText() != null && wtfQuellPartnerTelefon.getText() != null
					&& wtfQuellPartnerTelefon.getText().equals(wtfZielPartnerTelefon.getText()))
					|| (wtfZielPartnerTelefon.getText() == null && wtfQuellPartnerTelefon.getText() == null)) {
				wbuTelefonDatenrichtung.setEnabled(false);
			} else {
				wbuTelefonDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerHandy.getText() != null && wtfQuellPartnerHandy.getText() != null
					&& wtfQuellPartnerHandy.getText().equals(wtfZielPartnerHandy.getText()))
					|| (wtfZielPartnerHandy.getText() == null && wtfQuellPartnerHandy.getText() == null)) {
				wbuHandyDatenrichtung.setEnabled(false);
			} else {
				wbuHandyDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerFax.getText() != null && wtfQuellPartnerFax.getText() != null
					&& wtfQuellPartnerFax.getText().equals(wtfZielPartnerFax.getText()))
					|| (wtfZielPartnerFax.getText() == null && wtfQuellPartnerFax.getText() == null)) {
				wbuFaxDatenrichtung.setEnabled(false);
			} else {
				wbuFaxDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerDirektfax.getText() != null && wtfQuellPartnerDirektfax.getText() != null
					&& wtfQuellPartnerDirektfax.getText().equals(wtfZielPartnerDirektfax.getText()))
					|| (wtfZielPartnerDirektfax.getText() == null && wtfQuellPartnerDirektfax.getText() == null)) {
				wbuDirektfaxDatenrichtung.setEnabled(false);
			} else {
				wbuDirektfaxDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerEmail.getText() != null && wtfQuellPartnerEmail.getText() != null
					&& wtfQuellPartnerEmail.getText().equals(wtfZielPartnerEmail.getText()))
					|| (wtfZielPartnerEmail.getText() == null && wtfQuellPartnerEmail.getText() == null)) {
				wbuEmailDatenrichtung.setEnabled(false);
			} else {
				wbuEmailDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerHomepage.getText() != null && wtfQuellPartnerHomepage.getText() != null
					&& wtfQuellPartnerHomepage.getText().equals(wtfZielPartnerHomepage.getText()))
					|| (wtfZielPartnerHomepage.getText() == null && wtfQuellPartnerHomepage.getText() == null)) {
				wbuHomepageDatenrichtung.setEnabled(false);
			} else {
				wbuHomepageDatenrichtung.setEnabled(true);
			}

			if ((wtaQuellPartnerPartnerbemerkung.getText() != null && wtaZielPartnerPartnerbemerkung.getText() != null
					&& wtaQuellPartnerPartnerbemerkung.getText().equals(wtaZielPartnerPartnerbemerkung.getText()))
					|| (wtaQuellPartnerPartnerbemerkung.getText() == null
							&& wtaZielPartnerPartnerbemerkung.getText() == null)) {
				wbuPartnerbemerkungDatenrichtung.setEnabled(false);
			} else {
				wbuPartnerbemerkungDatenrichtung.setEnabled(true);
			}

			if ((wtfZielPartnerAnsprGeburtsdatum.getText() != null && wtfQuellPartnerAnsprGeburtsdatum.getText() != null
					&& wtfQuellPartnerAnsprGeburtsdatum.getText().equals(wtfZielPartnerAnsprGeburtsdatum.getText()))
					|| (wtfZielPartnerAnsprGeburtsdatum.getText() == null
							&& wtfQuellPartnerAnsprGeburtsdatum.getText() == null)) {
	...
	private void setzeStatusButtonResetDatenrichtung() {
		if (this.sActionToDoBeimZusammenfuehren.equals(PartnerFac.PART_ZUSAMMENFUEHREN_MODUS_PARTNER)) {
			if (this.partnerQuellDto != null && this.partnerZielDto != null
					&& this.partnerQuellDto.getIId().intValue() != this.partnerZielDto.getIId().intValue()) {
				wbuAuswahlReset.setEnabled(true);
			} else {
				wbuAuswahlReset.setEnabled(false);
			}
		} else if (this.sActionToDoBeimZusammenfuehren.equals(PartnerFac.PART_ZUSAMMENFUEHREN_MODUS_ANSPRECHPARTNER)) {
			if (this.ansprechpartnerQuellDto != null && this.ansprechpartnerZielDto != null
					&& this.ansprechpartnerQuellDto.getIId().intValue() != this.ansprechpartnerZielDto.getIId()
							.intValue()) {
				wbuAuswahlReset.setEnabled(true);
			} else {
				wbuAuswahlReset.setEnabled(false);
	...
	private void setzeVisibilityVonAnsprechpartnerQuellBtn() throws Throwable {
		AnsprechpartnerDto[] aAnsprechpartnerDtos = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
				.ansprechpartnerFindByPartnerIIdOhneExc(this.partnerQuellDto.getIId());
	...
	private void setzeVisibilityVonAnsprechpartnerZielBtn() throws Throwable {
		AnsprechpartnerDto[] aAnsprechpartnerDtos = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
				.ansprechpartnerFindByPartnerIIdOhneExc(this.partnerZielDto.getIId());
		if (aAnsprechpartnerDtos != null && aAnsprechpartnerDtos.length > 0) {
	...
	private void befuelleFelderMitAnsprechpartnerQuellDto(AnsprechpartnerDto aqDto) throws Throwable {
		PartnerDto partnerDto = DelegateFactory.getInstance().getPartnerDelegate()
				.partnerFindByPrimaryKey(aqDto.getPartnerIIdAnsprechpartner());
		...
		if (partnerDto.getCName1nachnamefirmazeile1() != null && partnerDto.getCName1nachnamefirmazeile1() != "") {
			wtfQuellPartnerName1.setText(partnerDto.getCName1nachnamefirmazeile1());
			wtfQuellPartnerName1.setCaretPosition(0);
			wtfQuellPartnerName1.setToolTipText(partnerDto.getCName1nachnamefirmazeile1());
		} else {
			wtfQuellPartnerName1.setText("");
			wtfQuellPartnerName1.setToolTipText("");
		}

		if (partnerDto.getCName2vornamefirmazeile2() != null && partnerDto.getCName2vornamefirmazeile2() != "") {
			wtfQuellPartnerName2.setText(partnerDto.getCName2vornamefirmazeile2());
			wtfQuellPartnerName2.setCaretPosition(0);
			wtfQuellPartnerName2.setToolTipText(partnerDto.getCName2vornamefirmazeile2());
		} else {
			wtfQuellPartnerName2.setText("");
		...
		if (partnerDto.getDGeburtsdatumansprechpartner() != null) {
			wtfQuellPartnerAnsprGeburtsdatum
					.setText(Helper.formatDatum(partnerDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
			wtfQuellPartnerAnsprGeburtsdatum.setCaretPosition(0);
			wtfQuellPartnerAnsprGeburtsdatum.setToolTipText(
					Helper.formatDatum(partnerDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
		} else {
			wtfQuellPartnerAnsprGeburtsdatum.setText("");
			wtfQuellPartnerAnsprGeburtsdatum.setToolTipText("");
		}
		...
		if (aqDto.getXBemerkung() != null) {
			...
			wtaQuellPartnerPartnerbemerkung.setCaretPosition(0);
			wtaQuellPartnerPartnerbemerkung.setToolTipText(aqDto.getXBemerkung());
		} else {
		...
		if (aqDto.getAnsprechpartnerfunktionIId() != null) {
			AnsprechpartnerfunktionDto ansprechfktDto = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
					.ansprechpartnerfunktionFindByPrimaryKey(aqDto.getAnsprechpartnerfunktionIId());
			wtfQuellPartnerAnsprechpartnerfunktion.setText(ansprechfktDto.getBezeichnung());
			wtfQuellPartnerAnsprechpartnerfunktion.setCaretPosition(0);
			wtfQuellPartnerAnsprechpartnerfunktion.setToolTipText(ansprechfktDto.getBezeichnung());
		} else {
			wtfQuellPartnerAnsprechpartnerfunktion.setText("");
	...
	private void befuelleFelderMitAnsprechpartnerZielDto(AnsprechpartnerDto azDto) throws Throwable {
		PartnerDto partnerDto = DelegateFactory.getInstance().getPartnerDelegate()
				.partnerFindByPrimaryKey(azDto.getPartnerIIdAnsprechpartner());
		...
		if (partnerDto.getCName1nachnamefirmazeile1() != null && partnerDto.getCName1nachnamefirmazeile1() != "") {
			wtfZielPartnerName1.setText(partnerDto.getCName1nachnamefirmazeile1());
			wtfZielPartnerName1.setCaretPosition(0);
			wtfZielPartnerName1.setToolTipText(partnerDto.getCName1nachnamefirmazeile1());
		} else {
			wtfZielPartnerName1.setText("");
			wtfZielPartnerName1.setToolTipText("");
		}
		...
		if (partnerDto.getCName2vornamefirmazeile2() != null && partnerDto.getCName2vornamefirmazeile2() != "") {
			wtfZielPartnerName2.setText(partnerDto.getCName2vornamefirmazeile2());
			wtfZielPartnerName2.setCaretPosition(0);
			wtfZielPartnerName2.setToolTipText(partnerDto.getCName2vornamefirmazeile2());
		} else {
			wtfZielPartnerName2.setText("");
			wtfZielPartnerName2.setToolTipText("");
		}
		...
		if (azDto.getXBemerkung() != null) {
			...
			wtaZielPartnerPartnerbemerkung.setCaretPosition(0);
			wtaZielPartnerPartnerbemerkung.setToolTipText(azDto.getXBemerkung());
		} else {
			wtaZielPartnerPartnerbemerkung.setText("");
			wtaZielPartnerPartnerbemerkung.setToolTipText("");
		}
		...
		if (azDto.getAnsprechpartnerfunktionIId() != null) {
			AnsprechpartnerfunktionDto ansprechfktDto = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
					.ansprechpartnerfunktionFindByPrimaryKey(azDto.getAnsprechpartnerfunktionIId());
			wtfZielPartnerAnsprechpartnerfunktion.setText(ansprechfktDto.getBezeichnung());
			wtfZielPartnerAnsprechpartnerfunktion.setCaretPosition(0);
			wtfZielPartnerAnsprechpartnerfunktion.setToolTipText(ansprechfktDto.getBezeichnung());
		} else {
			wtfZielPartnerAnsprechpartnerfunktion.setText("");
	...
	private void befuelleFelderMitPartnerQuellDto(PartnerDto pqDto) throws Throwable {
		if (this.partnerQuellDto != null && this.partnerZielDto != null) {
			...
			if (pqDto.getCName1nachnamefirmazeile1() != null) {
				wtfQuellPartnerName1.setText(pqDto.getCName1nachnamefirmazeile1());
				wtfQuellPartnerName1.setCaretPosition(0);
				wtfQuellPartnerName1.setToolTipText(pqDto.getCName1nachnamefirmazeile1());
			} else {
				wtfQuellPartnerName1.setText("");
				wtfQuellPartnerName1.setToolTipText("");
			}
			...
			if (pqDto.getCName2vornamefirmazeile2() != null) {
				wtfQuellPartnerName2.setText(pqDto.getCName2vornamefirmazeile2());
				wtfQuellPartnerName2.setCaretPosition(0);
				wtfQuellPartnerName2.setToolTipText(pqDto.getCName2vornamefirmazeile2());
			} else {
				wtfQuellPartnerName2.setText("");
				wtfQuellPartnerName2.setToolTipText("");
			}
			...
			if (pqDto.getCName3vorname2abteilung() != null) {
				wtfQuellPartnerName3.setText(pqDto.getCName3vorname2abteilung());
				wtfQuellPartnerName3.setCaretPosition(0);
				wtfQuellPartnerName3.setToolTipText(pqDto.getCName3vorname2abteilung());
			} else {
				wtfQuellPartnerName3.setText("");
			...
			if (pqDto.getLandplzortDto() != null && pqDto.getLandplzortDto().formatLandPlzOrt() != null) {
				wtfQuellPartnerOrt.setText(pqDto.getLandplzortDto().formatLandPlzOrt());
				wtfQuellPartnerOrt.setCaretPosition(0);
				wtfQuellPartnerOrt.setToolTipText(pqDto.getLandplzortDto().formatLandPlzOrt());
			} else {
				wtfQuellPartnerOrt.setText("");
			...
			if (pqDto.getLandplzortDto_Postfach() != null
				...
				wtfQuellPartnerPostfachort.setText(pqDto.getLandplzortDto_Postfach().formatLandPlzOrt());
				wtfQuellPartnerPostfachort.setCaretPosition(0);
				wtfQuellPartnerPostfachort.setToolTipText(pqDto.getLandplzortDto_Postfach().formatLandPlzOrt());
			} else {
				wtfQuellPartnerPostfachort.setText("");
			...
			if (pqDto.getPartnerartCNr() != null) {
				...
				wtfQuellPartnerPartnerart.setToolTipText(pqDto.getPartnerartCNr());
			} else {
				wtfQuellPartnerPartnerart.setText("");
			...
			if (pqDto.getLocaleCNrKommunikation() != null) {
				wtfQuellPartnerKommunikationsspr.setText(pqDto.getLocaleCNrKommunikation());
				wtfQuellPartnerKommunikationsspr.setCaretPosition(0);
				wtfQuellPartnerKommunikationsspr.setToolTipText(pqDto.getLocaleCNrKommunikation());
			} else {
				wtfQuellPartnerKommunikationsspr.setText("");
			...
			if (pqDto.getCFilialnummer() != null) {
				...
				wtfQuellPartnerFilialnr.setToolTipText(pqDto.getCFilialnummer());
			} else {
				wtfQuellPartnerFilialnr.setText("");
			...
			if (pqDto.getCGerichtsstand() != null) {
				...
				wtfQuellPartnerGerichtsstand.setToolTipText(pqDto.getCGerichtsstand());
			} else {
				wtfQuellPartnerGerichtsstand.setText("");
			...
			if (pqDto.getCFirmenbuchnr() != null) {
				...
				wtfQuellPartnerFirmenbuchnr.setToolTipText(pqDto.getCFirmenbuchnr());
			} else {
				wtfQuellPartnerFirmenbuchnr.setText("");
			...
			if (pqDto.getPartnerklasseIId() != null) {
				wtfQuellPartnerPartnerklasse.setText(DelegateFactory.getInstance().getPartnerDelegate()
						.partnerklasseFindByPrimaryKey(pqDto.getPartnerklasseIId()).getBezeichnung());
				wtfQuellPartnerPartnerklasse.setCaretPosition(0);
				wtfQuellPartnerPartnerklasse.setToolTipText(DelegateFactory.getInstance().getPartnerDelegate()
						.partnerklasseFindByPrimaryKey(pqDto.getPartnerklasseIId()).getBezeichnung());
			...
			if (pqDto.getBrancheIId() != null) {
				wtfQuellPartnerBranche.setText(DelegateFactory.getInstance().getPartnerDelegate()
						.brancheFindByPrimaryKey(pqDto.getBrancheIId()).getBezeichnung());
				wtfQuellPartnerBranche.setCaretPosition(0);
				wtfQuellPartnerBranche.setToolTipText(DelegateFactory.getInstance().getPartnerDelegate()
						.brancheFindByPrimaryKey(pqDto.getBrancheIId()).getBezeichnung());
			...
			if (pqDto.getXBemerkung() != null) {
				...
				wtaQuellPartnerPartnerbemerkung.setCaretPosition(0);
				wtaQuellPartnerPartnerbemerkung.setToolTipText(pqDto.getXBemerkung());
			} else {
				wtaQuellPartnerPartnerbemerkung.setText("");
				wtaQuellPartnerPartnerbemerkung.setToolTipText("");
			}
			...
			if (pqDto.getDGeburtsdatumansprechpartner() != null) {
				wtfQuellPartnerAnsprGeburtsdatum
						.setText(Helper.formatDatum(pqDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
				wtfQuellPartnerAnsprGeburtsdatum.setCaretPosition(0);
				wtfQuellPartnerAnsprGeburtsdatum.setToolTipText(
						Helper.formatDatum(pqDto.getDGeburtsdatumansprechpartner(), Locale.getDefault()));
			} else {
				wtfQuellPartnerAnsprGeburtsdatum.setText("");
				wtfQuellPartnerAnsprGeburtsdatum.setToolTipText("");
			}
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(PanelBasis.ESC)
			...
			if (this.sActionToDoBeimZusammenfuehren.equals(PartnerFac.PART_ZUSAMMENFUEHREN_MODUS_PARTNER)) {
				...
				if (this.partnerQuellDto != null && this.partnerZielDto != null
					...
					try {
						...
						if (bKundeMitverdichten && DelegateFactory.getInstance().getKundeDelegate()
								.sindBeiQuellUndZielKundeSokosVorhanden(this.partnerQuellDto.getIId(),
										this.partnerZielDto.getIId())) {
							DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.info"), LPMain
									.getInstance().getTextRespectUISPr("part.kunde.zusammenfuehren.sokos.hinweis"));

						}

						DelegateFactory.getInstance().getPartnerDelegate().zusammenfuehrenPartner(this.partnerZielDto,
								this.partnerQuellDto.getIId(), bKundeMitverdichten, bLieferantMitverdichten,
								bBankMitverdichten);
						erfolgreich = true;
					} catch (ExceptionLP ex) {
						boolean b = handleMyOwnException(ex);
					}
				} else {
					// warnung, quelle und ziel sind identisch
					String sText = LPMain.getInstance()
							.getTextRespectUISPr("part.zusammenfuehren.warnung.quelle.ziel.identisch");
					DialogFactory.showModalDialog(
							LPMain.getInstance().getTextRespectUISPr("part.partnerzusammenfuehren"), sText);
				}
				...
				if (this.ansprechpartnerQuellDto != null && this.ansprechpartnerZielDto != null
					...
					try {
						DelegateFactory.getInstance().getAnsprechpartnerDelegate().zusammenfuehrenAnsprechpartner(
								this.ansprechpartnerZielDto, this.ansprechpartnerQuellDto.getIId(),
					...
					// warnung, quelle und ziel sind identisch
					String sText = LPMain.getInstance()
							.getTextRespectUISPr("part.zusammenfuehren.warnung.ansprechpartner.quelle.ziel.identisch");
					DialogFactory.showModalDialog(
							LPMain.getInstance().getTextRespectUISPr("part.ansprechpartnerzusammenfuehren"), sText);
				}
			...
			if (erfolgreich) {
				...
				((InternalFramePartner) getInternalFrame()).getTpPartner().getPanelPartnerQP1()
...

		{
			...
			panelPartner = PartnerFilterFactory.getInstance().createPanelFLRPartner(getInternalFrame(), selectedId,
					false);
			...
			if (panelPartner.getSelectedId() != null) {
				...
				PartnerDto partnerDtoTmp = DelegateFactory.getInstance().getPartnerDelegate()
						.partnerFindByPrimaryKey((Integer) oKey);
				partnerDtoTmp.setBankDto(DelegateFactory.getInstance().getPartnerbankDelegate()
						.bankFindByPrimaryKeyOhneExc((Integer) oKey));
		...
		if (e.getActionCommand().equals(ACTION_ZIELPARTNERANSPRECHPARTNER_AUSWAEHLEN)) {
			this.sActionToDoBeimZusammenfuehren = PartnerFac.PART_ZUSAMMENFUEHREN_MODUS_ANSPRECHPARTNER;
			panelAnsprechpartner = PartnerFilterFactory.getInstance().createPanelFLRAnsprechpartner(getInternalFrame(),
					this.partnerZielDto.getIId(), null, false, false);
			DialogQuery dialogQueryAnsprechpartner = new DialogQuery(panelAnsprechpartner);

			Object oKey = panelAnsprechpartner.getSelectedId();
			if (oKey != null) {
				AnsprechpartnerDto ansprechpartnerDtoTmp = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
						.ansprechpartnerFindByPrimaryKey((Integer) oKey);
				if (this.ansprechpartnerQuellDto != null && this.ansprechpartnerQuellDto.getIId() != null
						&& this.ansprechpartnerQuellDto.getIId().intValue() == ansprechpartnerDtoTmp.getIId()
								.intValue()) {
					String sMsg = LPMain.getInstance()
							.getTextRespectUISPr("part.zusammenfuehren.warnung.ansprechpartner.bereits.ausgewaehlt");
					DialogFactory.showModalDialog(
							LPMain.getInstance().getTextRespectUISPr("part.partnerzusammenfuehren"), sMsg);
				} else {
					this.ansprechpartnerZielDto = ansprechpartnerDtoTmp;
					setzeFelderVonVektorSichtbar(this.vPartnerkomponenten, false);
					setzeFelderVonVektorSichtbar(this.vAnsprechpartnerkomponenten, true);
		...
		if (e.getActionCommand().equals(ACTION_QUELLPARTNERANSPRECHPARTNER_AUSWAEHLEN)) {
			this.sActionToDoBeimZusammenfuehren = PartnerFac.PART_ZUSAMMENFUEHREN_MODUS_ANSPRECHPARTNER;
			panelAnsprechpartner = PartnerFilterFactory.getInstance().createPanelFLRAnsprechpartner(getInternalFrame(),
			...
			if (oKey != null) {
				AnsprechpartnerDto ansprechpartnerDtoTmp = DelegateFactory.getInstance().getAnsprechpartnerDelegate()
						.ansprechpartnerFindByPrimaryKey((Integer) oKey);
				if (this.ansprechpartnerZielDto != null && this.ansprechpartnerZielDto.getIId() != null
						&& this.ansprechpartnerZielDto.getIId().intValue() == ansprechpartnerDtoTmp.getIId()
								.intValue()) {
					String sMsg = LPMain.getInstance()
							.getTextRespectUISPr("part.zusammenfuehren.warnung.ansprechpartner.bereits.ausgewaehlt");
					DialogFactory.showModalDialog(
		...
		if (e.getActionCommand().equals(ACTION_ALLE_DATENRICHTUNGEN_WAEHLEN)) {
			...
			if (e.getSource() instanceof WrapperButtonZusammenfuehren) {
				((WrapperButtonZusammenfuehren) e.getSource()).setNextSelection();
				/*
				 * hier alle weiteren zusammenfuehrenButtons auf die oben gesetzte nextSelection
				 * setzen
				 */
				...
				for (Enumeration<WrapperButtonZusammenfuehren> el = vWrapperButtonsZusammenfuehren.elements(); el
						.hasMoreElements();) {
					((WrapperButtonZusammenfuehren) el.nextElement()).setISelection(iAktSel);
				}
				setzeFarbenVonTextfeldern(this.vWrapperButtonsZusammenfuehren, this.vZielfelder, this.vQuellfelder,
						false);
			}
		}
	...
	private void schreibeRichtungInZielAnsprechpartner() throws Throwable {
		...
		this.partnerVonAnsprechpartnerZielDto = DelegateFactory.getInstance().getPartnerDelegate()
				.partnerFindByPrimaryKey(this.ansprechpartnerZielDto.getPartnerIIdAnsprechpartner());
		...
		if (wbuAnredeDatenrichtung.isEnabled()) {
			if (wbuAnredeDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerVonAnsprechpartnerZielDto
						.setAnredeCNr(this.ansprechpartnerQuellDto.getPartnerDto().getAnredeCNr());
			}
		}
		...
		if (wbuTitelDatenrichtung.isEnabled()) {
			if (wbuTitelDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerVonAnsprechpartnerZielDto
						.setCTitel(this.ansprechpartnerQuellDto.getPartnerDto().getCTitel());
			}
		}
		...
		if (wbuName1Datenrichtung.isEnabled()) {
			if (wbuName1Datenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerVonAnsprechpartnerZielDto.setCName1nachnamefirmazeile1(
						this.ansprechpartnerQuellDto.getPartnerDto().getCName1nachnamefirmazeile1());
			}
		}
		...
		if (wbuName2Datenrichtung.isEnabled()) {
			if (wbuName2Datenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerVonAnsprechpartnerZielDto.setCName2vornamefirmazeile2(
						this.ansprechpartnerQuellDto.getPartnerDto().getCName2vornamefirmazeile2());
			}
		}

		// 'Ansprechpartner' und Partner
		if (wbuAnsprGeburtsdatumDatenrichtung.isEnabled()) {
			if (wbuAnsprGeburtsdatumDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerVonAnsprechpartnerZielDto.setDGeburtsdatumansprechpartner(
						this.ansprechpartnerQuellDto.getPartnerDto().getDGeburtsdatumansprechpartner());
			}
		}
		...
		if (wbuTelefonDatenrichtung.isEnabled()) {
			if (wbuTelefonDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setCTelefon(this.ansprechpartnerQuellDto.getCTelefon());
				this.ansprechpartnerZielDto.setBDurchwahl(this.ansprechpartnerQuellDto.getBDurchwahl());
		...
		if (wbuHandyDatenrichtung.isEnabled()) {
			if (wbuHandyDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setCHandy(this.ansprechpartnerQuellDto.getCHandy());
			}
		}
		...
		if (wbuFaxDatenrichtung.isEnabled()) {
			if (wbuFaxDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setCFax(this.ansprechpartnerQuellDto.getCFax());
		...
		if (wbuDirektfaxDatenrichtung.isEnabled()) {
			if (wbuDirektfaxDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setCDirektfax(this.ansprechpartnerQuellDto.getCDirektfax());
		...
		if (wbuEmailDatenrichtung.isEnabled()) {
			if (wbuEmailDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setCEmail(this.ansprechpartnerQuellDto.getCEmail());

			}
		}

		if (wbuPartnerbemerkungDatenrichtung.isEnabled()) {
			if (wbuPartnerbemerkungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto.setXBemerkung(this.ansprechpartnerQuellDto.getXBemerkung());
			} else if (wbuPartnerbemerkungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
		...
		if (wbuAnsprechpartnerfunktionDatenrichtung.isEnabled()) {
			if (wbuAnsprechpartnerfunktionDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.ansprechpartnerZielDto
						.setAnsprechpartnerfunktionIId(this.ansprechpartnerQuellDto.getAnsprechpartnerfunktionIId());
			}
		}
	...
	private void schreibeRichtungInZielPartner() throws Throwable {
		/*
		 * alle buttons vergleichen: wenn der btn nach li zeigt: nix wenn der button
		 * nach rechts zeigt & aktiv ist: schreibe von quelle diese daten in ziel wenn
		 * der button kombiniert zeigt & aktiv ist: fuege daten von quelle zu ziel hinzu
		 * (evtl. laenge pruefen)
		 */
		String sTmp = "";
		...
		if (wbuAnredeDatenrichtung.isEnabled()) {
			if (wbuAnredeDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setAnredeCNr(this.partnerQuellDto.getAnredeCNr());
			}
		}
		...
		if (wbuName1Datenrichtung.isEnabled()) {
			if (wbuName1Datenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCName1nachnamefirmazeile1(this.partnerQuellDto.getCName1nachnamefirmazeile1());
			}
		}
		...
		if (wbuName2Datenrichtung.isEnabled()) {
			if (wbuName2Datenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCName2vornamefirmazeile2(this.partnerQuellDto.getCName2vornamefirmazeile2());
			}
		}
		...
		if (wbuName3Datenrichtung.isEnabled()) {
			if (wbuName3Datenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCName3vorname2abteilung(this.partnerQuellDto.getCName3vorname2abteilung());
			}
		}
		...
		if (wbuStrasseDatenrichtung.isEnabled()) {
			if (wbuStrasseDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCStrasse(this.partnerQuellDto.getCStrasse());
			}
		}
		...
		if (wbuOrtDatenrichtung.isEnabled()) {
			if (wbuOrtDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setLandplzortIId(this.partnerQuellDto.getLandplzortIId());
			}
		}

		if (wbuPostfachortDatenrichtung.isEnabled()) {
			if (wbuPostfachortDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setLandplzortIIdPostfach(this.partnerQuellDto.getLandplzortIIdPostfach());
			}
		}
		...
		if (wbuPostfachnrDatenrichtung.isEnabled()) {
			if (wbuPostfachnrDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCPostfach(this.partnerQuellDto.getCPostfach());
			}
		}
		...
		if (wbuPartnerartDatenrichtung.isEnabled()) {
			if (wbuPartnerartDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setPartnerartCNr(this.partnerQuellDto.getPartnerartCNr());
			}
		}
		...
		if (wbuKommunikationssprDatenrichtung.isEnabled()) {
			if (wbuKommunikationssprDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setLocaleCNrKommunikation(this.partnerQuellDto.getLocaleCNrKommunikation());
			}
		}
		...
		if (wbuFilialnrDatenrichtung.isEnabled()) {
			if (wbuFilialnrDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCFilialnummer(this.partnerQuellDto.getCFilialnummer());
			}
		}

		if (wbuGerichtsstandDatenrichtung.isEnabled()) {
			if (wbuGerichtsstandDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCGerichtsstand(this.partnerQuellDto.getCGerichtsstand());
			}
		}

		if (wbuFirmenbuchnrDatenrichtung.isEnabled()) {
			if (wbuFirmenbuchnrDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCFirmenbuchnr(this.partnerQuellDto.getCFirmenbuchnr());
			}
		}
		if (wbuBIC.isEnabled()) {
			if (wbuBIC.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				if (this.partnerZielDto.getBankDto() != null && this.partnerQuellDto.getBankDto() != null) {
					this.partnerZielDto.getBankDto().setCBic(this.partnerQuellDto.getBankDto().getCBic());
				}
			}
		}
		if (wbuBLZ.isEnabled()) {
			if (wbuBLZ.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				if (this.partnerZielDto.getBankDto() != null && this.partnerQuellDto.getBankDto() != null) {
					this.partnerZielDto.getBankDto().setCBlz(this.partnerQuellDto.getBankDto().getCBlz());
				}
			}
		}
		if (wbuPartnerklasseDatenrichtung.isEnabled()) {
			if (wbuPartnerklasseDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setPartnerklasseIId(this.partnerQuellDto.getPartnerklasseIId());
			}
		}
		...
		if (wbuBrancheDatenrichtung.isEnabled()) {
			if (wbuBrancheDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setBrancheIId(this.partnerQuellDto.getBrancheIId());
			}
		}
		...
		if (wbuTelefonDatenrichtung.isEnabled()) {
			if (wbuTelefonDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCTelefon(this.partnerQuellDto.getCTelefon());
		...
		if (wbuHomepageDatenrichtung.isEnabled()) {
			if (wbuHomepageDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setCHomepage(this.partnerQuellDto.getCHomepage());
			}
		}
		...
		if (wbuPartnerbemerkungDatenrichtung.isEnabled()) {
			if (wbuPartnerbemerkungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto.setXBemerkung(this.partnerQuellDto.getXBemerkung());
			} else if (wbuPartnerbemerkungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
				String sTmpText = this.partnerZielDto.getXBemerkung() + " " + this.partnerQuellDto.getXBemerkung();
				if (sTmpText.length() > MAX_PARTNERBEMERKUNG) {
					sTmpText = sTmpText.substring(0, MAX_PARTNERBEMERKUNG);
				}
		...
		if (wbuAnsprGeburtsdatumDatenrichtung.isEnabled()) {
			if (wbuAnsprGeburtsdatumDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.partnerZielDto
						.setDGeburtsdatumansprechpartner(this.partnerQuellDto.getDGeburtsdatumansprechpartner());
			}
		}

	}

	private String handleExceptionBereitsVorhandenLieferant(List<?> alInfoForTheClient) {
		String sMsg = "";
		String s0Lieferant = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s1Lieferantenname = "";
		String s2Mandant = LPMain.getInstance().getTextRespectUISPr("lp.mandant");
		String s3Mandantcnr = "";
		String s4Lieferant = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s5Lieferantenname = "";
		String s6Mandant = LPMain.getInstance().getTextRespectUISPr("lp.mandant");
		...
		for (int i = 1; i < alInfoForTheClient.size(); i++) {
			if (i == alInfoForTheClient.size() - 1) {
				...
				try {
					lieferantDto = DelegateFactory.getInstance().getLieferantDelegate().lieferantFindByPrimaryKey(
							Integer.valueOf(alInfoForTheClient.get(i).toString()).intValue());
				} catch (Throwable ex) {
					// nothing
				}
				if (lieferantDto != null) {
					if (lieferantDto.getPartnerDto() != null) {
						s5Lieferantenname = lieferantDto.getPartnerDto().formatName();
					}
				...
				if (lieferantDto != null) {
					if (lieferantDto.getPartnerDto() != null) {
						s1Lieferantenname = lieferantDto.getPartnerDto().formatName();
					}
		...
		MessageFormat mf = new MessageFormat(
				LPMain.getTextRespectUISPr("part.zusammenfuehren.warnung.bereits.vorhanden"));
		try {
			mf.setLocale(LPMain.getTheClient().getLocUi());
		} catch (Throwable ex1) {
		}
		Object pattern[] = { s0Lieferant, s1Lieferantenname, s2Mandant, s3Mandantcnr, s4Lieferant, s5Lieferantenname,
				s6Mandant, s7Mandantencrn };
		sMsg = mf.format(pattern);
		return sMsg;

	}

	private String handleExceptionBereitsVorhandenKunde(List<?> alInfoForTheClient) {
		String sMsg = "";
		String s0Kunde = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s1Kundenname = "";
		String s2Mandant = LPMain.getInstance().getTextRespectUISPr("lp.mandant");
		String s3Mandantcnr = "";
		String s4Kunde = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s5Kundenname = "";
		String s6Mandant = LPMain.getInstance().getTextRespectUISPr("lp.mandant");
		String s7Mandantencrn = "";
		for (int i = 1; i < alInfoForTheClient.size(); i++) {
			if (i == alInfoForTheClient.size() - 1) {
				...
				try {
					kundeDto = DelegateFactory.getInstance().getKundeDelegate()
							.kundeFindByPrimaryKey(Integer.valueOf(alInfoForTheClient.get(i).toString()).intValue());
				} catch (Throwable ex) {
					// nothing
				}
				if (kundeDto != null) {
		...
		Object pattern[] = { s0Kunde, s1Kundenname, s2Mandant, s3Mandantcnr, s4Kunde, s5Kundenname, s6Mandant,
				s7Mandantencrn };
		sMsg = mf.format(pattern);
	...
	private String handleExceptionBereitsVorhandenPersonal(List<?> alInfoForTheClient) {
		String sMsg = "";
		String s0Personal = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s1Personalname = "";
		String s2Mandant = LPMain.getInstance().getTextRespectUISPr("lp.mandant");
		String s3Mandantcnr = "";
		String s4Personal = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
			...
			if (i == alInfoForTheClient.size() - 1) {
				...
				try {
					personalDto = DelegateFactory.getInstance().getPersonalDelegate()
							.personalFindByPrimaryKey(Integer.valueOf(alInfoForTheClient.get(i).toString()).intValue());
				} catch (Throwable ex) {
					// nothing
				}
				if (personalDto != null) {
					if (personalDto.getPartnerDto() != null) {
						s5Personalname = personalDto.getPartnerDto().formatName();
					}
				...
				if (personalDto != null) {
					if (personalDto.getPartnerDto() != null) {
						s1Personalname = personalDto.getPartnerDto().formatName();
					}
		...
		Object pattern[] = { s0Personal, s1Personalname, s2Mandant, s3Mandantcnr, s4Personal, s5Personalname, s6Mandant,
				s7Mandantencrn };
		sMsg = mf.format(pattern);
		return sMsg;
	}

	private String handleExceptionBereitsVorhandenBank(List<?> alInfoForTheClient) {
		String sMsg = "";
		String s0Bank = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s1Blz = LPMain.getInstance().getTextRespectUISPr("lp.blz") + ": ";
		String s2Partner = LPMain.getInstance().getTextRespectUISPr("part.partner");
		String s3Partnername = this.partnerQuellDto.formatName();
		;
		String s4Bank = LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString());
		String s5Blz = LPMain.getInstance().getTextRespectUISPr("lp.blz") + ": ";
		String s6Partner = LPMain.getInstance().getTextRespectUISPr("part.partner");
		...
		for (int i = 1; i < alInfoForTheClient.size(); i++) {
			if (i == alInfoForTheClient.size() - 1) {
				...
				try {
					bankDto = DelegateFactory.getInstance().getPartnerbankDelegate()
							.bankFindByPrimaryKey(this.partnerZielDto.getIId());
				} catch (Throwable ex) {
					// nothing
				}
				if (bankDto != null) {
				...
				try {
					...
					bankDto = DelegateFactory.getInstance().getPartnerbankDelegate()
							.bankFindByPrimaryKey(this.partnerQuellDto.getIId());
				} catch (Throwable ex) {
					// nothing
				}
				if (bankDto != null) {
		...
		Object pattern[] = { s0Bank, s1Blz, s2Partner, s3Partnername, s4Bank, s5Blz, s6Partner, s7Partnername };
		sMsg = mf.format(pattern);
		return sMsg;
	}
	...
	private void handleExceptionBereitsVorhanden(ExceptionLP exfc) {
		List<?> alInfoForTheClient = exfc.getAlInfoForTheClient();

		String sMsg = "";

		if (alInfoForTheClient != null && alInfoForTheClient.size() > 0) {
			String sBetrifft = LPMain.getInstance().getTextRespectUISPr("lp.betrifft") + ": "
					+ LPMain.getInstance().getTextRespectUISPr(alInfoForTheClient.get(0).toString()) + "\n";
			sMsg = sMsg + sBetrifft;
			if (alInfoForTheClient.get(0).toString().equals("lp.lieferant")) {
				sMsg = sMsg + handleExceptionBereitsVorhandenLieferant(alInfoForTheClient);
			} else if (alInfoForTheClient.get(0).toString().equals("lp.kunde")) {
				sMsg = sMsg + handleExceptionBereitsVorhandenKunde(alInfoForTheClient);
			} else if (alInfoForTheClient.get(0).toString().equals("button.personal.tooltip")) {
				sMsg = sMsg + handleExceptionBereitsVorhandenPersonal(alInfoForTheClient);
			} else if (alInfoForTheClient.get(0).toString().equals("lp.bank")) {
				sMsg = sMsg + handleExceptionBereitsVorhandenBank(alInfoForTheClient);
			} else {
				// unbekannt oder unbehandelt
				new DialogError(LPMain.getInstance().getDesktop(), exfc, DialogError.TYPE_ERROR);
			}
		} else {
		...
		DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("part.partnerzusammenfuehren"), sMsg);
