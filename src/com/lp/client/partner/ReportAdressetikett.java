...
public class ReportAdressetikett extends ReportEtikett implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportAdressetikett(InternalFrame frame,
			com.lp.server.partner.service.PartnerDto partnerDto, int iOption,
	...
	private void jbInit() throws Exception {
		...
		jpaWorkingOn.add(wlaPartner, new GridBagConstraints(0, iZeile, 1, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfPartner, new GridBagConstraints(1, iZeile, 3, 1,
				0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wbuAnsprechpartner, new GridBagConstraints(0, iZeile,
				...
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wftAnsprechpartner, new GridBagConstraints(1, iZeile,
				3, 1, 0.1, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
	}
	...
	private void dialogQueryAnsprechpartner(ActionEvent e) throws Throwable {
		panelQueryFLRAnsprechpartner = PartnerFilterFactory.getInstance()
				.createPanelFLRAnsprechpartner(getInternalFrame(), partnerIId,
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		return DelegateFactory.getInstance().getKundeDelegate()
				.printAdressetikett(partnerIId, ansprechpartnerIId, iOption);
	}
