...
public class ReportLiefermengen
...
protected JPanel jpaWorkingOn = new JPanel();
  ...
  public ReportLiefermengen(InternalFrameKunde internalFrame, String add2Title)
      throws Throwable {
    super(internalFrame, add2Title);
    kundeIId=internalFrame.getKundeDto().getIId();
    LPMain.getInstance().getTextRespectUISPr("kunde.report.liefermengen");
    jbInit();
    initComponents();
  ...
  public String getReportname() {
    return KundeReportFac.REPORT_LIEFERMENGEN;
  }
