...
/**
 * <p>
 * Diese Klasse kuemmert sich um das Zusammenf&uuml;hren von Kunden
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * Erstellung: Vorname Nachname; 01.04.08
 * </p>
 *
 * <p>
 * 
 ...
 */
public class PanelDialogKundenZusammenfuehren extends PanelDialog {
	/**
	 * 
	 */
	...
	// mind. alle Texte, die nvarchar > 40 haben, hier definieren bzw. Felder, deren
	// Inhalt kombiniert werden kann
	...
	// soll der Partner des rechten Kunden genommen werden, so steht diese
	// PartnerIId in iKundePartnerIId
	...
	/*
	 * MandantCNr - nicht noetig, da beim manuellen Zusammenfuehren nur Kunden auf
	 * dem selben Mandanten angezeigt werden
	 */
	...
	// RE-Email
	private WrapperLabel wlaREEmail = null;
	private WrapperButtonZusammenfuehren wbuREEmailDatenrichtung = null;
	private WrapperTextFieldZusammenfuehren wtfZielKundeREEmail = null;
	private WrapperTextFieldZusammenfuehren wtfQuellKundeREEmail = null;

	public PanelDialogKundenZusammenfuehren(KundeDto kundeZielDto, InternalFrame internalFrame, String add2TitleI)
			throws Throwable {

		super(internalFrame, add2TitleI + " | " + kundeZielDto.getPartnerDto().formatName());
	...
	/**
	 * setzt den Button fuer das rndgueltige zusammenfuehren aktiv oder inaktiv, je
	 * nach Vorhandensein des linken und rechten Kundens
	 * 
	 * @throws Throwable
	 */
	...
	private void jbInit() throws Throwable {
		...
		wbuZielKundeAuswaehlen.setText(LPMain.getInstance().getTextRespectUISPr("lp.kunde") + "...");
		wbuZielKundeAuswaehlen.setToolTipText(LPMain.getInstance().getTextRespectUISPr("button.kunde.tooltip"));
		wbuZielKundeAuswaehlen.addActionListener(this);
		wbuZielKundeAuswaehlen.setActionCommand(ACTION_ZIELKUNDE_AUSWAEHLEN);
		wbuZielKundeAuswaehlen.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuZielKundeAuswaehlen.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wbuZielKundeAuswaehlen.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		wbuZielKundeAuswaehlen.setFocusable(true);

		// Quellkunde-Auswahlbutton
		wbuQuellKundeAuswaehlen = new WrapperButtonZusammenfuehren();
		wbuQuellKundeAuswaehlen.setText(LPMain.getInstance().getTextRespectUISPr("lp.kunde") + "...");
		wbuQuellKundeAuswaehlen.setToolTipText(LPMain.getInstance().getTextRespectUISPr("button.kunde.tooltip"));
		wbuQuellKundeAuswaehlen.addActionListener(this);
		wbuQuellKundeAuswaehlen.setActionCommand(ACTION_QUELLKUNDE_AUSWAEHLEN);
		wbuQuellKundeAuswaehlen.setMaximumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wbuQuellKundeAuswaehlen.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wbuQuellKundeAuswaehlen.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		...
		wlaPartnername.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaPartnername.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaPartnername.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundePartnername.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundePartnername.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundePartnername.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundePartnername.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundePartnername.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundePartnername.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeMwst.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeMwst.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeMwst.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeMwst.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeMwst.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeMwst.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaWaehrung.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeWaehrung.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeWaehrung.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeWaehrung.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeWaehrung.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeWaehrung.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeWaehrung.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaLieferart.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaLieferart.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaLieferart.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeLieferart.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferart.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferart.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeLieferart.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferart.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferart.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaSpediteur.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaSpediteur.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaSpediteur.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeSpediteur.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeSpediteur.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeSpediteur.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeSpediteur.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeSpediteur.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeSpediteur.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaZahlungsziel.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaZahlungsziel.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaZahlungsziel.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeZahlungsziel.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeZahlungsziel.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeZahlungsziel.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeZahlungsziel.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeZahlungsziel.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeZahlungsziel.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKostenstelle.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaKostenstelle.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaKostenstelle.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeKostenstelle.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKostenstelle.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKostenstelle.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeKostenstelle.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKostenstelle.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKostenstelle.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaProvisionsempfaenger
				.setText(LPMain.getInstance().getTextRespectUISPr("part.kunde.provisionsempfaenger") + ": ");
		wlaProvisionsempfaenger.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaProvisionsempfaenger.setPreferredSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		wlaProvisionsempfaenger.setMinimumSize(new Dimension(110, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeProvisionsempfaenger.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeProvisionsempfaenger
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeProvisionsempfaenger.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeProvisionsempfaenger.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeProvisionsempfaenger
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeProvisionsempfaenger.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaRabattsatz.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaRabattsatz.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaRabattsatz.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeRabattsatz.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeRabattsatz.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeRabattsatz.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeRabattsatz.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRabattsatz.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRabattsatz.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaGarantie.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeGarantie.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeGarantie.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeGarantie.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeGarantie.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeGarantie.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeGarantie.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKommentar.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaKommentar.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaKommentar.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		// Kurznr - Konditionen links neben generieren Kurznr - nicht editierbar, nur
		// auswaehlbar
		...
		wtfZielKundeKurznr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKurznr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKurznr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeKurznr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKurznr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKurznr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKreditlimit.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaKreditlimit.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaKreditlimit.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeKreditlimit.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKreditlimit.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKreditlimit.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeKreditlimit.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKreditlimit.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKreditlimit.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaBonitaetspruefung
				.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.bonitaet.check.last.kurz") + ": ");
		wlaBonitaetspruefung.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaBonitaetspruefung.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaBonitaetspruefung.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeBonitaetspruefung.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeBonitaetspruefung.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeBonitaetspruefung.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeBonitaetspruefung.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeBonitaetspruefung.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeBonitaetspruefung.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaLiefersperre.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.liefersperre_am") + ": ");
		wlaLiefersperre.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
		wlaLiefersperre.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaLiefersperre.setMinimumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeLiefersperre.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLiefersperre.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLiefersperre.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeLiefersperre.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLiefersperre.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLiefersperre.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaRechnungskopien.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.kopien_re") + ": ");
		wlaRechnungskopien.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
		wlaRechnungskopien.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaRechnungskopien.setMinimumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeRechnungskopien.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeRechnungskopien.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeRechnungskopien.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeRechnungskopien.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRechnungskopien.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRechnungskopien.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaLieferscheinkopien.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.kopien_ls") + ": ");
		wlaLieferscheinkopien.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
		wlaLieferscheinkopien.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaLieferscheinkopien.setMinimumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeLieferscheinkopien.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferscheinkopien.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferscheinkopien.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeLieferscheinkopien.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferscheinkopien.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferscheinkopien.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaMitarbeiter.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
		wlaMitarbeiter.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaMitarbeiter.setMinimumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeMitarbeiter.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeMitarbeiter.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeMitarbeiter.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeMitarbeiter.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeMitarbeiter.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeMitarbeiter.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeTour.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeTour.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeTour.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeTour.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeTour.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeTour.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaLieferantennr.setMaximumSize(new Dimension(120, Defaults.getInstance().getControlHeight()));
		wlaLieferantennr.setPreferredSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaLieferantennr.setMinimumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeLieferantennr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferantennr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeLieferantennr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeLieferantennr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferantennr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeLieferantennr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeAbc.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeAbc.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeAbc.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeAbc.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeAbc.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeAbc.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaAgb.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.agb_uebermittelt_am") + ": ");
		...
		wtfZielKundeAgb.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeAgb.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeAgb.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeAgb.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeAgb.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeAgb.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaFremdsystemnr.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.fremdsystemnr") + ": ");
		wlaFremdsystemnr.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaFremdsystemnr.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaFremdsystemnr.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeFremdsystemnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeFremdsystemnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeFremdsystemnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeFremdsystemnr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeFremdsystemnr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeFremdsystemnr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaErloeskonto.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaErloeskonto.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaErloeskonto.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeErloeskonto.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeErloeskonto.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeErloeskonto.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeErloeskonto.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeErloeskonto.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeErloeskonto.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaDebitorenkonto.setText(LPMain.getInstance().getTextRespectUISPr("lp.debitorenkonto") + ": ");
		wlaDebitorenkonto.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaDebitorenkonto.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaDebitorenkonto.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeDebitorenkonto.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeDebitorenkonto.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeDebitorenkonto.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeDebitorenkonto.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeDebitorenkonto.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeDebitorenkonto.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaRechnungsadresspartner.setText(LPMain.getInstance().getTextRespectUISPr("lp.rechnungsadresse") + ": ");
		wlaRechnungsadresspartner.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaRechnungsadresspartner.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaRechnungsadresspartner.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeRechnungsadresspartner
		...
		wtfQuellKundeRechnungsadresspartner
				.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRechnungsadresspartner
				.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeRechnungsadresspartner
		...
		wlaHinweisInt.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaHinweisInt.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaHinweisInt.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeHinweisInt.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeHinweisInt.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeHinweisInt.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeHinweisInt.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeHinweisInt.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeHinweisInt.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaHinweisExt.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaHinweisExt.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaHinweisExt.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wlaZessionsfaktor.setText(LPMain.getInstance().getTextRespectUISPr("part.kund.zessionsfaktor") + ": ");
		wlaZessionsfaktor.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaZessionsfaktor.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaZessionsfaktor.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeZessionsfaktor.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeZessionsfaktor.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeZessionsfaktor.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeZessionsfaktor.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeZessionsfaktor.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeZessionsfaktor.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaPreisliste.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaPreisliste.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaPreisliste.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundePreisliste.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundePreisliste.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundePreisliste.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundePreisliste.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundePreisliste.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundePreisliste.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaKundennr.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wtfZielKundeKundennr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKundennr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeKundennr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wtfQuellKundeKundennr.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKundennr.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeKundennr.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		...
		wlaMindermengenzuschlag.setText(LPMain.getInstance().getTextRespectUISPr("label.mindermengenzuschlag") + ": ");
		wlaMindermengenzuschlag.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaMindermengenzuschlag.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaMindermengenzuschlag.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wcbQuellKundeMindermengenzuschlag
				.setPreferredSize(new Dimension(17, Defaults.getInstance().getControlHeight()));
		...
		wlaMonatsrechnung.setText(LPMain.getInstance().getTextRespectUISPr("part.monatsrechnung") + ": ");
		wlaMonatsrechnung.setMaximumSize(new Dimension(130, Defaults.getInstance().getControlHeight()));
		wlaMonatsrechnung.setPreferredSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		wlaMonatsrechnung.setMinimumSize(new Dimension(125, Defaults.getInstance().getControlHeight()));
		...
		wlaSammelrechnung.setText(LPMain.getInstance().getTextRespectUISPr("part.bekommt_sammelrechnung") + ": ");
		wlaSammelrechnung.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaSammelrechnung.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaSammelrechnung.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaRechnungsempfaenger.setText(LPMain.getInstance().getTextRespectUISPr("part.ist_rechnungempfaenger") + ": ");
		wlaRechnungsempfaenger.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaRechnungsempfaenger.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaRechnungsempfaenger.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaPreiseAmLs.setText(LPMain.getInstance().getTextRespectUISPr("part.preise_an_ls_andrucken") + ": ");
		wlaPreiseAmLs.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaPreiseAmLs.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaPreiseAmLs.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaBelegdruckMitRabatt
				.setText(LPMain.getInstance().getTextRespectUISPr("part.rechnungsdruck_mit_rabatt") + ": ");
		wlaBelegdruckMitRabatt.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaBelegdruckMitRabatt.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaBelegdruckMitRabatt.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaDistributor.setText(LPMain.getInstance().getTextRespectUISPr("part.ist_distributor") + ": ");
		wlaDistributor.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaDistributor.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaDistributor.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaTeillieferungen.setText(LPMain.getInstance().getTextRespectUISPr("part.akzeptiert_teillieferung") + ": ");
		wlaTeillieferungen.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaTeillieferungen.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaTeillieferungen.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaLsgewicht.setText(LPMain.getInstance().getTextRespectUISPr("part.ls_gewicht_angeben") + ": ");
		wlaLsgewicht.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaLsgewicht.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaLsgewicht.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaInteressent.setText(LPMain.getInstance().getTextRespectUISPr("lp.interessent") + ": ");
		wlaInteressent.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaInteressent.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaInteressent.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaVersteckt.setText(LPMain.getInstance().getTextRespectUISPr("lp.versteckt") + ": ");
		wlaVersteckt.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaVersteckt.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaVersteckt.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		wlaReversecharge.setText(LPMain.getInstance().getTextRespectUISPr("lp.reversecharge") + ": ");
		wlaReversecharge.setMaximumSize(new Dimension(140, Defaults.getInstance().getControlHeight()));
		wlaReversecharge.setPreferredSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		wlaReversecharge.setMinimumSize(new Dimension(135, Defaults.getInstance().getControlHeight()));
		...
		// Email
		wlaREEmail = new WrapperLabel();
		wlaREEmail.setText(LPMain.getInstance().getTextRespectUISPr("kunde.emailrechnungsempfang.kurz") + ": ");
		wlaREEmail.setMaximumSize(new Dimension(115, Defaults.getInstance().getControlHeight()));
		wlaREEmail.setPreferredSize(new Dimension(100, Defaults.getInstance().getControlHeight()));
		wlaREEmail.setMinimumSize(new Dimension(100, Defaults.getInstance().getControlHeight()));

		wbuREEmailDatenrichtung = new WrapperButtonZusammenfuehren();
		wbuREEmailDatenrichtung.addActionListener(this);
		wbuREEmailDatenrichtung.setActionCommand(ACTION_DATENRICHTUNG_WAEHLEN);
		vWrapperButtonsZusammenfuehren.addElement(wbuREEmailDatenrichtung);

		wtfZielKundeREEmail = new WrapperTextFieldZusammenfuehren();
		wtfZielKundeREEmail.setText("");
		wtfZielKundeREEmail.setColumnsMax(Facade.MAX_UNBESCHRAENKT);
		wtfZielKundeREEmail.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfZielKundeREEmail.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeREEmail.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfZielKundeREEmail.setActivatable(false);
		vZielfelder.addElement(wtfZielKundeREEmail);

		wtfQuellKundeREEmail = new WrapperTextFieldZusammenfuehren();
		wtfQuellKundeREEmail.setText("");
		wtfQuellKundeREEmail.setColumnsMax(Facade.MAX_UNBESCHRAENKT);
		wtfQuellKundeREEmail.setMaximumSize(new Dimension(180, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeREEmail.setPreferredSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeREEmail.setMinimumSize(new Dimension(150, Defaults.getInstance().getControlHeight()));
		wtfQuellKundeREEmail.setActivatable(false);
		vQuellfelder.addElement(wtfQuellKundeREEmail);

		/*
		 * jpaWorkingOnScroll.add(wbuZielKundeAuswaehlen, new GridBagConstraints(1,
		 * iZeile, 1, 1, 0.0, 0.0 , GridBagConstraints.FIRST_LINE_END,
		 * GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		 * 
		 * jpaWorkingOnScroll.add(wbuAuswahlReset, new GridBagConstraints(2, iZeile, 1,
		 * 1, 0.0, 0.0 , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new
		 * Insets(0, 0, 0, 0), 0, 0));
		 * 
		 * jpaWorkingOnScroll.add(wbuQuellKundeAuswaehlen, new GridBagConstraints(3,
		 * iZeile, 1, 1, 0.0, 0.0 , GridBagConstraints.FIRST_LINE_END,
		 * GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		 */

		jpaWorkingOnScroll.add(wbuZielKundeAuswaehlen, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAuswahlReset, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuQuellKundeAuswaehlen, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPartnername, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundePartnername, new GridBagConstraints(1, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPartnernameDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundePartnername, new GridBagConstraints(3, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaMwst, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeMwst, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		/*
		 * jpaWorkingOnScroll.add(wbuMwstDatenrichtung, new GridBagConstraints(2,
		 * iZeile, 1, 1, 0.0, 0.0 , GridBagConstraints.CENTER,
		 * GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		 */

		jpaWorkingOnScroll.add(wtfQuellKundeMwst, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaWaehrung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeWaehrung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuWaehrungDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeWaehrung, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		jpaWorkingOnScroll.add(wtfZielKundeLieferart, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuLieferartDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeLieferart, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		jpaWorkingOnScroll.add(wtfZielKundeSpediteur, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuSpediteurDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeSpediteur, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaZahlungsziel, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeZahlungsziel, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuZahlungszielDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeZahlungsziel, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKostenstelle, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeKostenstelle, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKostenstelleDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeKostenstelle, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaProvisionsempfaenger, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeProvisionsempfaenger, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuProvisionsempfaengerDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeProvisionsempfaenger, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaRabattsatz, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeRabattsatz, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuRabattsatzDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeRabattsatz, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaGarantie, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeGarantie, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuGarantieDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeGarantie, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		...
		jpaWorkingOnScroll.add(jScrollPaneZielKundeKommentar, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKommentarDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(jScrollPaneQuellKundeKommentar, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKurznr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeKurznr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKurznrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeKurznr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKreditlimit, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeKreditlimit, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKreditlimitDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeKreditlimit, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaBonitaetspruefung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeBonitaetspruefung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuBonitaetspruefungDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeBonitaetspruefung, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaLiefersperre, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeLiefersperre, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuLiefersperreDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeLiefersperre, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaRechnungskopien, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeRechnungskopien, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuRechnungskopienDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeRechnungskopien, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaLieferscheinkopien, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeLieferscheinkopien, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuLieferscheinkopienDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeLieferscheinkopien, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaMitarbeiter, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeMitarbeiter, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuMitarbeiterDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeMitarbeiter, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaTour, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeTour, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuTourDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeTour, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaLieferantennr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeLieferantennr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuLieferantennrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeLieferantennr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaAbc, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeAbc, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAbcDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeAbc, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaAgb, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeAgb, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuAgbDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeAgb, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaFremdsystemnr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeFremdsystemnr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuFremdsystemnrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeFremdsystemnr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaErloeskonto, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeErloeskonto, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuErloeskontoDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeErloeskonto, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaDebitorenkonto, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeDebitorenkonto, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		/*
		 * jpaWorkingOnScroll.add(wbuDebitorenkontoDatenrichtung, new
		 * GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0 , GridBagConstraints.CENTER,
		 * GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
		 */

		jpaWorkingOnScroll.add(wtfQuellKundeDebitorenkonto, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaRechnungsadresspartner, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeRechnungsadresspartner, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuRechnungsadresspartnerDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeRechnungsadresspartner, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaHinweisInt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeHinweisInt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuHinweisIntDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeHinweisInt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaHinweisExt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeHinweisExt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuHinweisExtDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeHinweisExt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaZessionsfaktor, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeZessionsfaktor, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuZessionsfaktorDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeZessionsfaktor, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPreisliste, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundePreisliste, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPreislisteDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundePreisliste, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaKundennr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeKundennr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuKundennrDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeKundennr, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaREEmail, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfZielKundeREEmail, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuREEmailDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wtfQuellKundeREEmail, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaMindermengenzuschlag, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeMindermengenzuschlag, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuMindermengenzuschlagDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeMindermengenzuschlag, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaMonatsrechnung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeMonatsrechnung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuMonatsrechnungDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeMonatsrechnung, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaSammelrechnung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeSammelrechnung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuSammelrechnungDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeSammelrechnung, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaRechnungsempfaenger, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeRechnungsempfaenger, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuRechnungsempfaengerDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeRechnungsempfaenger, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaPreiseAmLs, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundePreiseAmLs, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuPreiseAmLsDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundePreiseAmLs, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaBelegdruckMitRabatt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeBelegdruckMitRabatt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuBelegdruckMitRabattDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeBelegdruckMitRabatt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaDistributor, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeDistributor, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuDistributorDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeDistributor, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaTeillieferungen, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeTeillieferungen, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuTeillieferungenDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeTeillieferungen, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaLsgewicht, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeLsgewicht, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuLsgewichtDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeLsgewicht, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaInteressent, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeInteressent, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuInteressentDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeInteressent, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaVersteckt, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeVersteckt, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuVerstecktDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeVersteckt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		// Zeile
		iZeile++;

		jpaWorkingOnScroll.add(wlaReversecharge, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbZielKundeReversecharge, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wbuReversechargeDatenrichtung, new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));

		jpaWorkingOnScroll.add(wcbQuellKundeReversecharge, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

		jScrollPaneKunde.setViewportView(jpaWorkingOnScroll);
		jScrollPaneKunde.setAutoscrolls(true);

		jpaWorkingOn.add(jScrollPaneKunde, new GridBagConstraints(0, iZeile, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));

		saveButton = createAndSaveButton("/com/lp/client/res/check2.png",
				LPMain.getTextRespectUISPr("part.kundenzusammenfuehren.ausfuehren"), ACTION_SPECIAL_SAVE,
	...
	/**
	 * wird ein Zielkunde (=Kunde auf der linken Seite) ausgewaehlt, so werden die
	 * Felder mit dessen Daten gefuellt
	 * 
	 * @param kndZDto KundeDto
	 * @throws Throwable
	 */
	private void befuelleFelderMitKundeZielDto(KundeDto kndZDto) throws Throwable {

		if (kndZDto.getPartnerDto().formatName() != null && kndZDto.getPartnerDto().formatName() != "") {
		...
		if (kndZDto.getMwstsatzbezIId() != null) {
			wtfZielKundeMwst.setText(DelegateFactory.getInstance().getMandantDelegate()
					.mwstsatzbezFindByPrimaryKey(kndZDto.getMwstsatzbezIId()).getCBezeichnung());
		...
		if (kndZDto.getLieferartIId() != null) {
			wtfZielKundeLieferart.setText(DelegateFactory.getInstance().getLocaleDelegate()
					.lieferartFindByPrimaryKey(kndZDto.getLieferartIId()).formatBez());
			wtfZielKundeLieferart.setCaretPosition(0);
			wtfZielKundeLieferart.setToolTipText(DelegateFactory.getInstance().getLocaleDelegate()
					.lieferartFindByPrimaryKey(kndZDto.getLieferartIId()).formatBez());
		} else {
			wtfZielKundeLieferart.setText("");
		...
		if (kndZDto.getKostenstelleIId() != null) {
			...
			wtfZielKundeKostenstelle.setToolTipText(kostenstelleDto.formatKostenstellenbezeichnung());
		} else {
			wtfZielKundeKostenstelle.setText("");
		...
		if (kndZDto.getPersonaliIdProvisionsempfaenger() != null) {
			...
			wtfZielKundeProvisionsempfaenger.setToolTipText(personalDto.formatFixUFTitelName2Name1());
		} else {
			wtfZielKundeProvisionsempfaenger.setText("");
		...
		if (kndZDto.getNKreditlimit() != null) {
			...
			wtfZielKundeKreditlimit
					.setText(kndZDto.getCWaehrung() + " " + Helper.formatZahl(bdLimit, Locale.getDefault()));
			wtfZielKundeKreditlimit.setCaretPosition(0);
			wtfZielKundeKreditlimit
					.setToolTipText(kndZDto.getCWaehrung() + " " + Helper.formatZahl(bdLimit, Locale.getDefault()));
		} else {
			wtfZielKundeKreditlimit.setText("");
		...
		if (kndZDto.getTBonitaet() != null) {
			...
			wtfZielKundeBonitaetspruefung.setText(Helper.formatDatum(dBonitaet, Locale.getDefault()));
			wtfZielKundeBonitaetspruefung.setCaretPosition(0);
			wtfZielKundeBonitaetspruefung.setToolTipText(Helper.formatDatum(dBonitaet, Locale.getDefault()));
		} else {
			wtfZielKundeBonitaetspruefung.setText("");
		...
		if (kndZDto.getTLiefersperream() != null) {
			...
			wtfZielKundeLiefersperre.setText(Helper.formatDatum(dLiefersperre, Locale.getDefault()));
			wtfZielKundeLiefersperre.setCaretPosition(0);
			wtfZielKundeLiefersperre.setToolTipText(Helper.formatDatum(dLiefersperre, Locale.getDefault()));
		} else {
			wtfZielKundeLiefersperre.setText("");
		...
		if (kndZDto.getIDefaultrekopiendrucken() != null) {
			...
			wtfZielKundeRechnungskopien.setToolTipText(kndZDto.getIDefaultrekopiendrucken().toString());
		} else {
			wtfZielKundeRechnungskopien.setText("");
		...
		if (kndZDto.getIDefaultlskopiendrucken() != null) {
			wtfZielKundeLieferscheinkopien.setText(kndZDto.getIDefaultlskopiendrucken().toString());
			wtfZielKundeLieferscheinkopien.setCaretPosition(0);
			wtfZielKundeLieferscheinkopien.setToolTipText(kndZDto.getIDefaultlskopiendrucken().toString());
		} else {
			wtfZielKundeLieferscheinkopien.setText("");
		...
		if (kndZDto.getIidErloeseKonto() != null) {
			...
			wtfZielKundeErloeskonto.setToolTipText(kontoDtoSmall.getCNr() + " " + kontoDtoSmall.getCBez());
		} else {
			wtfZielKundeErloeskonto.setText("");
		...
		if (kndZDto.getIidDebitorenkonto() != null) {
			...
			wtfZielKundeDebitorenkonto.setToolTipText(kontoDto.getCNr() + " " + kontoDto.getCBez());
		} else {
			wtfZielKundeDebitorenkonto.setText("");
		...
		if (kndZDto.getFZessionsfaktor() != null) {
			...
			wtfZielKundeZessionsfaktor.setToolTipText(Helper.formatZahl(bdZession, Locale.getDefault()) + " %");
		} else {
			wtfZielKundeZessionsfaktor.setText("");
		...
		if (kndZDto.getVkpfArtikelpreislisteIIdStdpreisliste() != null) {
			VkpfartikelpreislisteDto oVkpfartikelpreislisteDto = DelegateFactory.getInstance()
					...
					.vkpfartikelpreislisteFindByPrimaryKey(kndZDto.getVkpfArtikelpreislisteIIdStdpreisliste());
		...
		if (kndZDto.getIKundennummer() != null) {
			wtfZielKundeKundennr.setText(Helper.formatZahl(kndZDto.getIKundennummer(), Locale.getDefault()));
			wtfZielKundeKundennr.setCaretPosition(0);
			wtfZielKundeKundennr.setToolTipText(Helper.formatZahl(kndZDto.getIKundennummer(), Locale.getDefault()));
		} else {
			wtfZielKundeKundennr.setText("");
			wtfZielKundeKundennr.setToolTipText("");
		}

		if (kndZDto.getCEmailRechnungsempfang() != null) {
			wtfZielKundeREEmail.setText(kndZDto.getCEmailRechnungsempfang());
			wtfZielKundeREEmail.setCaretPosition(0);
			wtfZielKundeREEmail.setToolTipText(kndZDto.getCEmailRechnungsempfang());
		} else {
			wtfZielKundeREEmail.setText("");
			wtfZielKundeREEmail.setToolTipText("");
		}
	...
	/**
	 * je nach KundenDtos wird der zentrale Datenrichtungsbutton enabled oder
	 * disabled gesetzt
	 */
	...
	private void setzeStatusVonButtonDatenrichtung() {
		if (this.kundeQuellDto != null && this.kundeZielDto != null) {
			...
			if ((wtfZielKundePartnername.getText() != null && wtfQuellKundePartnername.getText() != null
					&& wtfQuellKundePartnername.getText().equals(wtfZielKundePartnername.getText()))
					|| (wtfZielKundePartnername.getText() == null && wtfQuellKundePartnername.getText() == null)) {
			...
			if ((wtfZielKundeMwst.getText() != null && wtfQuellKundeMwst.getText() != null
					&& wtfQuellKundeMwst.getText().equals(wtfZielKundeMwst.getText()))
					|| (wtfZielKundeMwst.getText() == null && wtfQuellKundeMwst.getText() == null)) {
			...
			if ((wtfZielKundeWaehrung.getText() != null && wtfQuellKundeWaehrung.getText() != null
					&& wtfQuellKundeWaehrung.getText().equals(wtfZielKundeWaehrung.getText()))
					|| (wtfZielKundeWaehrung.getText() == null && wtfQuellKundeWaehrung.getText() == null)) {
			...
			if ((wtfZielKundeLieferart.getText() != null && wtfQuellKundeLieferart.getText() != null
					&& wtfQuellKundeLieferart.getText().equals(wtfZielKundeLieferart.getText()))
					|| (wtfZielKundeLieferart.getText() == null && wtfQuellKundeLieferart.getText() == null)) {
			...
			if ((wtfZielKundeSpediteur.getText() != null && wtfQuellKundeSpediteur.getText() != null
					&& wtfQuellKundeSpediteur.getText().equals(wtfZielKundeSpediteur.getText()))
					|| (wtfZielKundeSpediteur.getText() == null && wtfQuellKundeSpediteur.getText() == null)) {
				wbuSpediteurDatenrichtung.setEnabled(false);
			} else {
				wbuSpediteurDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeZahlungsziel.getText() != null && wtfQuellKundeZahlungsziel.getText() != null
					&& wtfQuellKundeZahlungsziel.getText().equals(wtfZielKundeZahlungsziel.getText()))
					|| (wtfZielKundeZahlungsziel.getText() == null && wtfQuellKundeZahlungsziel.getText() == null)) {
				wbuZahlungszielDatenrichtung.setEnabled(false);
			} else {
				wbuZahlungszielDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeKostenstelle.getText() != null && wtfQuellKundeKostenstelle.getText() != null
					&& wtfQuellKundeKostenstelle.getText().equals(wtfZielKundeKostenstelle.getText()))
					|| (wtfZielKundeKostenstelle.getText() == null && wtfQuellKundeKostenstelle.getText() == null)) {
			...
			if ((wtfZielKundeProvisionsempfaenger.getText() != null
					...
					&& wtfQuellKundeProvisionsempfaenger.getText().equals(wtfZielKundeProvisionsempfaenger.getText()))
					|| (wtfZielKundeProvisionsempfaenger.getText() == null
							&& wtfQuellKundeProvisionsempfaenger.getText() == null)) {
			...
			if ((wtfZielKundeRabattsatz.getText() != null && wtfQuellKundeRabattsatz.getText() != null
					&& wtfQuellKundeRabattsatz.getText().equals(wtfZielKundeRabattsatz.getText()))
					|| (wtfZielKundeRabattsatz.getText() == null && wtfQuellKundeRabattsatz.getText() == null)) {
			...
			if ((wtfZielKundeGarantie.getText() != null && wtfQuellKundeGarantie.getText() != null
					&& wtfQuellKundeGarantie.getText().equals(wtfZielKundeGarantie.getText()))
					|| (wtfZielKundeGarantie.getText() == null && wtfQuellKundeGarantie.getText() == null)) {
			...
			if ((wtaZielKundeKommentar.getText() != null && wtaQuellKundeKommentar.getText() != null
					&& wtaQuellKundeKommentar.getText().equals(wtaZielKundeKommentar.getText()))
					|| (wtaZielKundeKommentar.getText() == null && wtaQuellKundeKommentar.getText() == null)) {
			...
			if ((wtfZielKundeKurznr.getText() != null && wtfQuellKundeKurznr.getText() != null
					&& wtfQuellKundeKurznr.getText().equals(wtfZielKundeKurznr.getText()))
					|| (wtfZielKundeKurznr.getText() == null && wtfQuellKundeKurznr.getText() == null)) {
			...
			if ((wtfZielKundeKreditlimit.getText() != null && wtfQuellKundeKreditlimit.getText() != null
					&& wtfQuellKundeKreditlimit.getText().equals(wtfZielKundeKreditlimit.getText()))
					|| (wtfZielKundeKreditlimit.getText() == null && wtfQuellKundeKreditlimit.getText() == null)) {
				wbuKreditlimitDatenrichtung.setEnabled(false);
			} else {
				wbuKreditlimitDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeBonitaetspruefung.getText() != null && wtfQuellKundeBonitaetspruefung.getText() != null
					&& wtfQuellKundeBonitaetspruefung.getText().equals(wtfZielKundeBonitaetspruefung.getText()))
					|| (wtfZielKundeBonitaetspruefung.getText() == null
			...
			if ((wtfZielKundeLiefersperre.getText() != null && wtfQuellKundeLiefersperre.getText() != null
					&& wtfQuellKundeLiefersperre.getText().equals(wtfZielKundeLiefersperre.getText()))
					|| (wtfZielKundeLiefersperre.getText() == null && wtfQuellKundeLiefersperre.getText() == null)) {
				wbuLiefersperreDatenrichtung.setEnabled(false);
			} else {
				wbuLiefersperreDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeRechnungskopien.getText() != null && wtfQuellKundeRechnungskopien.getText() != null
					&& wtfQuellKundeRechnungskopien.getText().equals(wtfZielKundeRechnungskopien.getText()))
					|| (wtfZielKundeRechnungskopien.getText() == null
			...
			if ((wtfZielKundeLieferscheinkopien.getText() != null && wtfQuellKundeLieferscheinkopien.getText() != null
					&& wtfQuellKundeLieferscheinkopien.getText().equals(wtfZielKundeLieferscheinkopien.getText()))
					|| (wtfZielKundeLieferscheinkopien.getText() == null
			...
			if ((wtfZielKundeMitarbeiter.getText() != null && wtfQuellKundeMitarbeiter.getText() != null
					&& wtfQuellKundeMitarbeiter.getText().equals(wtfZielKundeMitarbeiter.getText()))
					|| (wtfZielKundeMitarbeiter.getText() == null && wtfQuellKundeMitarbeiter.getText() == null)) {
			...
			if ((wtfZielKundeTour.getText() != null && wtfQuellKundeTour.getText() != null
					&& wtfQuellKundeTour.getText().equals(wtfZielKundeTour.getText()))
					|| (wtfZielKundeTour.getText() == null && wtfQuellKundeTour.getText() == null)) {
				wbuTourDatenrichtung.setEnabled(false);
			} else {
				wbuTourDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeLieferantennr.getText() != null && wtfQuellKundeLieferantennr.getText() != null
					&& wtfQuellKundeLieferantennr.getText().equals(wtfZielKundeLieferantennr.getText()))
					|| (wtfZielKundeLieferantennr.getText() == null && wtfQuellKundeLieferantennr.getText() == null)) {
			...
			if ((wtfZielKundeAbc.getText() != null && wtfQuellKundeAbc.getText() != null
					&& wtfQuellKundeAbc.getText().equals(wtfZielKundeAbc.getText()))
					|| (wtfZielKundeAbc.getText() == null && wtfQuellKundeAbc.getText() == null)) {
			...
			if ((wtfZielKundeAgb.getText() != null && wtfQuellKundeAgb.getText() != null
					&& wtfQuellKundeAgb.getText().equals(wtfZielKundeAgb.getText()))
					|| (wtfZielKundeAgb.getText() == null && wtfQuellKundeAgb.getText() == null)) {
				wbuAgbDatenrichtung.setEnabled(false);
			} else {
				wbuAgbDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeFremdsystemnr.getText() != null && wtfQuellKundeFremdsystemnr.getText() != null
					&& wtfQuellKundeFremdsystemnr.getText().equals(wtfZielKundeFremdsystemnr.getText()))
					|| (wtfZielKundeFremdsystemnr.getText() == null && wtfQuellKundeFremdsystemnr.getText() == null)) {
			...
			if ((wtfZielKundeErloeskonto.getText() != null && wtfQuellKundeErloeskonto.getText() != null
					&& wtfQuellKundeErloeskonto.getText().equals(wtfZielKundeErloeskonto.getText()))
					|| (wtfZielKundeErloeskonto.getText() == null && wtfQuellKundeErloeskonto.getText() == null)) {
				wbuErloeskontoDatenrichtung.setEnabled(false);
			} else {
				wbuErloeskontoDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeDebitorenkonto.getText() != null && wtfQuellKundeDebitorenkonto.getText() != null
					&& wtfQuellKundeDebitorenkonto.getText().equals(wtfZielKundeDebitorenkonto.getText()))
					|| (wtfZielKundeDebitorenkonto.getText() == null
			...
			if ((wtfZielKundeRechnungsadresspartner.getText() != null
					...
					&& wtfQuellKundeRechnungsadresspartner.getText()
							.equals(wtfZielKundeRechnungsadresspartner.getText()))
					|| (wtfZielKundeRechnungsadresspartner.getText() == null
							&& wtfQuellKundeRechnungsadresspartner.getText() == null)) {
			...
			if ((wtfZielKundeHinweisInt.getText() != null && wtfQuellKundeHinweisInt.getText() != null
					&& wtfQuellKundeHinweisInt.getText().equals(wtfZielKundeHinweisInt.getText()))
					|| (wtfZielKundeHinweisInt.getText() == null && wtfQuellKundeHinweisInt.getText() == null)) {
			...
			if ((wtfZielKundeHinweisExt.getText() != null && wtfQuellKundeHinweisExt.getText() != null
					&& wtfQuellKundeHinweisExt.getText().equals(wtfZielKundeHinweisExt.getText()))
					|| (wtfZielKundeHinweisExt.getText() == null && wtfQuellKundeHinweisExt.getText() == null)) {
				wbuHinweisExtDatenrichtung.setEnabled(false);
			} else {
				wbuHinweisExtDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeZessionsfaktor.getText() != null && wtfQuellKundeZessionsfaktor.getText() != null
					&& wtfQuellKundeZessionsfaktor.getText().equals(wtfZielKundeZessionsfaktor.getText()))
					|| (wtfZielKundeZessionsfaktor.getText() == null
			...
			if ((wtfZielKundePreisliste.getText() != null && wtfQuellKundePreisliste.getText() != null
					&& wtfQuellKundePreisliste.getText().equals(wtfZielKundePreisliste.getText()))
					|| (wtfZielKundePreisliste.getText() == null && wtfQuellKundePreisliste.getText() == null)) {
			...
			if ((wtfZielKundeKundennr.getText() != null && wtfQuellKundeKundennr.getText() != null
					&& wtfQuellKundeKundennr.getText().equals(wtfZielKundeKundennr.getText()))
					|| (wtfZielKundeKundennr.getText() == null && wtfQuellKundeKundennr.getText() == null)) {
				wbuKundennrDatenrichtung.setEnabled(false);
			} else {
				wbuKundennrDatenrichtung.setEnabled(true);
			}

			if ((wtfZielKundeREEmail.getText() != null && wtfQuellKundeREEmail.getText() != null
					&& wtfQuellKundeREEmail.getText().equals(wtfZielKundeREEmail.getText()))
					|| (wtfZielKundeREEmail.getText() == null && wtfQuellKundeREEmail.getText() == null)) {
				wbuREEmailDatenrichtung.setEnabled(false);
			} else {
				wbuREEmailDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeMindermengenzuschlag.getShort().equals(wcbZielKundeMindermengenzuschlag.getShort())) {
				wbuMindermengenzuschlagDatenrichtung.setEnabled(false);
			} else {
				wbuMindermengenzuschlagDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeMonatsrechnung.getShort().equals(wcbZielKundeMonatsrechnung.getShort())) {
				wbuMonatsrechnungDatenrichtung.setEnabled(false);
			} else {
				wbuMonatsrechnungDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeSammelrechnung.getShort().equals(wcbZielKundeSammelrechnung.getShort())) {
				wbuSammelrechnungDatenrichtung.setEnabled(false);
			} else {
				wbuSammelrechnungDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeRechnungsempfaenger.getShort().equals(wcbZielKundeRechnungsempfaenger.getShort())) {
				wbuRechnungsempfaengerDatenrichtung.setEnabled(false);
			} else {
				wbuRechnungsempfaengerDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundePreiseAmLs.getShort().equals(wcbZielKundePreiseAmLs.getShort())) {
				wbuPreiseAmLsDatenrichtung.setEnabled(false);
			} else {
				wbuPreiseAmLsDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeBelegdruckMitRabatt.getShort().equals(wcbZielKundeBelegdruckMitRabatt.getShort())) {
				wbuBelegdruckMitRabattDatenrichtung.setEnabled(false);
			} else {
				wbuBelegdruckMitRabattDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeDistributor.getShort().equals(wcbZielKundeDistributor.getShort())) {
				wbuDistributorDatenrichtung.setEnabled(false);
			} else {
				wbuDistributorDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeTeillieferungen.getShort().equals(wcbZielKundeTeillieferungen.getShort())) {
				wbuTeillieferungenDatenrichtung.setEnabled(false);
			} else {
				wbuTeillieferungenDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeLsgewicht.getShort().equals(wcbZielKundeLsgewicht.getShort())) {
				wbuLsgewichtDatenrichtung.setEnabled(false);
			} else {
				wbuLsgewichtDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeInteressent.getShort().equals(wcbZielKundeInteressent.getShort())) {
				wbuInteressentDatenrichtung.setEnabled(false);
			} else {
				wbuInteressentDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeVersteckt.getShort().equals(wcbZielKundeVersteckt.getShort())) {
				wbuVerstecktDatenrichtung.setEnabled(false);
			} else {
				wbuVerstecktDatenrichtung.setEnabled(true);
			}

			if (wcbQuellKundeReversecharge.getShort().equals(wcbZielKundeReversecharge.getShort())) {
	...
	/**
	 * wird ein Quellkunde (=Kunde auf der rechten Seite) ausgewaehlt, so werden die
	 * Felder mit dessen Daten gefuellt
	 * 
	 * @param kqDto KundeDto
	 * @throws Throwable
	 */
	private void befuelleFelderMitKundeQuellDto(KundeDto kqDto) throws Throwable {
		if (this.kundeQuellDto != null && this.kundeZielDto != null) {
			...
			if (kqDto.getMwstsatzbezIId() != null) {
				wtfQuellKundeMwst.setText(DelegateFactory.getInstance().getMandantDelegate()
						.mwstsatzbezFindByPrimaryKey(kqDto.getMwstsatzbezIId()).getCBezeichnung());
			...
			if (kqDto.getLieferartIId() != null) {
				wtfQuellKundeLieferart.setText(DelegateFactory.getInstance().getLocaleDelegate()
						.lieferartFindByPrimaryKey(kqDto.getLieferartIId()).formatBez());
				wtfQuellKundeLieferart.setCaretPosition(0);
				wtfQuellKundeLieferart.setToolTipText(DelegateFactory.getInstance().getLocaleDelegate()
						.lieferartFindByPrimaryKey(kqDto.getLieferartIId()).formatBez());
			} else {
				wtfQuellKundeLieferart.setText("");
			...
			if (kqDto.getKostenstelleIId() != null) {
				...
				wtfQuellKundeKostenstelle.setToolTipText(kostenstelleDto.formatKostenstellenbezeichnung());
			} else {
				wtfQuellKundeKostenstelle.setText("");
			...
			if (kqDto.getPersonaliIdProvisionsempfaenger() != null) {
				...
				wtfQuellKundeProvisionsempfaenger.setToolTipText(personalDto.formatFixUFTitelName2Name1());
			} else {
				wtfQuellKundeProvisionsempfaenger.setText("");
			...
			if (kqDto.getFRabattsatz() != null) {
				...
				wtfQuellKundeRabattsatz.setToolTipText(Helper.formatZahl(bdRabatt, Locale.getDefault()) + " %");
			} else {
				wtfQuellKundeRabattsatz.setText("");
			...
			if (kqDto.getNKreditlimit() != null) {
				...
				wtfQuellKundeKreditlimit
						.setText(kqDto.getCWaehrung() + " " + Helper.formatZahl(bdLimit, Locale.getDefault()));
				wtfQuellKundeKreditlimit.setCaretPosition(0);
				wtfQuellKundeKreditlimit
						.setToolTipText(kqDto.getCWaehrung() + " " + Helper.formatZahl(bdLimit, Locale.getDefault()));
			} else {
				wtfQuellKundeKreditlimit.setText("");
			...
			if (kqDto.getTBonitaet() != null) {
				...
				wtfQuellKundeBonitaetspruefung.setText(Helper.formatDatum(dBonitaet, Locale.getDefault()));
				wtfQuellKundeBonitaetspruefung.setCaretPosition(0);
				wtfQuellKundeBonitaetspruefung.setToolTipText(Helper.formatDatum(dBonitaet, Locale.getDefault()));
			} else {
				wtfQuellKundeBonitaetspruefung.setText("");
			...
			if (kqDto.getTLiefersperream() != null) {
				...
				wtfQuellKundeLiefersperre.setText(Helper.formatDatum(dLiefersperre, Locale.getDefault()));
				wtfQuellKundeLiefersperre.setCaretPosition(0);
				wtfQuellKundeLiefersperre.setToolTipText(Helper.formatDatum(dLiefersperre, Locale.getDefault()));
			} else {
				wtfQuellKundeLiefersperre.setText("");
			...
			if (kqDto.getIDefaultrekopiendrucken() != null) {
				...
				wtfQuellKundeRechnungskopien.setToolTipText(kqDto.getIDefaultrekopiendrucken().toString());
			} else {
				wtfQuellKundeRechnungskopien.setText("");
			...
			if (kqDto.getIDefaultlskopiendrucken() != null) {
				wtfQuellKundeLieferscheinkopien.setText(kqDto.getIDefaultlskopiendrucken().toString());
				wtfQuellKundeLieferscheinkopien.setCaretPosition(0);
				wtfQuellKundeLieferscheinkopien.setToolTipText(kqDto.getIDefaultlskopiendrucken().toString());
			} else {
				wtfQuellKundeLieferscheinkopien.setText("");
			...
			if (kqDto.getIidErloeseKonto() != null) {
				...
				wtfQuellKundeErloeskonto.setToolTipText(kontoDtoSmall.getCNr() + " " + kontoDtoSmall.getCBez());
			} else {
				wtfQuellKundeErloeskonto.setText("");
			...
			if (kqDto.getIidDebitorenkonto() != null) {
				...
				wtfQuellKundeDebitorenkonto.setToolTipText(kontoDto.getCNr() + " " + kontoDto.getCBez());
			} else {
				wtfQuellKundeDebitorenkonto.setText("");
			...
			if (kqDto.getFZessionsfaktor() != null) {
				...
				wtfQuellKundeZessionsfaktor.setText(Helper.formatZahl(bdZession, Locale.getDefault()) + " %");
				wtfQuellKundeZessionsfaktor.setCaretPosition(0);
				wtfQuellKundeZessionsfaktor.setToolTipText(Helper.formatZahl(bdZession, Locale.getDefault()) + " %");
			} else {
				wtfQuellKundeZessionsfaktor.setText("");
			...
			if (kqDto.getVkpfArtikelpreislisteIIdStdpreisliste() != null) {
				VkpfartikelpreislisteDto oVkpfartikelpreislisteDto = DelegateFactory.getInstance()
						.getVkPreisfindungDelegate()
						.vkpfartikelpreislisteFindByPrimaryKey(kqDto.getVkpfArtikelpreislisteIIdStdpreisliste());
			...
			if (kqDto.getIKundennummer() != null) {
				wtfQuellKundeKundennr.setText(Helper.formatZahl(kqDto.getIKundennummer(), Locale.getDefault()));
				wtfQuellKundeKundennr.setCaretPosition(0);
				wtfQuellKundeKundennr.setToolTipText(Helper.formatZahl(kqDto.getIKundennummer(), Locale.getDefault()));
			} else {
				wtfQuellKundeKundennr.setText("");
				wtfQuellKundeKundennr.setToolTipText("");
			}

			if (kqDto.getCEmailRechnungsempfang() != null) {
				wtfQuellKundeREEmail.setText(kqDto.getCEmailRechnungsempfang());
				wtfQuellKundeREEmail.setCaretPosition(0);
				wtfQuellKundeREEmail.setToolTipText(kqDto.getCEmailRechnungsempfang());
			} else {
				wtfQuellKundeREEmail.setText("");
				wtfQuellKundeREEmail.setToolTipText("");
			}
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(PanelBasis.ESC)
			...
			if (this.kundeQuellDto != null && this.kundeZielDto != null
				...
				try {
					...
					if (DelegateFactory.getInstance().getKundeDelegate().sindBeiQuellUndZielKundeSokosVorhanden(
							this.kundeQuellDto.getPartnerIId(), this.kundeZielDto.getPartnerIId())) {
						DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("lp.info"),
								LPMain.getInstance().getTextRespectUISPr("part.kunde.zusammenfuehren.sokos.hinweis"));
					}

					DelegateFactory.getInstance().getKundeDelegate().zusammenfuehrenKunde(this.kundeZielDto,
							this.kundeQuellDto.getIId(), this.iKundePartnerIId);
					erfolgreich = true;
				...
				String sText = LPMain.getInstance()
						.getTextRespectUISPr("part.zusammenfuehren.warnung.kunde.quelle.ziel.identisch");
				DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("part.kundenzusammenfuehren"),
						sText);
			}
			if (erfolgreich) {
				// AuswahlFLR refreshen
				((InternalFrameKunde) getInternalFrame()).getTpKunde().getPanelKundeQP1().eventYouAreSelected(true);
				getInternalFrame().closePanelDialog();
			}
		}

		if (e.getActionCommand().equals(ACTION_ZIELKUNDE_AUSWAEHLEN)) {
			panelQueryKundeFlr = PartnerFilterFactory.getInstance().createPanelFLRKunde(getInternalFrame(), true, true);
			new DialogQuery(panelQueryKundeFlr);
			Object oKey = panelQueryKundeFlr.getSelectedId();
			KundeDto kundeDtoTmp = DelegateFactory.getInstance().getKundeDelegate()
					.kundeFindByPrimaryKey((Integer) oKey);
			if (this.kundeQuellDto != null && this.kundeQuellDto.getIId() != null
					&& this.kundeQuellDto.getIId().intValue() == kundeDtoTmp.getIId().intValue()) {
				String sMsg = LPMain.getInstance()
						.getTextRespectUISPr("part.zusammenfuehren.warnung.kunde.bereits.ausgewaehlt");
				DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("part.kundenzusammenfuehren"),
						sMsg);
			} else {
		...
		if (e.getActionCommand().equals(ACTION_QUELLKUNDE_AUSWAEHLEN)) {
			...
			KundeDto kundeDtoTmp = DelegateFactory.getInstance().getKundeDelegate()
					.kundeFindByPrimaryKey((Integer) oKey);
			if (this.kundeZielDto != null && this.kundeZielDto.getIId() != null
					&& this.kundeZielDto.getIId().intValue() == kundeDtoTmp.getIId().intValue()) {
				String sMsg = LPMain.getInstance()
						.getTextRespectUISPr("part.zusammenfuehren.warnung.kunde.bereits.ausgewaehlt");
				DialogFactory.showModalDialog(LPMain.getInstance().getTextRespectUISPr("part.kundenzusammenfuehren"),
						sMsg);
		...
		if (e.getActionCommand().equals(ACTION_DATENRICHTUNG_WAEHLEN)) {
			// ToDo: Pfeil nach links, Pfeil nach rechts oder Kombinationsringe (unendlich
			// zeichen)
	...
	/**
	 * Schreibt die selektierten Kundendaten in die zielkundenDto Einige
	 * Dateninhalte wie z.B. Anrede, Ort, etc... sind nicht kombinierbar einige wie
	 * Kommentar und Hinweis sind kombinierbar
	 * 
	 * @throws Throwable
	 */
	private void schreibeRichtungInZielKunde() throws Throwable {
		/*
		 * alle buttons vergleichen: wenn der btn nach li zeigt: nix wenn der button
		 * nach rechts zeigt & aktiv ist: schreibe diese daten von quelle in ziel wenn
		...
		if (wbuPartnernameDatenrichtung.isEnabled()) {
			if (wbuPartnernameDatenrichtung
			...
			} else if (wbuPartnernameDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_LINKEN_DATENINHALT) {
		...
		if (wbuZahlungszielDatenrichtung.isEnabled()) {
			if (wbuZahlungszielDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuKostenstelleDatenrichtung.isEnabled()) {
			if (wbuKostenstelleDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuProvisionsempfaengerDatenrichtung.isEnabled()) {
			if (wbuProvisionsempfaengerDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.kundeZielDto
						.setPersonaliIdProvisionsempfaenger(this.kundeQuellDto.getPersonaliIdProvisionsempfaenger());
			}
		}
		...
		if (wbuKommentarDatenrichtung.isEnabled()) {
			...
			} else if (wbuKommentarDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
		...
		if (wbuKreditlimitDatenrichtung.isEnabled()) {
			if (wbuKreditlimitDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuBonitaetspruefungDatenrichtung.isEnabled()) {
			if (wbuBonitaetspruefungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuLiefersperreDatenrichtung.isEnabled()) {
			if (wbuLiefersperreDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuRechnungskopienDatenrichtung.isEnabled()) {
			if (wbuRechnungskopienDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuLieferscheinkopienDatenrichtung.isEnabled()) {
			if (wbuLieferscheinkopienDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuMitarbeiterDatenrichtung.isEnabled()) {
			if (wbuMitarbeiterDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuLieferantennrDatenrichtung.isEnabled()) {
			if (wbuLieferantennrDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuFremdsystemnrDatenrichtung.isEnabled()) {
			if (wbuFremdsystemnrDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuErloeskontoDatenrichtung.isEnabled()) {
			if (wbuErloeskontoDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuDebitorenkontoDatenrichtung.isEnabled()) {
			if (wbuDebitorenkontoDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuRechnungsadresspartnerDatenrichtung.isEnabled()) {
			if (wbuRechnungsadresspartnerDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuHinweisIntDatenrichtung.isEnabled()) {
			...
			} else if (wbuHinweisIntDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
		...
		if (wbuHinweisExtDatenrichtung.isEnabled()) {
			...
			} else if (wbuHinweisExtDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_KOMBINIERTE_DATENINHALTE) {
		...
		if (wbuZessionsfaktorDatenrichtung.isEnabled()) {
			if (wbuZessionsfaktorDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuPreislisteDatenrichtung.isEnabled()) {
			if (wbuPreislisteDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.kundeZielDto.setVkpfArtikelpreislisteIIdStdpreisliste(
						this.kundeQuellDto.getVkpfArtikelpreislisteIIdStdpreisliste());
			}
		}
		...
		if (wbuREEmailDatenrichtung.isEnabled()) {
			if (wbuREEmailDatenrichtung.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
				this.kundeZielDto.setCEmailRechnungsempfang(this.kundeQuellDto.getCEmailRechnungsempfang());
			}
		}

		if (wbuMindermengenzuschlagDatenrichtung.isEnabled()) {
			if (wbuMindermengenzuschlagDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuMonatsrechnungDatenrichtung.isEnabled()) {
			if (wbuMonatsrechnungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuSammelrechnungDatenrichtung.isEnabled()) {
			if (wbuSammelrechnungDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuRechnungsempfaengerDatenrichtung.isEnabled()) {
			if (wbuRechnungsempfaengerDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuBelegdruckMitRabattDatenrichtung.isEnabled()) {
			if (wbuBelegdruckMitRabattDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuDistributorDatenrichtung.isEnabled()) {
			if (wbuDistributorDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuTeillieferungenDatenrichtung.isEnabled()) {
			if (wbuTeillieferungenDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuInteressentDatenrichtung.isEnabled()) {
			if (wbuInteressentDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
		...
		if (wbuReversechargeDatenrichtung.isEnabled()) {
			if (wbuReversechargeDatenrichtung
					.getISelection() == WrapperButtonZusammenfuehren.SELECT_RECHTEN_DATENINHALT) {
