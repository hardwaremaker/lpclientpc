...
public class DialogPartnerimportXLS extends JDialog implements ActionListener {
	/**
	 * 
	 */
	...
	public DialogPartnerimportXLS(byte[] xlsDatei, TabbedPanePartner tpPartner)
			throws Throwable {
		super(LPMain.getInstance().getDesktop(), "Partner XLS importieren", true);
	...
	private void jbInit() throws Exception {
		...
		wtaFehler.setText(DelegateFactory
				.getInstance()
				.getPartnerDelegate()
				.pruefeUndImportierePartnerXLS(xlsDatei,
						wcbErzeugeKunde.isSelected(),
						wcbErzeugeLieferant.isSelected(), false));
		...
		panelUrlaubsanspruch.add(wcbErzeugeKunde, new GridBagConstraints(0, 1,
				1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 100, 0));
		panelUrlaubsanspruch.add(wcbErzeugeLieferant, new GridBagConstraints(1,
		...
		if (e.getSource().equals(wbuImportieren)) {
			try {
				DelegateFactory
						...
						.pruefeUndImportierePartnerXLS(xlsDatei,
								wcbErzeugeKunde.isSelected(),
								wcbErzeugeLieferant.isSelected(), true);
