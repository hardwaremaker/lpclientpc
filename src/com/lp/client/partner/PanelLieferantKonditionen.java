...
//	private WrapperCheckBox wcbReversecharge = null;
	...
	private PanelSelectReversechargeart panelReversechargeart = null;
	private WrapperLabel wlaFremdsystemnr = new WrapperLabel();
	private WrapperTextField wtfFremdsystemnr = new WrapperTextField();

	private WrapperLabel wlaLiefertag = new WrapperLabel();
	private WrapperComboBox wcoLiefertag = new WrapperComboBox();
	...
	public PanelLieferantKonditionen(InternalFrame internalFrame, String add2TitleI, Object keyI) throws Throwable {
...
//				.setText(LPMain.getTextRespectUISPr("lp.reversecharge"));
		...
		wlaLiefertag.setText(LPMain.getTextRespectUISPr("part.lieferant.liefertag"));

		DateFormatSymbols symbols = new DateFormatSymbols(LPMain.getInstance().getUISprLocale());
		String[] wochentage = symbols.getWeekdays();
		Map<Integer, String> m = new LinkedHashMap<Integer, String>();

		m.put(Calendar.MONDAY, wochentage[Calendar.MONDAY]);
		m.put(Calendar.TUESDAY, wochentage[Calendar.TUESDAY]);
		m.put(Calendar.WEDNESDAY, wochentage[Calendar.WEDNESDAY]);
		m.put(Calendar.THURSDAY, wochentage[Calendar.THURSDAY]);
		m.put(Calendar.FRIDAY, wochentage[Calendar.FRIDAY]);

		wcoLiefertag.setMap(m, false);
		...
		wnfKreditlimit.setMaximumValue(new BigDecimal(LieferantFac.MAX_KREDITLIMIT));
		...
		wtfZahlungsziel = new WrapperTextField(MandantFac.MAX_ZAHLUNGSZIEL_C_BEZ);
		...
		wbtZahlungsziel.setText(LPMain.getTextRespectUISPr("button.zahlungsziel"));
		...
		wlaMindestbestellwert = new WrapperLabel(LPMain.getTextRespectUISPr("lp.mindestbestellwert"));
		wnfMindestbestellwert = new WrapperNumberField();

		wlaJahresbonus = new WrapperLabel(LPMain.getTextRespectUISPr("lp.jahresbonus"));
		wnfJahresbonus = new WrapperNumberField();

		wlaAbUmsatz = new WrapperLabel(LPMain.getTextRespectUISPr("part.ab_umsatz"));
		wnfAbUmsatz = new WrapperNumberField();

		wlaMindermengenzuschlag = new WrapperLabel(LPMain.getTextRespectUISPr("part.mindermengenzuschlag"));
		wnfMindermengenzuschlag = new WrapperNumberField();

		wlaFremdsystemnr = new WrapperLabel(LPMain.getTextRespectUISPr("part.kund.fremdsystemnr"));
		wtfFremdsystemnr = new WrapperTextField(LieferantFac.MAX_FREMDSYSTEMNR);
		wlaFreigabe = new WrapperLabel(LPMain.getTextRespectUISPr("part.lieferant.freigabe"));
		...
		wlaTransportkostenJeLieferung = new WrapperLabel(LPMain.getTextRespectUISPr("part.tpkostenjelieferung"));
		...
		Integer kontonummerMaxStellen = DelegateFactory.getInstance().getFinanzDelegate()
				.getAnzahlStellenVonKontoNummer(FinanzServiceFac.KONTOTYP_KREDITOR);
		wtnfKontokreditoren.setMaximumDigits(kontonummerMaxStellen.intValue());

		wlaKontokreditorenRangeVonBis = new WrapperLabel();
		wlaKontokreditorenRangeVonBis.setHorizontalAlignment(SwingConstants.LEFT);
		...
		wbuKontowaren.setText(LPMain.getTextRespectUISPr("button.warenkonto"));
		...
		wefKommentar = new WrapperEditorFieldKommentar(getInternalFrame(), LPMain.getTextRespectUISPr("lp.bemerkung"));
		...
		wlaFreigabeAb.setText(LPMain.getTextRespectUISPr("part.lieferant.freigabeab"));
		wlaFreigabeAb.setHorizontalAlignment(SwingConstants.LEFT);

		wcbBeurteilen = new WrapperCheckBox(LPMain.getTextRespectUISPr("lp.beurteilen"));
		wcbZuschlagInklusive = new WrapperCheckBox(LPMain.getTextRespectUISPr("part.zuschlaginklusive"));
		wcbZuschlagInklusive.setToolTipText(LPMain.getTextRespectUISPr("part.zuschlaginklusive.tooltip"));

		wcbZollimportpapiere = new WrapperCheckBox(
		...
		wbuKreditorenkontoAutomatisch = new WrapperGotoButton(com.lp.util.GotoHelper.GOTO_KREDITORENKONTO_AUSWAHL);

		wbuKreditorenkontoAutomatisch.getWrapperButtonGoTo().setVisible(bFibuInstalliert);
		wbuKreditorenkontoAutomatisch.setText(LPMain.getTextRespectUISPr("button.kreditorenkontoanlegen"));
		wbuKreditorenkontoAutomatisch
				.setToolTipText(LPMain.getTextRespectUISPr("button.kreditorenkontoanlegen.tooltip"));
		wbuKreditorenkontoAutomatisch.setActionCommand(ACTION_SPECIAL_KREDITORENKONTOAUTOMATISCH);
		wbuKreditorenkontoAutomatisch.addActionListener(this);

		wlaBestellsperream = new WrapperLabel(LPMain.getTextRespectUISPr("lp.lieferant.bestellsperream"));
		wdfBestellsperream = new WrapperDateField();

		HelperClient.setMinimumAndPreferredSize(panelReversechargeart.getWcoReversechargeart(),
				HelperClient.getSizeFactoredDimension(190));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbtKostenstelle, new GridBagConstraints(0, iZeile, 1, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfKostenstelle, new GridBagConstraints(1, iZeile, 1, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(new WrapperLabel(), new GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaWaehrung, new GridBagConstraints(3, iZeile, 1, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wcoWaehrung, new GridBagConstraints(4, iZeile, 2, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuKontowaren, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfKontowaren, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		if (DelegateFactory.getInstance().getFinanzDelegate().getAnzahlDerFinanzaemter() > 1) {
			...
			if (DelegateFactory.getInstance().getMandantDelegate()
				...
				jpaWorkingOn.add(wlaAbweichendesfinanzamt, new GridBagConstraints(2, iZeile, 2, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
				jpaWorkingOn.add(wtfAbweichendesustland, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			} else {
				jpaWorkingOn.add(wbuAbweichendesustland, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
				jpaWorkingOn.add(wtfAbweichendesustland, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0,
						GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			}
		}
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuKreditorenkontoAutomatisch, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtnfKontokreditoren, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaKontokreditorenRangeVonBis, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wcbIgErwerb, new GridBagConstraints(4, iZeile, 1, 1, 0.1, 0.0, GridBagConstraints.CENTER,
...
//					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jpaWorkingOn.add(panelReversechargeart.getWlaReversechargeart(), new GridBagConstraints(5, iZeile, 1, 1,
					0.1, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
			jpaWorkingOn.add(panelReversechargeart.getWcoReversechargeart(), new GridBagConstraints(6, iZeile, 1, 1,
					0.1, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), -130, 0));
...
//					GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		...
		jpaWorkingOn.add(wcbZollimportpapiere, new GridBagConstraints(0, iZeile, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wcbBeurteilen, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaBeurteilung, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaHinweistextextern, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfHinweistextextern, new GridBagConstraints(1, iZeile, 5, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaHinweistextintern, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfHinweistextintern, new GridBagConstraints(1, iZeile, 5, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		// Zeile.
		...
		jpaWorkingOn.add(wlaKommentar, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wefKommentar, new GridBagConstraints(1, iZeile, 5, 1, 0.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		iZeile++;
		jpaWorkingOn.add(wlaFremdsystemnr, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wtfFremdsystemnr, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaLiefertag, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wcoLiefertag, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaFreigabe, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wtfFreigabe, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		JPanel panelFreigabe = new JPanel();
		HvLayout hvLayoutFreigabe = HvLayoutFactory.create(panelFreigabe, "ins 0", "fill", "");
		hvLayoutFreigabe.add(wlaFreigabeAb, "growx, w min+10").add(wdfFreigabe, "al left, w pref")
				.add(wlaFreigabePerson, "growx, pushx");
		jpaWorkingOn.add(panelFreigabe, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaRabattsatz, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfRabattsatz, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaEinheitProzentRabatt, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaJahresbonus, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfJahresbonus, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg2, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 20, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaKreditlimit, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfKreditlimit, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg0, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaAbUmsatz, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfAbUmsatz, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg3, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaMindestbestellwert, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfMindestbestellwert, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg1, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaMindermengenzuschlag, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfMindermengenzuschlag, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg4, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		iZeile++;
		jpaWorkingOn.add(wlaTransportkostenJeLieferung, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfTransportkostenJeLieferung, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg5, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wlaKupferzahl, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wnfKupferzahl, new GridBagConstraints(4, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaLieferantenWhg6, new GridBagConstraints(5, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 35, 0));
		jpaWorkingOn.add(wcbZuschlagInklusive, new GridBagConstraints(6, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbtZahlungsziel, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfZahlungsziel, new GridBagConstraints(1, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		
		jpaWorkingOn.add(wbuLieferadresse, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 80, 0));
		jpaWorkingOn.add(wtfLieferadresse, new GridBagConstraints(4, iZeile, 3, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 95, 2, 2), 0, 0));
		
		// Zeile.
		iZeile++;

		jpaWorkingOn.add(wbuLieferart, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfLieferart, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		jpaWorkingOn.add(wsfLager.getWrapperButton(), new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 80, 0));
		jpaWorkingOn.add(wsfLager.getWrapperTextField(), new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 95, 2, 2), 0, 0));

		jpaWorkingOn.add(wbuZiellager, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 80, 0));
		jpaWorkingOn.add(wtfZiellager, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.HORIZONTAL, new Insets(2, 95, 2, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuSpedition, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfSpedition, new GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wlaBestellsperream, new GridBagConstraints(3, iZeile, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wdfBestellsperream, new GridBagConstraints(4, iZeile, 2, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));

		wbuVersteckterKunde = new WrapperGotoButton(com.lp.util.GotoHelper.GOTO_KUNDE_KONDITIONEN);
		wbuVersteckterKunde.setText(LPMain.getTextRespectUISPr("part.lieferant.versteckterkunde.konditionen"));
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		...
		if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_KONTOWAREN)) {
			...
			panelQueryFLRKontowaren = new PanelQueryFLR(querytypes, filters, QueryParameters.UC_ID_FINANZKONTEN,
					aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("lp.konto.waren"));
			...
			panelQueryFLRKontowaren.befuellePanelFilterkriterienDirektUndVersteckte(fkDirekt1, fkDirekt2, fkVersteckt);
			...
			if (getLieferantDto().getIIdKostenstelle() != null) {
				panelQueryFLRKostenstelle.setSelectedId(getLieferantDto().getIIdKostenstelle());
			}
		...
		else if (e.getActionCommand().equals(ACTION_SPECIAL_KREDITORENKONTOAUTOMATISCH)) {
			...
			if (getLieferantDto().getKontoIIdKreditorenkonto() != null) {
				bKontoAnlegen = DialogFactory.showModalJaNeinDialog(getInternalFrame(),
						LPMain.getTextRespectUISPr("part.lieferant.warning.hatschoneinkreditorenkonto"),
						LPMain.getTextRespectUISPr("lp.frage"));
			}
			if (bKontoAnlegen) {
				String kontoNr = DelegateFactory.getInstance().getLieferantDelegate()
						.createKreditorenkontoNummerZuLieferantenAutomatisch(getLieferantDto().getIId(),
	...
	protected void dto2Components() throws Throwable {
		...
		KundeDto kDto = DelegateFactory.getInstance().getKundeDelegate().kundeFindByiIdPartnercNrMandantOhneExc(
				getLieferantDto().getPartnerIId(), LPMain.getTheClient().getMandant());
		...
		wcbZuschlagInklusive.setShort(getLieferantDto().getBZuschlagInklusive());
		wcbZollimportpapiere.setShort(getLieferantDto().getBZollimportpapier());

		wcoLiefertag.setKeyOfSelectedItem(getLieferantDto().getILiefertag());

		wtfFremdsystemnr.setText(getLieferantDto().getCFremdsystemnr());
		wdfFreigabe.setTimestamp(getLieferantDto().getTFreigabe());
		wtfFreigabe.setText(getLieferantDto().getCFreigabe());

		wbuKreditorenkontoAutomatisch.setOKey(getLieferantDto().getKontoIIdKreditorenkonto());
		wcbIgErwerb.setSelected(getLieferantDto().getBIgErwerbBoolean());
		panelReversechargeart.getWcoReversechargeart().setKeyOfSelectedItem(getLieferantDto().getReversechargeartId());
//		wcbReversecharge.setShort(getLieferantDto().getBReversecharge());
		...
		if (getLieferantDto().getTPersonalFreigabe() != null) {
			...
			ausg += Helper.formatDatum(getLieferantDto().getTPersonalFreigabe(), LPMain.getTheClient().getLocUi());

			if (getLieferantDto().getPersonalIIdFreigabe() != null) {
				PersonalDto personalDto = DelegateFactory.getInstance().getPersonalDelegate()
						.personalFindByPrimaryKey(getLieferantDto().getPersonalIIdFreigabe());
		...
		if (getLieferantDto().getZahlungszielIId() != null) {
			sZ = DelegateFactory.getInstance().getMandantDelegate()
					.zahlungszielFindByPrimaryKey(getLieferantDto().getZahlungszielIId()).getCBez();
		}
		wtfZahlungsziel.setText(sZ);

		wnfMindestbestellwert.setBigDecimal(getLieferantDto().getNMindestbestellwert());
		wnfJahresbonus.setBigDecimal(getLieferantDto().getNJahrbonus());
		wnfAbUmsatz.setBigDecimal(getLieferantDto().getNAbumsatz());
		wnfMindermengenzuschlag.setBigDecimal(getLieferantDto().getNMindermengenzuschlag());
		...
		wnfTransportkostenJeLieferung.setBigDecimal(getLieferantDto().getNTransportkostenprolieferung());
		wlaBeurteilung.setText(LPMain.getTextRespectUISPr("rekla.letztebeurteilung") + DelegateFactory.getInstance()
				.getLieferantDelegate().lieferantbeurteilungfindByLetzteBeurteilung(getLieferantDto().getIId()));

		if (getLieferantDto().getKontoIIdWarenkonto() != null) {
			KontoDtoSmall kontoDtoSmall = DelegateFactory.getInstance().getFinanzDelegate()
					.kontoFindByPrimaryKeySmall(getLieferantDto().getKontoIIdWarenkonto());
		...
		if (getLieferantDto().getPartnerDto().getLagerIIdZiellager() != null) {
			LagerDto lagerDto = DelegateFactory.getInstance().getLagerDelegate()
					.lagerFindByPrimaryKey(getLieferantDto().getPartnerDto().getLagerIIdZiellager());
		...
		if (getLieferantDto().getLieferartIId() != null) {
			LieferartDto lieferartDto = DelegateFactory.getInstance().getLocaleDelegate()
					.lieferartFindByPrimaryKey(getLieferantDto().getLieferartIId());
		...
		if (getLieferantDto().getPartnerDto().getLandIIdAbweichendesustland() != null) {
			LandDto landDto = DelegateFactory.getInstance().getSystemDelegate()
					.landFindByPrimaryKey(getLieferantDto().getPartnerDto().getLandIIdAbweichendesustland());
		...
		if (getLieferantDto().getKontoIIdKreditorenkonto() != null) {
			bhatBuchungenDrauf = DelegateFactory.getInstance().getBuchenDelegate().hatPartnerBuchungenAufKonto(
					getLieferantDto().getPartnerIId(), getLieferantDto().getKontoIIdKreditorenkonto());
		}
		...
		if (getLieferantDto().getIIdKostenstelle() != null) {
			KostenstelleDto kostenstelleDto = DelegateFactory.getInstance().getSystemDelegate()
					.kostenstelleFindByPrimaryKey(getLieferantDto().getIIdKostenstelle());
		...
		if (getLieferantDto().getZahlungszielIId() != null) {
			ZahlungszielDto zahlungszielDto = DelegateFactory.getInstance().getMandantDelegate()
					.zahlungszielFindByPrimaryKey(getLieferantDto().getZahlungszielIId());
		...
		wdfBestellsperream.setTimestamp(getLieferantDto().getTBestellsperream());

		wnfKupferzahl.setBigDecimal(getLieferantDto().getNKupferzahl());

		if (getLieferantDto().getPartnerIIdLieferadresse() != null) {
			PartnerDto lieferadresseDto = DelegateFactory.getInstance().getPartnerDelegate()
					.partnerFindByPrimaryKey(getLieferantDto().getPartnerIIdLieferadresse());
	...
	protected void components2Dto() throws Throwable {
		...
		getLieferantDto().setWaehrungCNr((String) wcoWaehrung.getKeyOfSelectedItem());
		...
		getLieferantDto().setBZuschlagInklusive(wcbZuschlagInklusive.getShort());
		getLieferantDto().setBZollimportpapier(wcbZollimportpapiere.getShort());
		getLieferantDto().setNMindestbestellwert(wnfMindestbestellwert.getBigDecimal());
		getLieferantDto().setNJahrbonus(wnfJahresbonus.getBigDecimal());
		getLieferantDto().setNAbumsatz(wnfAbUmsatz.getBigDecimal());
		getLieferantDto().setNMindermengenzuschlag(wnfMindermengenzuschlag.getBigDecimal());
		...
		getLieferantDto().setIKreditorenkontoAsIntegerNotiId(wtnfKontokreditoren.getInteger());
		getLieferantDto().setTBestellsperream(wdfBestellsperream.getTimestamp());
		getLieferantDto().setNTransportkostenprolieferung(wnfTransportkostenJeLieferung.getBigDecimal());
		...
		getLieferantDto().setILiefertag((Integer) wcoLiefertag.getKeyOfSelectedItem());
		getLieferantDto().setBIgErwerb(wcbIgErwerb.isSelected());
		getLieferantDto()
				.setReversechargeartId((Integer) panelReversechargeart.getWcoReversechargeart().getKeyOfSelectedItem());
//		if (bReversecharge == true) {
//			getLieferantDto().setBReversecharge(wcbReversecharge.getShort());
//		} else {
//			getLieferantDto().setBReversecharge(Helper.boolean2Short(false));
//		}
		getLieferantDto().setCFremdsystemnr(wtfFremdsystemnr.getText());
	}
	...
	private void initPanel() throws Throwable {
		...
		ParametermandantDto parametermandantDto = DelegateFactory.getInstance().getParameterDelegate()
				.getMandantparameter(LPMain.getTheClient().getMandant(), ParameterFac.KATEGORIE_LIEFERANT,
						ParameterFac.PARAMETER_KREDITOREN_VON);

		Integer iiKontoKreditorenVon = (Integer) parametermandantDto.getCWertAsObject();

		parametermandantDto = DelegateFactory.getInstance().getParameterDelegate().getMandantparameter(
				LPMain.getTheClient().getMandant(), ParameterFac.KATEGORIE_LIEFERANT,
				ParameterFac.PARAMETER_KREDITOREN_BIS);

		Integer iiKontoKreditorenBis = (Integer) parametermandantDto.getCWertAsObject();

		wlaKontokreditorenRangeVonBis.setText(iiKontoKreditorenVon + " - " + iiKontoKreditorenBis);

		wtnfKontokreditoren.setMinimumValue(new Integer(iiKontoKreditorenVon.intValue()));
		wtnfKontokreditoren.setMaximumValue(new Integer(iiKontoKreditorenBis.intValue()));
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI) throws Throwable {
		...
		if (!bNeedNoYouAreSelectedI) {
			...
			getInternalFrameLieferant().setLieferantDto(
					DelegateFactory.getInstance().getLieferantDelegate().lieferantFindByPrimaryKey((Integer) key));
			initPanel();
			dto2Components();
			getInternalFrame().setLpTitle(InternalFrame.TITLE_IDX_AS_I_LIKE,
					getLieferantDto().getPartnerDto().formatFixTitelName1Name2());
			setStatusbarModification(getLieferantDto());
//			setStatusbar();
		}
	}
...
//	}
	...
	public void eventActionSave(ActionEvent e, boolean bNeedNoSaveI) throws Throwable {
		...
		if (allMandatoryFieldsSetDlg()) {
			...
			// PJ 16695
			if ((getLieferantDto().getCFreigabe() != null && getLieferantDto().getTFreigabe() == null)
					|| (getLieferantDto().getCFreigabe() == null && getLieferantDto().getTFreigabe() != null)) {
				DialogFactory.showModalDialog(LPMain.getTextRespectUISPr("lp.error"),
						LPMain.getTextRespectUISPr("part.lieferant.freigabe.error"));
				return;
			}

			if (DelegateFactory.getInstance().getLieferantDelegate().pruefeObPreiseBeiWaehrungsaenderungVorhanden(
					getLieferantDto().getIId(), getLieferantDto().getWaehrungCNr())) {
				DialogFactory.showModalDialog(LPMain.getTextRespectUISPr("lp.hinweis"),
						LPMain.getTextRespectUISPr("lieferant.hinweis.waehrungsaenderung.artikellieferant"));
			}

			try {
				DelegateFactory.getInstance().getLieferantDelegate().updateLieferant(getLieferantDto());
			} catch (ExceptionLP efc) {
				int iJNC = -1;
				if (efc.getICode() == EJBExceptionLP.WARNUNG_KTO_BESETZT
						|| efc.getICode() == EJBExceptionLP.FEHLER_LIEFERANT_ABWEICHENDESUSTLAND_UNTERSCHIEDLICH) {
					String sMsg = "";
					...
					String sFSKonto[] = { LPMain.getTextRespectUISPr("part.lf.konto_besetzt_1"),
							LPMain.getTextRespectUISPr("part.lf.konto_besetzt_n") };
					if (startIndex == 0) {
						double limits[] = { 1, 2 };
						ChoiceFormat cf = new ChoiceFormat(limits, sFSKonto);
						sMsg = cf.format(efc.getAlInfoForTheClient().size() > 1 ? 2 : 1);
						sMsg = MessageFormat.format(sMsg, pattern);
					} else {
						sMsg = LPMain.getMessageTextRespectUISPr("part.lf.konto.unterschiedlichesUstland", sP);
					}
					iJNC = DialogFactory.showMeldung(sMsg, "", JOptionPane.YES_NO_CANCEL_OPTION);
				} else {
					throw efc;
				}
				if (iJNC == javax.swing.JOptionPane.YES_OPTION) {
					getLieferantDto().setUpdateModeKreditorenkonto(LieferantDto.I_UPD_KREDITORENKONTO_UPDATE);
					DelegateFactory.getInstance().getLieferantDelegate().updateLieferant(getLieferantDto());
	...
	void dialogQueryLagerFromListe(ActionEvent e) throws Throwable {
		panelQueryFLRLager = ArtikelFilterFactory.getInstance().createPanelFLRLager(getInternalFrame(),
				getLieferantDto().getPartnerDto().getLagerIIdZiellager(), true, false);
	...
	protected void eventItemchanged(EventObject eI) throws Exception, Throwable {
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			if (e.getSource() == panelQueryFLRKostenstelle) {
				...
				getLieferantDto().getPartnerDto().setLandIIdAbweichendesustland(landDto.getIID());
				wtfAbweichendesustland.setText(landDto.getCLkz());
			} else if (e.getSource() == panelQueryFLRLager) {
				Object key = ((ISourceEvent) e.getSource()).getIdSelected();
				LagerDto lagerDto = DelegateFactory.getInstance().getLagerDelegate()
						.lagerFindByPrimaryKey((Integer) key);
				if (wsfLager.getIKey() != null && wsfLager.getIKey().equals(lagerDto.getIId())) {
					...
					wtfZiellager.setText(lagerDto.getCNr());
					getLieferantDto().getPartnerDto().setLagerIIdZiellager(lagerDto.getIId());
				}
				...
				if (key != null) {
					...
					SpediteurDto s = DelegateFactory.getInstance().getMandantDelegate().spediteurFindByPrimaryKey(key);
				...
				if (key != null) {
					...
					KontoDto kontoDto = DelegateFactory.getInstance().getFinanzDelegate().kontoFindByPrimaryKey(key);
				...
				if (lieferadresseDto != null && lieferadresseDto.getIId() != null) {
					getLieferantDto().setPartnerIIdLieferadresse(lieferadresseDto.getIId());
					wtfLieferadresse.setText(lieferadresseDto.formatAnrede());
				}
			}
			...
			if (e.getSource() == panelQueryFLRAbweichendesustland) {
				wtfAbweichendesustland.setText(null);
				getLieferantDto().getPartnerDto().setLandIIdAbweichendesustland(null);
			} else if (e.getSource() == panelQueryFLRLager) {
				wtfZiellager.setText(null);
				...
				wtfLieferadresse.setText(null);
				getLieferantDto().setPartnerIIdLieferadresse(null);
			}
