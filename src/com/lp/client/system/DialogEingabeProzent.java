...
public class DialogEingabeProzent extends JDialog implements ActionListener {
	...
	private WrapperNumberField wnfProzent = null;
	...
	public DialogEingabeProzent() throws Throwable {
		...
		setTitle(LPMain.getInstance().getTextRespectUISPr("lp.prozentsatz.eingeben"));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(wbuSpeichern)) {
			try {
				if (wnfProzent.getBigDecimal() == null) {
				...
				prozent = wnfProzent.getBigDecimal();
	...
	private void jbInit() throws Exception {
		...
		wnfProzent = new WrapperNumberField();
		wnfProzent.setMandatoryField(true);
		...
		panel1.add(wlaTage, new GridBagConstraints(0, 3, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), 150, 0));
		panel1.add(wnfProzent, new GridBagConstraints(1, 3, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), 100, 0));
