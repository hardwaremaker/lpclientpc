...
public class PflegeAnsprechpartnerRechnungsadresse
		implements IPflegefunktion, ActionListener, ListSelectionListener, FocusListener {

	private static Logger logger = LpLogger.getLogger(PflegeAnsprechpartnerRechnungsadresse.class);
	...
	public String getName() {
		return "Ansprechpartner Rechungsadresse";
	}
	...
	public String getBeschreibung() {
		return "Bei folgenden Belegen sind die Ansprechpartner der Rechnungsadresse fehlerhaft zugeordnet:";
	}
	...
	public JPanel getPanel() {
		...
		exportieren = new JButton("Fehlerhaft zugeordnete Ansprechpartner bei Rechnungsadressen leeren.");
		...
		scrollResults = new JScrollPane(textResults, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		String listString;
		try {
			ArrayList<String> results = DelegateFactory.getInstance().getPflegeDelegate().sp9000(false);
		...
		actionMap = new HashMap<Component, PflegeAnsprechpartnerRechnungsadresse.Action>();
	...
	private class ActionExport implements Action {
		...
		public void doAction(EventObject event) {
			...
			try {
				ArrayList<String> results = DelegateFactory.getInstance().getPflegeDelegate().sp9000(true);

				textResults.setText("Aktion erfolgreich durchgefuehrt");

				DialogFactory.showModalDialog("Info", "Aktion erfolgreich durchgefuehrt");
			} catch (Throwable e) {
