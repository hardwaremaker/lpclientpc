...
public class PanelMandantKonditionen extends PanelBasis {
	...
	private WrapperCheckBox wcbPreislisteBeiNeukunden = null;
	...
	private WrapperButton wbuZahlungszielAnzahlung = null;
	private WrapperTextField wtfZahlungszielAnzahlung = null;
	private PanelQueryFLR panelQueryFLRZahlungszielAnzahlung = null;
	...
	static final private String ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_ANZAHLUNG = "action_special_flr_zahlungsziel_anzahlung";
	...
	public PanelMandantKonditionen(InternalFrame internalFrame, String add2TitleI, Object keyI) throws Throwable {
	...
	protected void eventItemchanged(EventObject eI) throws Throwable {
		...
		if (e.getID() == ItemChangedEvent.GOTO_DETAIL_PANEL) {
			...
			if (e.getSource() == panelQueryFLRLieferartKunde) {
				...
				LieferartDto lieferart2Dto = DelegateFactory.getInstance().getLocaleDelegate()
				...
				KostenstelleDto k = DelegateFactory.getInstance().getSystemDelegate().kostenstelleFindByPrimaryKey(iId);
				...
				ZahlungszielDto zahlungszielDto = DelegateFactory.getInstance().getMandantDelegate()
						.zahlungszielFindByPrimaryKey(getMandantDto().getZahlungszielIIdKunde());
//				wtfZahlungszielKunde.setText(zahlungszielDto.getCBez());
				dto2ComponentsZahlungsziel(zahlungszielDto, wtfZahlungszielKunde);
			}

			else if (e.getSource() == panelQueryFLRZahlungszielAnzahlung) {
				Integer iId = (Integer) ((ISourceEvent) e.getSource()).getIdSelected();

				getMandantDto().setZahlungszielIIdAnzahlung(iId);

				ZahlungszielDto zahlungszielDto = DelegateFactory.getInstance().getMandantDelegate()
						.zahlungszielFindByPrimaryKey(getMandantDto().getZahlungszielIIdAnzahlung());
				wtfZahlungszielAnzahlung.setText(zahlungszielDto.getCBez());
				dto2ComponentsZahlungsziel(zahlungszielDto, wtfZahlungszielAnzahlung);
			}
				...
				ZahlungszielDto zahlungszielDto = DelegateFactory.getInstance().getMandantDelegate()
						.zahlungszielFindByPrimaryKey(getMandantDto().getZahlungszielIIdLF());
//				wtfZahlungszielLF.setText(zahlungszielDto.getCBez());
				dto2ComponentsZahlungsziel(zahlungszielDto, wtfZahlungszielLF);
			} else if (e.getSource() == panelQueryFLRMWSTSatz) {
				Integer iId = (Integer) ((ISourceEvent) e.getSource()).getIdSelected();
				MwstsatzbezDto mwstbezDto = DelegateFactory.getInstance().getMandantDelegate()
						.mwstsatzbezFindByPrimaryKey(iId);
				...
				if (key != null) {
					...
					wtfBankverbindungNummer.setText(getBankverbindungText(bankverbindungDto));
					PartnerDto partner = DelegateFactory.getInstance().getPartnerDelegate()
							.partnerFindByPrimaryKey(bankverbindungDto.getBankIId());
					wtfBankverbindungBezeichnung.setText(partner.formatFixTitelName1Name2());
				}
			...
			if (e.getSource() == panelQueryFLRBank) {
				...
				getMandantDto().setMwstsatzbezIIdStandarddrittlandmwstsatz(null);
				wtfMWSTSatzDrittland.setText(null);
			} else if (e.getSource() == panelQueryFLRMWSTSatz) {
				getMandantDto().setMwstsatzbezIIdStandardinlandmwstsatz(null);
				wtfMWSTSatz.setText(null);
			} else if (e.getSource() == panelQueryFLRZahlungszielAnzahlung) {
				getMandantDto().setZahlungszielIIdAnzahlung(null);
				wtfZahlungszielAnzahlung.setText(null);
			}
		}
	}

	private void dto2ComponentsZahlungsziel(ZahlungszielDto zahlungszielDto, WrapperTextField wrapperTextField) {
		if (zahlungszielDto != null) {
			if (zahlungszielDto.getZahlungszielsprDto() != null) {
				wrapperTextField.setText(zahlungszielDto.getZahlungszielsprDto().getCBezeichnung());
			} else {
				wrapperTextField.setText(zahlungszielDto.getCBez());
			}
		} else {
	...
	private void dialogQueryBank(ActionEvent e) throws Throwable {
		...
		panelQueryFLRBank = FinanzFilterFactory.getInstance().createPanelFLRBankverbindung(getInternalFrame(), false,
				true);
		if (getMandantDto().getIBankverbindung() != null) {
			panelQueryFLRBank.setSelectedId(getMandantDto().getIBankverbindung());
		}
	...
	private void jbInit() throws Throwable {
		...
		wsfVerrechnungsmodell = new WrapperSelectField(WrapperSelectField.VERRECHNUNGSMODELL, getInternalFrame(), true);

		wlaMandant = new WrapperLabel(LPMain.getTextRespectUISPr("lp.mandant"));
		...
		wlaKurzbez = new WrapperLabel(LPMain.getTextRespectUISPr("lp.mandantbezeichnung"));
		wtfKurzbez.setMandatoryFieldDB(true);

		wlaIstHauptmandant = new WrapperLabel(LPMain.getTextRespectUISPr("part.ist_hautpmandant"));
		wcbIstHauptmandant = new WrapperCheckBox();
		
		
		wcbPreislisteBeiNeukunden = new WrapperCheckBox(LPMain.getTextRespectUISPr("lp.mandant.preisliste.fuerneukunden"));

		getInternalFrame().addItemChangedListener(this);

		wbuLieferartKunde = new WrapperButton();
		wbuLieferartKunde.setText(LPMain.getTextRespectUISPr("button.lieferart"));
		...
		wbuLieferartLF.setText(LPMain.getTextRespectUISPr("button.lieferart"));
		...
		wbuSpediteurKunde.setText(LPMain.getTextRespectUISPr("button.spediteur"));
		...
		wbuSpediteurLF.setText(LPMain.getTextRespectUISPr("button.spediteur"));
		...
		wbuZahlungszielKunde.setText(LPMain.getTextRespectUISPr("button.zahlungsziel"));
		wbuZahlungszielKunde.setActionCommand(ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_KUNDE);
		...
		wbuZahlungszielAnzahlung = new WrapperButton();
		wbuZahlungszielAnzahlung.setText(LPMain.getTextRespectUISPr("button.zahlungsziel.anzahlung"));
		wbuZahlungszielAnzahlung.setToolTipText(LPMain.getTextRespectUISPr("button.zahlungsziel.anzahlung.tooltip"));
		wbuZahlungszielAnzahlung.setActionCommand(ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_ANZAHLUNG);
		wbuZahlungszielAnzahlung.addActionListener(this);
		wtfZahlungszielAnzahlung = new WrapperTextField();
		wtfZahlungszielAnzahlung.setActivatable(false);

		wbuZahlungszielLF = new WrapperButton();
		wbuZahlungszielLF.setText(LPMain.getTextRespectUISPr("button.zahlungsziel"));
		...
		wbuPreislisteFLR.setText(LPMain.getTextRespectUISPr("vkpf.button.preislisten"));
		...
		wbuKostenstelleFLR.setText(LPMain.getTextRespectUISPr("button.kostenstelle"));
		...
		wtfKostenstelleKunde = new WrapperTextField(SystemFac.MAX_KOSTENSTELLE_CNR);
		wtfKostenstelleKunde.setActivatable(false);
		wtfKostenstelleKunde.setMandatoryField(true);

		wbuMWSTSatz = new WrapperButton();
		wbuMWSTSatz.setText(LPMain.getTextRespectUISPr("button.mwstsatz"));
		...
		wbuMWSTSatzAusland.setText(LPMain.getTextRespectUISPr("button.mwstsatzausland"));
		...
		wbuMWSTSatzDrittland.setText(LPMain.getTextRespectUISPr("button.mwstsatzdrittland"));
		wbuMWSTSatzDrittland.setActionCommand(ACTION_SPECIAL_FLR_MWSTSATZDRITTLAND);
		...
		wbuBankverbindung.setText(LPMain.getTextRespectUISPr("button.bankverbindung"));
		...
		wlaKundenvorbelegungen = new WrapperLabel(LPMain.getTextRespectUISPr("part.kund.vorbelegungen"));
		wlaLFvorbelegungen = new WrapperLabel(LPMain.getTextRespectUISPr("part.lief.vorbelegungen"));

		wlaVorbelegungen = new WrapperLabel(LPMain.getTextRespectUISPr("syst.vorbelegungen.allgemein"));

		// ab hier einhaengen.

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaMandant, new GridBagConstraints(0, iZeile, 1, 1, 0.3, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfMandant, new GridBagConstraints(1, iZeile, 1, 1, 0.3, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		...
		jpaWorkingOn.add(new WrapperLabel(), new GridBagConstraints(3, iZeile, 1, 1, 0.3, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(new WrapperLabel(), new GridBagConstraints(4, iZeile, 1, 1, 0.1, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));

		jpaWorkingOn.add(wlaIstHauptmandant, new GridBagConstraints(3, iZeile, 1, 1, 0.3, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wcbIstHauptmandant, new GridBagConstraints(4, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 10, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaKurzbez, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfKurzbez, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		// iZeile++;
		...
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaVorbelegungen, new GridBagConstraints(0, iZeile, 1, 1, 0.3, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile
		iZeile++;
		jpaWorkingOn.add(wbuLieferadresse, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfLieferadresse, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuMWSTSatz, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfMWSTSatz, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuMWSTSatzAusland, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfMWSTSatzAusland, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuMWSTSatzDrittland, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfMWSTSatzDrittland, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile
		iZeile++;
		jpaWorkingOn.add(wbuBankverbindung, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfBankverbindungNummer, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wtfBankverbindungBezeichnung, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wlaKundenvorbelegungen, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuLieferartKunde, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfLieferartKunde, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuSpediteurKunde, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfSpediteurKunde, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuZahlungszielKunde, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfZahlungszielKunde, new GridBagConstraints(1, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));

		jpaWorkingOn.add(wbuZahlungszielAnzahlung, new GridBagConstraints(2, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 100, 0));
		jpaWorkingOn.add(wtfZahlungszielAnzahlung, new GridBagConstraints(3, iZeile, 1, 1, 0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));

		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuPreislisteFLR, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfPreisliste, new GridBagConstraints(1, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));

		jpaWorkingOn.add(wcbPreislisteBeiNeukunden, new GridBagConstraints(2, iZeile, 2, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 100, 0));
		
		iZeile++;
		
		jpaWorkingOn.add(wbuKostenstelleFLR, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfKostenstelleKunde, new GridBagConstraints(1, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		...
		if (LPMain.getInstance().getDesktop()
			...
			iZeile++;
			jpaWorkingOn.add(wsfVerrechnungsmodell.getWrapperButton(), new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 2, 2, 2), 0, 0));
			jpaWorkingOn.add(wsfVerrechnungsmodell.getWrapperTextField(), new GridBagConstraints(1, iZeile, 3, 1, 0,
					0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
			// Zeile.
		}
		iZeile++;
		jpaWorkingOn.add(wlaLFvorbelegungen, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuLieferartLF, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wtfLieferartLF, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuSpediteurLF, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfSpediteurLF, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		// Zeile.
		iZeile++;
		jpaWorkingOn.add(wbuZahlungszielLF, new GridBagConstraints(0, iZeile, 1, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
		jpaWorkingOn.add(wtfZahlungszielLF, new GridBagConstraints(1, iZeile, 3, 1, 0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(1, 2, 1, 2), 0, 0));
	...
	protected void dto2Components() throws Throwable {
		...
		if (getMandantDto().getMwstsatzbezIIdStandardinlandmwstsatz() != null) {
			MwstsatzbezDto mwstbezDto = DelegateFactory.getInstance().getMandantDelegate()
					.mwstsatzbezFindByPrimaryKey(getMandantDto().getMwstsatzbezIIdStandardinlandmwstsatz());
			wtfMWSTSatz.setText(mwstbezDto.getCBezeichnung());
		} else {
			wtfMWSTSatz.setText(null);
		}
		...
		if (getMandantDto().getMwstsatzbezIIdStandardauslandmwstsatz() != null) {
			MwstsatzbezDto mwstbezDto = DelegateFactory.getInstance().getMandantDelegate()
					.mwstsatzbezFindByPrimaryKey(getMandantDto().getMwstsatzbezIIdStandardauslandmwstsatz());
			wtfMWSTSatzAusland.setText(mwstbezDto.getCBezeichnung());
		} else {
			wtfMWSTSatzAusland.setText(null);
		}
		...
		if (getMandantDto().getMwstsatzbezIIdStandarddrittlandmwstsatz() != null) {
			MwstsatzbezDto mwstbezDto = DelegateFactory.getInstance().getMandantDelegate()
					.mwstsatzbezFindByPrimaryKey(getMandantDto().getMwstsatzbezIIdStandarddrittlandmwstsatz());
			wtfMWSTSatzDrittland.setText(mwstbezDto.getCBezeichnung());
		} else {
			wtfMWSTSatzDrittland.setText(null);
		}
		...
		if (getMandantDto().getIBankverbindung() != null) {
			BankverbindungDto bankverbindungDto = DelegateFactory.getInstance().getFinanzDelegate()
					.bankverbindungFindByPrimaryKey(getMandantDto().getIBankverbindung());
			BankverbindungFormatter bvFormatter = new BankverbindungFormatter();
			wtfBankverbindungNummer.setText(bvFormatter.formatNummerFuerTextfeldEinerAuswahl(bankverbindungDto));
			PartnerDto partner = DelegateFactory.getInstance().getPartnerDelegate()
					.partnerFindByPrimaryKey(bankverbindungDto.getBankIId());
			wtfBankverbindungBezeichnung.setText(partner.formatFixTitelName1Name2());
		} else {
		...
		if (getMandantDto().getPartnerIIdLieferadresse() != null) {
			PartnerDto partnerDto = DelegateFactory.getInstance().getPartnerDelegate()
					.partnerFindByPrimaryKey(getMandantDto().getPartnerIIdLieferadresse());
			wtfLieferadresse.setText(partnerDto.formatAnrede());
		}

		boolean bIsHauptmandant = getMandantDto().getCNr()
				.equals(getMandantDto().getAnwenderDto().getMandantCNrHauptmandant());
		...
		if (getMandantDto().getLieferartIIdKunde() != null) {
			LieferartDto lieferart2Dto = DelegateFactory.getInstance().getLocaleDelegate()
					.lieferartFindByPrimaryKey(getMandantDto().getLieferartIIdKunde());
		...
		if (getMandantDto().getLieferartIIdLF() != null) {
			LieferartDto lieferart2Dto = DelegateFactory.getInstance().getLocaleDelegate()
					.lieferartFindByPrimaryKey(getMandantDto().getLieferartIIdLF());
			sLieferart = lieferart2Dto.getCNr();
		}
		...
		if (getMandantDto().getSpediteurIIdKunde() != null) {
			SpediteurDto spediteurDto = DelegateFactory.getInstance().getMandantDelegate()
					.spediteurFindByPrimaryKey(getMandantDto().getSpediteurIIdKunde());
		...
		if (getMandantDto().getSpediteurIIdLF() != null) {
			SpediteurDto spediteurDto = DelegateFactory.getInstance().getMandantDelegate()
					.spediteurFindByPrimaryKey(getMandantDto().getSpediteurIIdLF());
			sSpediteur = spediteurDto.getCNamedesspediteurs();
		}
...
//			}
		...
		if (getMandantDto().getZahlungszielIIdAnzahlung() != null) {
			ZahlungszielDto zahlungszielDto = DelegateFactory.getInstance().getMandantDelegate()
					.zahlungszielFindByPrimaryKey(getMandantDto().getZahlungszielIIdAnzahlung());
			dto2ComponentsZahlungsziel(zahlungszielDto, wtfZahlungszielAnzahlung);
		} else {
...
//			}
		...
		if (getMandantDto().getIIdKostenstelle() != null) {
			kos = DelegateFactory.getInstance().getSystemDelegate()
					.kostenstelleFindByPrimaryKey(getMandantDto().getIIdKostenstelle()).getCNr();
		}
		wtfKostenstelleKunde.setText(kos);

		wsfVerrechnungsmodell.setKey(getMandantDto().getVerrechnungsmodellIId());
		
		wcbPreislisteBeiNeukunden.setShort(getMandantDto().getBPreislisteFuerNeukunde());

	}

	protected void components2Dto() throws Throwable {

		getMandantDto().setBPreislisteFuerNeukunde(wcbPreislisteBeiNeukunden.getShort());
		
		getMandantDto().setVerrechnungsmodellIId(wsfVerrechnungsmodell.getIKey());

		getMandantDto().setCKbez(wtfKurzbez.getText());

		getMandantDto().setCNr(wtfMandant.getText());

		getMandantDto().getAnwenderDto().setIId(new Integer(SystemFac.PK_HAUPTMANDANT_IN_LP_ANWENDER));
		...
		if (Helper.short2boolean(wcbIstHauptmandant.getShort()) == true) {
			...
			DelegateFactory.getInstance().getSystemDelegate().updateAnwender(anwenderDto);
		}
	...
	public void eventYouAreSelected(boolean bNeedNoYouAreSelectedI) throws Throwable {
		...
		this.checkMandantLoggedInEqualsMandantSelected(LPMain.getTheClient().getMandant(), getMandantDto().getCNr());
	...
	protected void eventActionUpdate(ActionEvent aE, boolean bNeedNoUpdateI) throws Throwable {
		...
		if (DelegateFactory.getInstance().getTheJudgeDelegate().hatRecht(RechteFac.RECHT_LP_HAUPTMANDANT_U)) {
	...
	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_LIEFERART_KUNDE)) {
			panelQueryFLRLieferartKunde = SystemFilterFactory.getInstance().createPanelFLRLieferart(getInternalFrame(),
					getMandantDto().getLieferartIIdKunde(), getMandantDto().getCNr());
			new DialogQuery(panelQueryFLRLieferartKunde);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_LIEFERART_LF)) {
			panelQueryFLRLieferartLF = SystemFilterFactory.getInstance().createPanelFLRLieferart(getInternalFrame(),
					getMandantDto().getLieferartIIdLF(), getMandantDto().getCNr());
			new DialogQuery(panelQueryFLRLieferartLF);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_SPEDITEUR_KUNDE)) {
			panelQueryFLRSpediteurKunde = SystemFilterFactory.getInstance().createPanelFLRSpediteur(getInternalFrame(),
					getMandantDto().getSpediteurIIdKunde(), getMandantDto().getCNr());
			new DialogQuery(panelQueryFLRSpediteurKunde);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_SPEDITEUR_LF)) {
			panelQueryFLRSpediteurLF = SystemFilterFactory.getInstance().createPanelFLRSpediteur(getInternalFrame(),
					getMandantDto().getSpediteurIIdLF(), getMandantDto().getCNr());
			new DialogQuery(panelQueryFLRSpediteurLF);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_KUNDE)) {
			panelQueryFLRZahlungszielKunde = SystemFilterFactory.getInstance().createPanelFLRZahlungsziel(
					getInternalFrame(), getMandantDto().getZahlungszielIIdKunde(), getMandantDto().getCNr());
			new DialogQuery(panelQueryFLRZahlungszielKunde);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_ANZAHLUNG)) {
			panelQueryFLRZahlungszielAnzahlung = SystemFilterFactory.getInstance().createPanelFLRZahlungsziel(
					getInternalFrame(), getMandantDto().getZahlungszielIIdAnzahlung(), getMandantDto().getCNr(), true);
			new DialogQuery(panelQueryFLRZahlungszielAnzahlung);
		}

		else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_ZAHLUNGSZIEL_LF)) {
			panelQueryFLRZahlungszielLF = SystemFilterFactory.getInstance().createPanelFLRZahlungsziel(
					getInternalFrame(), getMandantDto().getZahlungszielIIdLF(), getMandantDto().getCNr());
			...
			if (getMandantDto().getIIdKostenstelle() != null) {
				panelQueryFLRKostenstelle.setSelectedId(getMandantDto().getIIdKostenstelle());
			}
			...
			panelQueryFLRPreislisten = new PanelQueryFLR(querytypes, filters, QueryParameters.UC_ID_PREISLISTENNAME,
					aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("vkpf.preislisten.title.tab"));
			if (getMandantDto().getVkpfArtikelpreislisteIId() != null) {
				panelQueryFLRPreislisten.setSelectedId(getMandantDto().getVkpfArtikelpreislisteIId());
			}
			...
			QueryType[] querytypes = null;
			FilterKriterium[] filters = SystemFilterFactory.getInstance().createFKMandantCNr();
			panelQueryFLRMWSTSatz = new PanelQueryFLR(querytypes, filters, QueryParameters.UC_ID_MWSTSATZBEZ,
					aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("label.mwstsatz"));
			if (getMandantDto().getMwstsatzbezIIdStandardinlandmwstsatz() != null) {
				panelQueryFLRMWSTSatz.setSelectedId(getMandantDto().getMwstsatzbezIIdStandardinlandmwstsatz());
			}
			new DialogQuery(panelQueryFLRMWSTSatz);
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_MWSTSATZAUSLAND)) {
			String[] aWhichButtonIUse = new String[] { PanelBasis.ACTION_LEEREN };
			QueryType[] querytypes = null;
			FilterKriterium[] filters = SystemFilterFactory.getInstance().createFKMandantCNr();
			panelQueryFLRMWSTSatzAusland = new PanelQueryFLR(querytypes, filters, QueryParameters.UC_ID_MWSTSATZBEZ,
					aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("button.mwstsatzausland"));
			if (getMandantDto().getMwstsatzbezIIdStandardauslandmwstsatz() != null) {
				panelQueryFLRMWSTSatzAusland.setSelectedId(getMandantDto().getMwstsatzbezIIdStandardauslandmwstsatz());
			}
			new DialogQuery(panelQueryFLRMWSTSatzAusland);
		} else if (e.getActionCommand().equals(ACTION_SPECIAL_FLR_MWSTSATZDRITTLAND)) {
			String[] aWhichButtonIUse = new String[] { PanelBasis.ACTION_LEEREN };
			QueryType[] querytypes = null;
			FilterKriterium[] filters = SystemFilterFactory.getInstance().createFKMandantCNr();
			panelQueryFLRMWSTSatzDrittland = new PanelQueryFLR(querytypes, filters, QueryParameters.UC_ID_MWSTSATZBEZ,
					aWhichButtonIUse, getInternalFrame(), LPMain.getTextRespectUISPr("button.mwstsatzdrittland"));
			if (getMandantDto().getMwstsatzbezIIdStandarddrittlandmwstsatz() != null) {
				panelQueryFLRMWSTSatzDrittland
						.setSelectedId(getMandantDto().getMwstsatzbezIIdStandarddrittlandmwstsatz());
			}
			...
			if (getMandantDto().getPartnerIIdLieferadresse() != null) {
				panelQueryLieferadresse.setSelectedId(getMandantDto().getPartnerIIdLieferadresse());
			}
		}
	...
	private void setWtfPreisliste(Integer keyPreisliste) throws Throwable {
		...
		if (keyPreisliste != null) {
			VkpfartikelpreislisteDto vkpfartikelpreislisteDto = DelegateFactory.getInstance()
					.getVkPreisfindungDelegate().vkpfartikelpreislisteFindByPrimaryKey(keyPreisliste);
	...
	private void checkMandantLoggedInEqualsMandantSelected(String loggedinMandant, String selectedMandant)
		...
		if (!loggedinMandant.equals(selectedMandant)) {
			...
			getPanelStatusbar().setLockField(LPMain.getTextRespectUISPr("system.nurleserecht"));
		}
	}
	...
	private void dialogQueryLieferadresse() throws Throwable {
		...
		panelQueryLieferadresse = new PanelQueryFLR(null, null, QueryParameters.UC_ID_PARTNER, aWhichButtonIUse,
				getInternalFrame(), LPMain.getTextRespectUISPr("bes.title.lieferadresseauswahlliste"));

		panelQueryLieferadresse.befuellePanelFilterkriterienDirekt(
	...
	private String getBankverbindungText(BankverbindungDto bankverbindungDto) {
		if (bankverbindungDto == null)
			return null;
		return bankverbindungDto.getCIban() != null ? bankverbindungDto.getCIban()
