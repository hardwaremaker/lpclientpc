...
public class PanelAutoJobMonatsabrechnungversand implements IPanelAutoJobDetails {

	private AutoJobMonatsabrechnungversandCtrl panelCtrl;
	...
	public PanelAutoJobMonatsabrechnungversand(AutoJobMonatsabrechnungversandCtrl panelCtrl) {
		setPanelCtrl(panelCtrl);
	}

	public void setPanelCtrl(AutoJobMonatsabrechnungversandCtrl panelCtrl) {
		this.panelCtrl = panelCtrl;
	}

	public AutoJobMonatsabrechnungversandCtrl getPanelCtrl() {
		return panelCtrl;
	}
