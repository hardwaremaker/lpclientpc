...
public class PanelAutoJobWEJournal implements IPanelAutoJobDetails {

	private IAutoJobDetailsPanelCtrl<JobDetailsWEJournalDto> ctrl;
	...
	public PanelAutoJobWEJournal(IAutoJobDetailsPanelCtrl<JobDetailsWEJournalDto> ctrl) {
		setPanelCtrl(ctrl);
	}

	public void setPanelCtrl(IAutoJobDetailsPanelCtrl<JobDetailsWEJournalDto> ctrl) {
		this.ctrl = ctrl;
	}
	
	public IAutoJobDetailsPanelCtrl<JobDetailsWEJournalDto> getPanelCtrl() {
		return ctrl;
	}
