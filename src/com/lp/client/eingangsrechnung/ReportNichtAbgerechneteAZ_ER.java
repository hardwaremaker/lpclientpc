...
public class ReportNichtAbgerechneteAZ_ER extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportNichtAbgerechneteAZ_ER(TabbedPaneEingangsrechnung tabbedPaneEingangsrechnung, String add2Title)
			throws Throwable {
	...
	private void jbInit() throws Throwable {
		...
		wdfStichtag.setDate(new java.util.Date());
		// wegen dialogFLR
		getInternalFrame().addItemChangedListener(this);

		jpaWorkingOn.add(wlaStichtag, new GridBagConstraints(0, iZeile, 1, 1, 0.2, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
		jpaWorkingOn.add(wdfStichtag, new GridBagConstraints(1, iZeile, 1, 1, 0.8, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(2, 2, 2, 2), 0, 0));
	...
	public String getReportname() {
		return EingangsrechnungReportFac.REPORT_EINGANGSRECHNUNG_NICHT_ABGERECHNETE_ANZAHLUNGEN;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getEingangsrechnungDelegate()
				.printNichtabgerechneteAnzahlungen(wdfStichtag.getDate());
	}
