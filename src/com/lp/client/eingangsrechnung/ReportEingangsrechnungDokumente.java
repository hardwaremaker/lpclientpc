...
public class ReportEingangsrechnungDokumente extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportEingangsrechnungDokumente(TabbedPaneEingangsrechnung tabbedPaneEingangsrechnung, String add2Title)
			throws Throwable {
	...
	public String getReportname() {
		return EingangsrechnungReportFac.REPORT_EINGANGSRECHNUNG_DOKUMENTE;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getEingangsrechnungDelegate()
				.printDokumente(tabbedPaneEingangsrechnung.getEingangsrechnungDto().getIId());
	}
