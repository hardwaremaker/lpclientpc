...
public interface IVendidataImportController<T> {
	...
	public T importXML(String xmlContent, boolean checkOnly);
	
	public T importXMLFile(File file) throws FileNotFoundException, IOException;
	
	public T importXMLFile(String filename) throws FileNotFoundException, IOException;
}
