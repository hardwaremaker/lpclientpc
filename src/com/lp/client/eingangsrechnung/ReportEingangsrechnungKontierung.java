...
public class ReportEingangsrechnungKontierung extends PanelBasis implements PanelReportIfJRDS, PropertyChangeListener {

	private static final long serialVersionUID = -1903408096481980811L;

	private final static String ACTION_SPECIAL_KOSTENSTELLE_ALLE = "action_special_kostenstelle_alle";
	private final static String ACTION_SPECIAL_KOSTENSTELLE_EINE = "action_special_kostenstelle_eine";
	private final static String ACTION_SPECIAL_KOSTENSTELLE_AUSWAHL = "action_special_kostenstelle_auswahl";
	...
	private JLabel wlaKostenstellen = new JLabel();
	...
	private JLabel wlaEr = new JLabel();
	...
	/*
	 * private void jbInit() throws Throwable { border1 =
	 * BorderFactory.createEmptyBorder(10, 10, 10, 10);
	 * this.setLayout(gridBagLayout1); wlaEr.setText("Eingangsrechnungen");
	 * wlaEr.setMinimumSize(new Dimension(100,
	 * Defaults.getInstance().getControlHeight())); wlaEr.setPreferredSize(new
	 * Dimension(100, Defaults.getInstance().getControlHeight()));
	 * wrbErAlle.setText("Alle"); wrbErBezahlte.setText("Bezahlte");
	 * wrbErOffene.setText("Offene"); wlaDatum.setText("Auswertung nach");
	 ...
	 * "button.kostenstelle.tooltip")); wrbKostenstelleAlle.setMinimumSize(new
	 * Dimension(BREITE_SPALTE2, Defaults.getInstance().getControlHeight()));
	 ...
	 * wrbKostenstelleAlle.setSelected(true);
	 * wrbKostenstelleAlle.setText("Alle"); wrbKostenstelleEine.setText("Eine");
	 * wlaVon.setText("Von"); wlaBis.setText("Bis");
	 * wrbKostenstelleAlle.setMinimumSize(new Dimension(50,
	 * Defaults.getInstance().getControlHeight()));
	 * wrbKostenstelleAlle.setPreferredSize(new Dimension(50,
	 * Defaults.getInstance().getControlHeight())); wlaVon.setMinimumSize(new
	 * Dimension(25, Defaults.getInstance().getControlHeight()));
	 * wlaVon.setPreferredSize(new Dimension(25,
	 * Defaults.getInstance().getControlHeight())); wlaBis.setMinimumSize(new
	 * Dimension(25, Defaults.getInstance().getControlHeight()));
	 * wlaBis.setPreferredSize(new Dimension(25,
	 * Defaults.getInstance().getControlHeight()));
	 ...
	 *
	 * wdfVon.setMandatoryField(true); wdfBis.setMandatoryField(true);
	 *
	 * wdfVon.getDisplay().addPropertyChangeListener(this);
	 * wdfBis.getDisplay().addPropertyChangeListener(this); wdrBereich = new
	 * WrapperDateRangeController(wdfVon, wdfBis);
	 *
	 * //wegen dialogFLR getInternalFrame().addItemChangedListener(this);
	 *
	 * this.add(jpaWorkingOn, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0,
	 * GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0),
	 * 0, 0)); jpaWorkingOn.add(wlaEr, new GridBagConstraints(0, iZeile, 1, 1,
	 * 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2,
	 * 2, 2, 2), 0, 0)); jpaWorkingOn.add(wrbErOffene, new GridBagConstraints(1,
	 * iZeile, 4, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
	 * new Insets(2, 2, 2, 2), 0, 0)); iZeile++; jpaWorkingOn.add(wrbErBezahlte,
	 * new GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0,
	 * GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2),
	 * 0, 0)); iZeile++; jpaWorkingOn.add(wrbErAlle, new GridBagConstraints(1,
	 * iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
	 * new Insets(2, 2, 2, 2), 0, 0)); iZeile++;
	 * jpaWorkingOn.add(wlaKostenstellen, new GridBagConstraints(0, iZeile, 1,
	 * 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new
	 * Insets(2, 2, 2, 2), 0, 0)); jpaWorkingOn.add(wrbKostenstelleAlle, new
	 * GridBagConstraints(1, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
	 * GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0)); iZeile++;
	 * jpaWorkingOn.add(wrbKostenstelleEine, new GridBagConstraints(1, iZeile,
	 * 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new
	 * Insets(2, 2, 2, 2), 0, 0)); jpaWorkingOn.add(wbuKostenstelle, new
	 * GridBagConstraints(2, iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST,
	 * GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	 * jpaWorkingOn.add(wtfKostenstelleNummer, new GridBagConstraints(3, iZeile,
	 * 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new
	 * Insets(2, 2, 2, 2), 0, 0)); jpaWorkingOn.add(wtfKostenstelleBezeichnung,
	 * new GridBagConstraints(4, iZeile, 1, 1, 1.0, 0.0,
	 * GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2),
	 * 0, 0)); iZeile++; jpaWorkingOn.add(wlaDatum, new GridBagConstraints(0,
	 * iZeile, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH,
	 * new Insets(2, 2, 2, 2), 0, 0)); jpaWorkingOn.add(wrbRechnungsdatum, new
	 * GridBagConstraints(1, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
	 * GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0)); iZeile++;
	 * jpaWorkingOn.add(wrbFreigabedatum, new GridBagConstraints(1, iZeile, 4,
	 * 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new
	 * Insets(2, 2, 2, 2), 0, 0)); iZeile++; JPanel jpaDatum = new JPanel(new
	 * GridBagLayout());
	 *
	 * jpaDatum.add(wlaVon, new GridBagConstraints(0, iZeile, 1, 1, 0.0, 0.0,
	 * GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2, 2, 2),
	 * 0, 0)); jpaDatum.add(wdfVon, new GridBagConstraints(1, iZeile, 1, 1, 1.0,
	 * 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(2, 2,
	 * 2, 2), 0, 0)); jpaDatum.add(wlaBis, new GridBagConstraints(2, iZeile, 1,
	 * 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new
	 * Insets(2, 2, 2, 2), 0, 0)); jpaDatum.add(wdfBis, new
	 * GridBagConstraints(3, iZeile, 1, 1, 1.0, 0.0, GridBagConstraints.WEST,
	 * GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0));
	 * jpaDatum.add(wdrBereich, new GridBagConstraints(4, iZeile, 1, 1, 0.0,
	 * 0.0, GridBagConstraints.CENTER, GridBagConstraints.VERTICAL, new
	 * Insets(2, 2, 2, 2), 0, 0)); jpaWorkingOn.add(jpaDatum, new
	 * GridBagConstraints(0, iZeile, 4, 1, 0.0, 0.0, GridBagConstraints.WEST,
	 * GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 0, 0)); iZeile++;
	 *
	 *
	...
	private void jbInit() throws Throwable {
		...
		wlaEr.setText(LPMain.getTextRespectUISPr("er.eingangsrechnung"));

		wrbErOffene.setText(LPMain.getTextRespectUISPr("lp.offene"));
		wrbErBezahlte.setText(LPMain.getTextRespectUISPr("lp.bezahlte"));
		wrbErAlle.setText(LPMain.getTextRespectUISPr("lp.alle"));

		wlaDatum.setText(LPMain.getTextRespectUISPr("er.journal.alle.auswertungnach"));
		wrbRechnungsdatum.setText(LPMain.getTextRespectUISPr("er.rechnung.datum"));
		wrbFreigabedatum.setText(LPMain.getTextRespectUISPrWithNull("er.journal.alle.freigabedatum"));

		wlaKostenstellen.setText(LPMain.getTextRespectUISPr("label.kostenstelle"));
		wrbKostenstelleAlle.setText(LPMain.getTextRespectUISPr("lp.alle"));
		wrbKostenstelleEine.setText(LPMain.getTextRespectUISPr("lp.eine"));
		...
		panelDateRange.getWdfVon().addPropertyChangeListener(this);
		panelDateRange.getWdfBis().addPropertyChangeListener(this);
		...
		hvLayout
			.addAligned(Align.RIGHT, wlaEr)
			.add(wrbErOffene)
			.add(wrbErBezahlte)
			.add(wrbErAlle).wrap();

		hvLayout
			.addAligned(Align.RIGHT, wlaKostenstellen)
			.add(wrbKostenstelleAlle)
			.add(wrbKostenstelleEine)
			.add(wtfKostenstelleNummer, 90)
			.add(wtfKostenstelleBezeichnung, 150).wrap();

		hvLayout
			.addAligned(Align.RIGHT, wlaDatum)
			.add(wrbRechnungsdatum)
			.add(wrbFreigabedatum)
			.add(panelDateRange).span(2);
	}

	protected void eventActionSpecial(ActionEvent e) throws Throwable {
		if (e.getActionCommand().equals(ReportEingangsrechnungKontierung.ACTION_SPECIAL_KOSTENSTELLE_ALLE)) {
			setVisibilityKostenstelle(true);
		} else if (e.getActionCommand().equals(ReportEingangsrechnungKontierung.ACTION_SPECIAL_KOSTENSTELLE_EINE)) {
...
//			}
		} else if (e.getActionCommand().equals(ReportEingangsrechnungKontierung.ACTION_SPECIAL_KOSTENSTELLE_AUSWAHL)) {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if (evt.getSource() == panelDateRange.getWdfVon().getDisplay() && evt.getPropertyName().equals("date")) {
			panelDateRange.getWdfBis().setMinimumValue(panelDateRange.getWdfVon().getDate());
		} else if (evt.getSource() == panelDateRange.getWdfBis().getDisplay() && evt.getPropertyName().equals("date")) {
			panelDateRange.getWdfVon().setMaximumValue(panelDateRange.getWdfBis().getDate());
		}
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		// return
		// DelegateFactory.getInstance().getEingangsrechnungDelegate().printKontierungsjournal(
		// iFilter, kostenstelleIId, iKritDatum, wdfVon.getDate(),
		// wdfBis.getDate(),tabbedPaneEingangsrechnung.isBZusatzkosten());
		return DelegateFactory.getInstance().getEingangsrechnungDelegate().printKontierungsjournal(iFilter,
				kostenstelleIId, iKritDatum, panelDateRange.getWdfVon().getDate(), panelDateRange.getWdfBis().getDate(),
