...
public class DialogErfuellungsgrad extends JDialog implements
	...
	private WrapperNumberField wnfPraemie = null;
	private Double fErfuellungsgrad = null;
	private BigDecimal bdPraemie = null;
	private AuftragDto auftragDto = null;
	private String btnString1 = null;
	private String btnString2 = null;

	public DialogErfuellungsgrad(AuftragDto auftragDto,
			Double fErfuellungsgrad, BigDecimal bdPraemie) {
		super(LPMain.getInstance().getDesktop(), "", true);
		this.fErfuellungsgrad = fErfuellungsgrad;
		this.bdPraemie = bdPraemie;
		...
		setTitle(LPMain.getInstance().getTextRespectUISPr(
				"auft.menu.bearbeiten.erfuellungsgrad"));
	...
	private void jbInit() throws Throwable {
		...
		wnfPraemie = new WrapperNumberField();
		wnfPraemie.setFractionDigits(Defaults.getInstance()
				.getIUINachkommastellenPreiseVK());
		if (bdPraemie != null) {
			wnfPraemie.setBigDecimal(bdPraemie);
		}

		btnString1 = LPMain.getInstance().getTextRespectUISPr("lp.report.save");
		btnString2 = LPMain.getInstance().getTextRespectUISPr("Cancel");
		add(panel1);
		panel1.add(wnfErfuellungsgrad, new GridBagConstraints(0, 1, 1, 1, 1.0,
				1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 0, 0, 0), 0, 0));
		panel1.add(wnfPraemie, new GridBagConstraints(0, 2, 1, 1, 1.0, 1.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), 0, 0));

		String msgString1 = LPMain.getInstance().getTextRespectUISPr(
				"auft.hint.erfuellungsgraderfassen");
		String msgString2 = LPMain.getInstance().getTextRespectUISPr(
				"auft.konditionen.praemie");
		Object[] array = { msgString1, wnfErfuellungsgrad, msgString2,
				wnfPraemie };
		...
		if (isVisible()
			...
			if (btnString1.equals(value)) {
				try {
					...
					bdPraemie = wnfPraemie.getBigDecimal();
					auftragDto.setNPraemie(bdPraemie);
