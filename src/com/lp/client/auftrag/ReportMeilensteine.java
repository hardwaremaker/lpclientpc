...
public class ReportMeilensteine extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMeilensteine(InternalFrame internalFrame, Integer iIdAuftragI,
	...
	public String getReportname() {
		return AuftragReportFac.REPORT_AUFTRAG_MEILENSTEINE;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getAuftragReportDelegate()
				.printMeilensteine(wdfStichtag.getTimestamp());
	}
