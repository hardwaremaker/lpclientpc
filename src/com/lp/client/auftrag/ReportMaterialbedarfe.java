...
public class ReportMaterialbedarfe extends PanelBasis implements
		PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportMaterialbedarfe(InternalFrame internalFrame,
	...
	public String getReportname() {
		return AuftragReportFac.REPORT_AUFTRAG_MATERIALBEDARFE;
	}

	public JasperPrintLP getReport(String sDrucktype) throws Throwable {

		return DelegateFactory.getInstance().getAuftragReportDelegate()
				.printMaterialbedarfe(wdfStichtag.getTimestamp());
	}
