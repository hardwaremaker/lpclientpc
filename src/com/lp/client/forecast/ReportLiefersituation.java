...
public class ReportLiefersituation extends PanelBasis implements PanelReportIfJRDS {
	/**
	 * 
	 */
	...
	public ReportLiefersituation(InternalFrame internalFrame,Integer forecastauftragIId,
	...
	public String getReportname() {
		return ForecastReportFac.REPORT_LIEFERSITUATION;
	}
	...
	public JasperPrintLP getReport(String sDrucktype) throws Throwable {
		...
		return DelegateFactory.getInstance().getForecastReportDelegate()
				.printLiefersituation(forecastauftragIId);
	}
