...
public class BelegpostionkonvertierungDelegate extends Delegate {
	...
	public BelegpostionkonvertierungDelegate() throws ExceptionLP {
		try {
			...
			belegpositionkonvertierungFac = lookupFac(context, BelegpositionkonvertierungFac.class);	
	...
	public AgstklpositionDto[] konvertiereNachAgstklpositionDto(
		...
		try {
			return belegpositionkonvertierungFac
					.konvertiereNachAgstklpositionDto(belegpositionDto,
	...
	public RechnungPositionDto[] konvertiereNachRechnungpositionDto(
			BelegpositionDto[] belegpositionDto,
			Integer kundeId, Timestamp belegDatum) throws Throwable {
		try {
			return belegpositionkonvertierungFac
					.konvertiereNachRechnungpositionDto(
							belegpositionDto, kundeId,
							belegDatum, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public AngebotpositionDto[] konvertiereNachAngebotpositionDto(
			...
			Timestamp tBelegdatum) throws Throwable {
		try {
			return belegpositionkonvertierungFac
					.konvertiereNachAngebotpositionDto(belegpositionDto,kundeIId,tBelegdatum,
							LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		...
		try {
			return belegpositionkonvertierungFac
					.konvertiereNachAuftragpositionDto(belegpositionDto,
							kundeIId, tBelegdatum, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
	...
	public LieferscheinpositionDto[] konvertiereNachLieferscheinpositionDto(
			BelegpositionDto[] belegpositionDto, Integer kundeIId,
			Timestamp tBelegdatum,boolean bMwstSatzNeuBestimmen) throws Throwable {
		try {
			return belegpositionkonvertierungFac
					.konvertiereNachLieferscheinpositionDto(belegpositionDto,
							kundeIId, tBelegdatum, bMwstSatzNeuBestimmen, LPMain.getTheClient());
		} catch (Throwable ex) {
			handleThrowable(ex);
			return null;
		}
